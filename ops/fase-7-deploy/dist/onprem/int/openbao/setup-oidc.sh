...
# Certificado en el que confiar al hablar con Keycloak. El de integracion es AUTOFIRMADO, asi que
# el propio certificado hace de CA. En un entorno con certificado de una CA publica, exportar
# BAO_OIDC_CA_FILE="" para que OpenBao use el almacen de confianza del sistema: pasarle el
# certificado HOJA de una cadena real haria FALLAR la verificacion, no relajarla.
BAO_OIDC_CA_FILE="${BAO_OIDC_CA_FILE-/openbao/tls/nginx-ca.crt}"
