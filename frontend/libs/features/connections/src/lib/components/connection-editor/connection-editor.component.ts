        ...
        <form class="editor-form" (ngSubmit)="!readonly() && save.emit()">
          <section class="form-section">
            <div class="section-header">
              ...
              <h4>{{ i18n.t('connections.detail') }}</h4>
            </div>

            <div class="hero-grid">
              <mat-form-field class="field-span-2">
                <mat-label>{{ i18n.t('common.name') }}</mat-label>
                <input matInput [disabled]="readonly()" [ngModel]="form().name" (ngModelChange)="patchForm.emit({ name: $event })" name="connectionName" />
              </mat-form-field>

              <mat-form-field>
                <mat-label>{{ i18n.t('common.type') }}</mat-label>
                <mat-select [disabled]="readonly()" [ngModel]="form().connectionType" (ngModelChange)="connectionTypeChange.emit($event)" name="connectionType">
              ...
              <div class="toggle-wrap">
                <mat-slide-toggle [disabled]="readonly()" [ngModel]="form().active" (ngModelChange)="patchForm.emit({ active: $event })" name="connectionActive">
          ...
          <section class="form-section">
            <div class="section-header">
              ...
              <h4>{{ i18n.t('ui.config.json') }}</h4>
            </div>

            <mat-form-field class="field-span-2">
              <mat-label>{{ i18n.t('ui.config.json') }}</mat-label>
              <textarea matInput rows="8" [disabled]="true" [ngModel]="configurationPreview()" name="connectionConfigurationJson"></textarea>
            </mat-form-field>
          </section>
