...
@Component({
  ...
  template: `
    <div class="form-grid">
      ...
      <mat-form-field><mat-label>{{ i18n.t('ui.password') }}</mat-label><input matInput type="password" [disabled]="readonly()" [ngModel]="draft().password" [ngModelOptions]="{ standalone: true }" (ngModelChange)="update('password', $event)" /></mat-form-field>
      ...
      <mat-form-field><mat-label>{{ i18n.t('ui.passphrase') }}</mat-label><input matInput type="password" [disabled]="readonly()" [ngModel]="draft().passphrase" [ngModelOptions]="{ standalone: true }" (ngModelChange)="update('passphrase', $event)" /></mat-form-field>
