  ...
  template: `
    <div class="task-grid">
      ...
      <mat-form-field>
        ...
        <mat-select [disabled]="readonly() || !selectedConnection()" [ngModel]="procedureSchema()" (ngModelChange)="handleSchemaChange($event)">
    ...
    <ih-process-task-binding-board
      ...
      [titleKey]="'ui.procedureParameters'"
      [hintKey]="'ui.procedureParametersHint'"
...
export class ProcessDbExecuteSpTaskFormComponent {
  ...
  readonly draft = computed(() => this.manager.hydrateDraft<DbExecuteStoredProcedureTaskDraft>(this.task()) ?? {
    connectionRef: '',
    procedureSchema: '',
    procedureName: '',
    timeoutSeconds: '30',
