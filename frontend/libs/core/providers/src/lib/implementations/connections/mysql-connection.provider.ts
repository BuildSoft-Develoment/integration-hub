// @trace spec 005-catalogo-conexiones RF-003 (conexiones: contrato configuration_json JDBC + secretos ${secret:...}) motor MYSQL
import { Injectable } from '@angular/core';
import { ConnectionDraft, ConnectionProvider } from '../../connections/connection-provider.abstract';

@Injectable()
export class MySqlConnectionProvider extends ConnectionProvider {
  override readonly descriptor = {
    type: 'MYSQL',
    label: 'MySQL',
    description: 'Conexion JDBC para MySQL con configuracion de pool y SQL inicial opcional.',
    category: 'JDBC',
    capabilities: ['Pool JDBC', 'SQL inicial', 'Secrets'],
  } as const;
