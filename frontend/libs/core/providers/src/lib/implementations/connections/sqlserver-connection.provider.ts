...
@Injectable()
export class SqlServerConnectionProvider extends ConnectionProvider {
  override readonly descriptor = {
    type: 'SQLSERVER',
    label: 'SQL Server',
    description: 'Conexion JDBC para SQL Server con configuracion de pool y propiedades extra.',
    category: 'JDBC',
