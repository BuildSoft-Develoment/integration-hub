# Evidencia E2E readers/plugins 10k - 20260709005931

- Plataforma: http://localhost:8080
- Usuario: admin
- Datos: C:\chatgtp\quarkus\qa\fase-6-qa\evidencias\large-readers-plugins-20260709005931\fixtures
- Resultado JSON: C:\chatgtp\quarkus\qa\fase-6-qa\evidencias\large-readers-plugins-20260709005931\result.json
- Screenshot login: C:\chatgtp\quarkus\qa\fase-6-qa\evidencias\large-readers-plugins-20260709005931\post-login.png
...
- Versiones registradas: demo-transform-java@1.0.0, demo-transform-node@1.0.0, demo-transform-python@1.0.0
- UI catalog size: 1
...
| csv-10k-sync-rest-call-batch | sync | COMPLETED | COMPLETED | 10000 | 20 | PASS |
...
| csv-invalid-reader-config-catalog-error |  | HTTP_4XX_OR_5XX | HTTP_200 |  |  | KNOWN DEFECT |
