...
| Backend compile final | `mvn -pl platform-app -DskipTests compile` | PASS | 2026-06-21: compila `platform-app` luego de cambios de repositorios, recursos REST y migracion V44. |
