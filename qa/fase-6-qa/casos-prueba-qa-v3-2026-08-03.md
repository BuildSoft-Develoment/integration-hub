...
| 29 | F2 | `CSRC-01` | CSRC | Manual-QA | Listar, buscar y filtrar fuentes | Pass | - | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 30 | F2 | `CSRC-02` | CSRC | Manual-QA | Crear fuente SFTP (Probar + Guardar) | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 31 | F2 | `CSRC-03` | CSRC | Manual-QA | Crear fuente Amazon S3 / MinIO | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 32 | F2 | `CSRC-04` | CSRC | Manual-QA | Crear fuente FTP | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 33 | F2 | `CSRC-05` | CSRC | Manual-QA | Crear fuente REST | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 34 | F2 | `CSRC-06` | CSRC | Manual-QA | Editar una fuente existente | Pass | - | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md`; ademas se comprobo que la mascara del password no corrompe la referencia `${secret:...}` |
| 35 | F2 | `CSRC-07` | CSRC | Manual-QA | Probar con credencial invalida (fail-loud) | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 36 | F2 | `CSRC-08` | CSRC | Manual-QA | Desactivar / Reactivar (baja logica; NO hay borrado) | Pass | - | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 37 | F2 | `CSRC-09` | CSRC | Manual-QA | Validacion de campos requeridos | Pass | - | **Fail** | Defecto **QA-CSRC-09**: *Crear* guarda una fuente sin la config obligatoria del provider (`host` vacio) aunque *Probar* si falla. Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 38 | F2 | `CSRC-10` | CSRC | Manual-QA | Cambiar de Tipo re-dibuja el formulario | Pass | - | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 39 | F2 | `CSRC-11` | CSRC | Tecnico/Dev | Fuente File system (requiere ruta montada) | N/A | N/A | **Pass (config)** | Ejecutable, NO N/A: el compose monta `./int/data-filesystem -> /work/data/filesystem`. Probar OK contra la ruta real y error diferenciado con selector. Lectura real no ejercitada (directorio vacio). Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 40 | F2 | `CSRC-12` | CSRC | Manual-QA | Ruta del archivo por tipo de fuente | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 41 | F2 | `CCON-01` | CCON | Manual-QA | Listar, buscar y filtrar conexiones | Pass | - | **Pass** | Busqueda y filtro por motor probados en los dos sentidos (0 y 1 resultado). Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 42 | F2 | `CCON-02` | CCON | Manual-QA | Crear conexion JDBC PostgreSQL (Probar + Guardar) | Pass | Pass | **Pass** | Password por `${env:QUARKUS_DATASOURCE_PASSWORD}`. Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 43 | F2 | `CCON-03` | CCON | Manual-QA | Probar con URL/credencial invalida (fail-loud) | Pass | Pass | **Pass** | Password deliberadamente incorrecta: *Probar* falla con `Cannot connect using the provided JDBC configuration`; cancelada sin crear. Mensaje sin traducir y sin causa -> **QA-CCON-I18N**. Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 44 | F2 | `CCON-04` | CCON | Manual-QA | Editar el pool de conexiones | Pass | - | **Pass** | Verificado **tras recarga completa** (store vacio -> fetch real): `Tamano maximo` = 20. El primer intento fallo con `PUT` **401** por token caducado y la UI lo mostro como guardado -> **QA-CCON-401**. Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 45 | F2 | `CCON-05` | CCON | Manual-QA | Desactivar / Reactivar conexion (baja logica) | Pass | Pass | **Pass** | Filtro Estado probado en los dos sentidos (Activa -> 0 de 0, Inactiva -> 1 de 1); reactivada. Sin borrado fisico. Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 46 | F2 | `CCON-06` | CCON | Tecnico/Dev | Otros motores requieren BD real | N/A | N/A | **No ejecutado** | Requiere UI o API autenticada |
| 47 | F2 | `CRDR-01` | CRDR | Manual-QA | Listar, buscar y filtrar readers | Pass | - | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 48 | F2 | `CRDR-02` | CRDR | Manual-QA | Crear reader SWIFT MT/FIN (banking) | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 49 | F2 | `CRDR-03` | CRDR | Manual-QA | Crear reader CSV MT101 (por posicion) | Pass | - | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 50 | F2 | `CRDR-04` | CRDR | Manual-QA | Crear reader JSON | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 51 | F2 | `CRDR-05` | CRDR | Manual-QA | Crear reader TXT de ancho fijo | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 52 | F2 | `CRDR-06` | CRDR | Manual-QA | Editar un reader | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
| 53 | F2 | `CRDR-07` | CRDR | Manual-QA | Desactivar / Reactivar reader (baja logica) | Pass | Pass | **Pass** | Corrida manual 2026-08-06 contra `/appih` nativo; ver `evidencias/corrida-manual-appih-nativo-20260806.md` |
