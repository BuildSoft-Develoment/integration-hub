...
import com.integrationhub.vertical.swift.mt101.provider.task.Mt101FragmentStore;
...
class Mt101RebuildServiceTest {
    ...
    void setUp() throws Exception {
        ...
        var fakeBuild = new Mt101BuildFromTableTaskProvider(null, null, new TestConfigurationMapper(), null, null) {
            @Override
    ...
    void schedulerDiscoversActiveRunsInNonDefaultJdbcConnections() throws Exception {
        ...
        var remotePool = new JdbcConnectionResolver() {
            @Override
    ...
    void schedulerIsolatesFailingJdbcConnectionAndStillSyncsHealthyOnes() throws Exception {
        ...
        var pool = new JdbcConnectionResolver() {
            @Override
            public List<String> activeJdbcConnectionRefs() {
