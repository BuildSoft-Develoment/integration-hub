 ...
 * @trace ADR-009
 */
public final class DbValidationPredicateFactory {
    ...
    public static ValidationPredicate fromSpec(RuleSpec spec, ObjectMapper objectMapper, JexlEngine jexlEngine) {
