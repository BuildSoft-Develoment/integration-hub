...
create table vertical_mt101.mt101_pay_dispatch_intent (
...
create index ix_mt101_pay_dispatch_intent_exec on vertical_mt101.mt101_pay_dispatch_intent (process_execution_id);
