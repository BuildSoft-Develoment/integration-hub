...
create or replace function vertical_mt101.mt101_pay_plan_delete_guard() returns trigger as $$
begin
...
drop trigger if exists trg_pay_plan_delete_guard on vertical_mt101.mt101_corrective_pay_plan;
create trigger trg_pay_plan_delete_guard
    before delete on vertical_mt101.mt101_corrective_pay_plan
    for each row execute function vertical_mt101.mt101_pay_plan_delete_guard();
