...
create table if not exists vertical_mt101.mt101_corrective_pay_fragment (
...
create index if not exists ix_mt101_corrective_pay_fragment_run_status
    on vertical_mt101.mt101_corrective_pay_fragment (rebuild_run_id, pay_status);

create index if not exists ix_mt101_corrective_pay_fragment_staging
    on vertical_mt101.mt101_corrective_pay_fragment (rebuild_run_id, staging_id);
