...
| 001-catalogo-fuentes | RF-007 | credenciales cloud (nativas/${secret}) | Administrar fuentes | POST /api/source-definitions | configuration_json (authMode) | FileVaultSecretValueProvider | - | En progreso (WIP, ADR-006) | specs/001-catalogo-fuentes/spec-tecnica.md | source-object-store (bloque auth) | - |
