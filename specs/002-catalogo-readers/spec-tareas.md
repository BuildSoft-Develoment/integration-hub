...
| T-006 | RF-001 | impl | frontend/libs/features/readers/src/lib/components/reader-type-form/reader-type-form-host/reader-type-form-host.component.ts | frontend/libs/features/readers/src/lib/catalog/reader-catalog.store.spec.ts | npx nx test readers | FAIL sin la UI de configuracion por formato | npx nx test readers | PASS | - | si | pending |
