// @covers spec 004-observabilidad-y-auditoria RF-006 (reingenieria: prueba que cubre el/los RF en produccion — observabilidad-y-auditoria: publicacion al backbone de auditoria)
