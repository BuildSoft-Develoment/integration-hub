// @covers spec 003-diseno-y-ejecucion-procesos RF-007, RF-011 (reingenieria: prueba que cubre el/los RF en produccion — diseno-y-ejecucion-procesos: resolucion de inputs y fan-in)
