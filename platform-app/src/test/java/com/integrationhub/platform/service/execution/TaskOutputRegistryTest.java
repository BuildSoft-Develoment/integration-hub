// @covers spec 003-diseno-y-ejecucion-procesos RF-010 (reingenieria: prueba que cubre el/los RF en produccion — diseno-y-ejecucion-procesos: registro de outputs por lote)
