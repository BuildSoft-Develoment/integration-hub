...
class Mt101BuildFromTableTaskProviderTest {
    ...
    void payGateOnlyReadsArchivedFragmentsByDefault() throws Exception {
        ...
        var archivedOnly = new java.util.ArrayList<com.integrationhub.platform.provider.task.payments.swift.model.Mt101Message>();
    ...
    void forEachPagePaginatesWithKeysetAcrossPages() throws Exception {
        ...
        var all = new java.util.ArrayList<com.integrationhub.platform.provider.task.payments.swift.model.Mt101Message>();
