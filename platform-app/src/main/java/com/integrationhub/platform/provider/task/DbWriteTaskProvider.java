...
public class DbWriteTaskProvider implements TaskProvider {
    ...
    private List<ReadRecord> enrichRecordsWithRuntime(TaskContext context,
        ...
        var runtimeValues = StoredProcedureRuntimeSupport.buildRuntimeVariables(
                executionVariables,
                context != null && context.processExecution() != null ? context.processExecution().id : null,
                context != null && context.taskDefinition() != null ? context.taskDefinition().id : null,
    ...
    private int insertIntoStaging(DataSource targetDataSource,
        ...
        try (Connection connection = targetDataSource.getConnection();
            ...
            for (var record : records) {
                statement.setLong(1, context.processExecution().id);
                statement.setLong(2, context.taskDefinition().id);
