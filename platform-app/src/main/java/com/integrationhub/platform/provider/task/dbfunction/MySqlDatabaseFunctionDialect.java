...
@ApplicationScoped
public class MySqlDatabaseFunctionDialect extends AbstractDatabaseFunctionDialect {
    ...
    public String selectStatement(String functionName,
                                  ...
                                  String resultAlias) {
        return selectScalarFunction(functionName, parameters, "`" + sanitizeResultAlias(resultAlias) + "`", "");
    }
}
