...
public class ProcessedSourceFileService {
    ...
    public void recordPipelineFiles(Long processExecutionId,
                                    ...
                                    List<ProcessTaskRuntimeService.FileReadSummary> completedFiles,
                                    List<ProcessTaskRuntimeService.FileFailureSummary> failedFiles) {
        ...
        var completedByName = new HashMap<String, ProcessTaskRuntimeService.FileReadSummary>();
        completedFiles.forEach(summary -> completedByName.put(summary.fileName(), summary));
        var failedByName = new HashMap<String, ProcessTaskRuntimeService.FileFailureSummary>();
