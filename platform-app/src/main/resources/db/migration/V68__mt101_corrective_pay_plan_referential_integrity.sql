...
alter table mt101_corrective_pay_plan
    ...
    foreign key (rebuild_run_id) references mt101_rebuild_run (rebuild_run_id)
    on delete restrict
    not valid;

alter table mt101_corrective_pay_plan_fragment
...
alter table mt101_rebuild_run validate constraint fk_run_active_plan_revision;
