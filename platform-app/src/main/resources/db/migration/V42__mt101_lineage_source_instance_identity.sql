...
alter table mt101_fragment_record
...
drop index if exists ux_mt101_fragment_record_current;
...
drop index if exists ux_mt101_rebuild_selection_row;
...
create index if not exists ix_mt101_fragment_record_source_task
    on mt101_fragment_record (source_task_definition_id);
