...
update vertical_mt101.mt101_build_fragment
...
create index if not exists ix_mt101_fragment_source_record
    on vertical_mt101.mt101_build_fragment (source_file_hash, source_record_from, source_record_to);

create index if not exists ix_mt101_fragment_execution_source_record
    on vertical_mt101.mt101_build_fragment (process_execution_id, source_table, source_record_from, source_record_to);
...
create index if not exists ix_mt101_validation_transaction
    on vertical_mt101.mt101_validation_issue (fragment_set_id, transaction_reference);
