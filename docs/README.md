...
- `00.xx` a `08.xx` identifican documentos por fase.
- `90.xx` identifica documentacion transversal.
...
- [Fase 4 - Spec-Driven Development](fase-4-sdd/README.md)
...
1. Empezar por [00.00-guia-de-uso](fase-0-iniciacion/00.00-guia-de-uso.md).
2. Continuar con [00.01-vision-proyecto](fase-0-iniciacion/00.01-vision-proyecto.md) y [01.00-analisis-requerimientos](fase-1-analisis-requerimientos/01.00-analisis-requerimientos.md).
3. Revisar [03.00-arquitectura](fase-3-arquitectura/03.00-arquitectura.md), [03.01-decisiones-tecnologia](fase-3-arquitectura/03.01-decisiones-tecnologia.md) y [03.03-plan-despliegue](fase-3-arquitectura/03.03-plan-despliegue.md).
4. Para trabajo de implementacion, seguir [04.00-spec-driven-development](fase-4-sdd/04.00-spec-driven-development.md) y [specs/](../specs/README.md).
5. Para soporte y salida a ambientes, usar [06.00-plan-pruebas](fase-6-qa/06.00-plan-pruebas.md), [07.00-checklist-salida-produccion](fase-7-deploy/07.00-checklist-salida-produccion.md) y [08.00-operacion-continua](fase-8-operacion/08.00-operacion-continua.md).

## Rutas por rol

### Product Owner

- [Vision del proyecto](fase-0-iniciacion/00.01-vision-proyecto.md)
