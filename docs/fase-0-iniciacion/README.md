...
- Siguiente: [Guia de uso](00.00-guia-de-uso.md)
<!-- nav-guided:end -->

## Objetivo

Alinear direccion, alcance, plan base y responsables del proyecto.

## Nota de numeracion

Esta fase usa numeracion compuesta `00.xx`. El prefijo `00` identifica la fase y el sufijo ordena los documentos dentro de la carpeta.

## Contenido

- [00.00-guia-de-uso](00.00-guia-de-uso.md)
- [00.01-vision-proyecto](00.01-vision-proyecto.md)
