...
\r
skinparam rectangle<<DevDockerHostAdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<DevDockerHostQuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
...
rectangle "dockerHost" <<DevDockerHost>> as DevDockerHost {\r
  skinparam RectangleBorderColor<<DevDockerHost>> #428a4f\r
  skinparam RectangleFontColor<<DevDockerHost>> #428a4f\r
  skinparam RectangleBorderStyle<<DevDockerHost>> dashed\r
\r
  rectangle "==Admin Console" <<DevDockerHostAdminConsole>> as DevDockerHostAdminConsole\r
  rectangle "==Quarkus Native App" <<DevDockerHostQuarkusApp>> as DevDockerHostQuarkusApp\r
}\r
...
\r
DevDockerHostAdminConsole .[#8D8D8D,thickness=2].> DevDockerHostQuarkusApp : <color:#8D8D8D>[...]\r
DevDataOtel .[#8D8D8D,thickness=2].> DevDataJaeger : <color:#8D8D8D>Entrega trazas\r
DevDockerHostAdminConsole .[#8D8D8D,thickness=2].> DevDataIam : <color:#8D8D8D>[...]\r
DevDockerHostQuarkusApp .[#8D8D8D,thickness=2].> DevDataDb : <color:#8D8D8D>[...]\r
DevDockerHostQuarkusApp .[#8D8D8D,thickness=2].> DevDataIam : <color:#8D8D8D>Valida access tokens\r
DevDockerHostQuarkusApp .[#8D8D8D,thickness=2].> DevDataOtel : <color:#8D8D8D>Exporta trazas\r
@enduml\r
...
\r
skinparam rectangle<<PrePreNode1AdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PrePreNode1QuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
...
rectangle "preNode1" <<PrePreNode1>> as PrePreNode1 {\r
  skinparam RectangleBorderColor<<PrePreNode1>> #428a4f\r
  skinparam RectangleFontColor<<PrePreNode1>> #428a4f\r
  skinparam RectangleBorderStyle<<PrePreNode1>> dashed\r
\r
  rectangle "==Admin Console" <<PrePreNode1AdminConsole>> as PrePreNode1AdminConsole\r
  rectangle "==Quarkus Native App" <<PrePreNode1QuarkusApp>> as PrePreNode1QuarkusApp\r
}\r
...
\r
PrePreNode1AdminConsole .[#8D8D8D,thickness=2].> PrePreNode1QuarkusApp : <color:#8D8D8D>[...]\r
PreDataOtel .[#8D8D8D,thickness=2].> PreDataJaeger : <color:#8D8D8D>Entrega trazas\r
PrePreNode1AdminConsole .[#8D8D8D,thickness=2].> PreDataIam : <color:#8D8D8D>[...]\r
PrePreNode1QuarkusApp .[#8D8D8D,thickness=2].> PreDataDb : <color:#8D8D8D>[...]\r
PrePreNode1QuarkusApp .[#8D8D8D,thickness=2].> PreDataIam : <color:#8D8D8D>Valida access tokens\r
PrePreNode1QuarkusApp .[#8D8D8D,thickness=2].> PreDataOtel : <color:#8D8D8D>Exporta trazas\r
@enduml\r
