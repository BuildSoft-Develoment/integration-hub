...
graph TB\r
  ...
  IntegrationHub.QuarkusApp.SourceDefinitionResource -. "\`Delega gestion de sources\`" .-> IntegrationHub.QuarkusApp.ProcessCatalogService\r
  ...
  IntegrationHub.QuarkusApp.PersistenceLayer -. "\`Lee y persiste\`" .-> IntegrationHub.QuarkusApp.DomainEntities\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub.AdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHub.AdminConsole\r
  IntegrationAdmin -. "\`Administra catalogos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
...
graph TB\r
  ...
  IntegrationHub.QuarkusApp -. "\`Obtiene payloads remotos\`" .-> FileSources.RestSource\r
  IntegrationHub.QuarkusApp -. "\`Exporta trazas\`" .-> Observability.Otel\r
`;case"domain_catalog_entities_code":return`---\r
title: "Catalog"\r
---\r
graph TB\r
  subgraph IntegrationHub["\`Integration Hub Platform\`"]\r
    subgraph IntegrationHub.QuarkusApp["\`App Service Quarkus Native\`"]\r
      IntegrationHub.QuarkusApp.PersistenceLayer@{ shape: rectangle, label: "Panache Persistence Layer" }\r
      subgraph IntegrationHub.QuarkusApp.DomainEntities["\`Domain Entities\`"]\r
        IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity@{ shape: rectangle, label: "ProcessDefinition" }\r
        IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity@{ shape: rectangle, label: "ProcessTaskDefinition" }\r
        IntegrationHub.QuarkusApp.DomainEntities.SourceDefinitionEntity@{ shape: rectangle, label: "SourceDefinition" }\r
        IntegrationHub.QuarkusApp.DomainEntities.ReaderDefinitionEntity@{ shape: rectangle, label: "ReaderDefinition" }\r
      end\r
    end\r
  end\r
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationHub.QuarkusApp.PersistenceLayer -. "\`Lee y persiste\`" .-> IntegrationHub.QuarkusApp.DomainEntities.SourceDefinitionEntity\r
  IntegrationHub.QuarkusApp.PersistenceLayer -. "\`Lee y persiste\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ReaderDefinitionEntity\r
  IntegrationHub.QuarkusApp.PersistenceLayer -. "\`Lee y persiste\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity\r
  IntegrationHub.QuarkusApp.PersistenceLayer -. "\`Lee y persiste\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity -. "\`1..n tasks\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity -. "\`0..1 sourceDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.SourceDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity -. "\`0..1 readerDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ReaderDefinitionEntity\r
  IntegrationHub.QuarkusApp.PersistenceLayer -. "\`Opera sobre PostgreSQL\`" .-> Db\r
`;case"domain_execution_entities_code":return'---\r\ntitle: "Execution"\r\n---\r\ngraph TB\r\n  subgraph IntegrationHub["`Integration Hub Platform`"]\r\n    subgraph IntegrationHub.QuarkusApp["`App Service Quarkus Native`"]\r\n      IntegrationHub.QuarkusApp.PersistenceLayer@{ shape: rectangle, label: "Panache Persistence Layer" }\r\n      subgraph IntegrationHub.QuarkusApp.DomainEntities["`Domain Entities`"]\r\n        IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity@{ shape: rectangle, label: "ProcessTaskExecution" }\r\n        IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity@{ shape: rectangle, label: "AuditEvent" }\r\n        IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity@{ shape: rectangle, label: "ProcessExecution" }\r\n        IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity@{ shape: rectangle, label: "ProcessDefinition" }\r\n        IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity@{ shape: rectangle, label: "ProcessTaskDefinition" }\r\n      end\r\n    end\r\n  end\r\n  Db@{ shape: rectangle, label: "PostgreSQL" }\r\n  IntegrationHub.QuarkusApp.PersistenceLayer -. "`Lee y persiste`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity\r\n  IntegrationHub.QuarkusApp.PersistenceLayer -. "`Lee y persiste`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity\r\n  IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity -. "`n..1 processExecution`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity\r\n  IntegrationHub.QuarkusApp.PersistenceLayer -. "`Lee y persiste`" .-> IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity\r\n  IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity -. "`n..1 processExecution`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity\r\n  IntegrationHub.QuarkusApp.PersistenceLayer -. "`Lee y persiste`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity\r\n  IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity -. "`n..1 processDefinition`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity\r\n  IntegrationHub.QuarkusApp.PersistenceLayer -. "`Lee y persiste`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity\r\n  IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity -. "`n..1 taskDefinition`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity\r\n  IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity -. "`0..1 taskDefinition`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity\r\n  IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity -. "`1..n tasks`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity\r\n  IntegrationHub.QuarkusApp.PersistenceLayer -. "`Opera sobre PostgreSQL`" .-> Db\r\n';case"security_overview":return`---\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppSourceDefinitionResource -. "\`Delega alta de catalogo\`" .-> IntegrationHubQuarkusAppProcessCatalogService\r
