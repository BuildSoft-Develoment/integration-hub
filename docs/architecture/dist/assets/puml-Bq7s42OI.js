...
rectangle "==On-Prem Data Center" <<OnPrem>> as OnPrem\r
...
PlatformAdmin .[#8D8D8D,thickness=2].> OnPrem : <color:#8D8D8D>UC-10\r
...
InfraTeam .[#8D8D8D,thickness=2].> OnPrem : <color:#8D8D8D>UC-10\r
...
OnPrem .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>[...]\r
...
SchedulerActor .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>UC-05\r
OnPrem .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>[...]\r
OnPrem .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>[...]\r
...
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
@enduml\r
`;case"deployment_onprem":return`@startuml\r
title "DEV, PRE y PRO"\r
top to bottom direction\r
\r
hide stereotype\r
skinparam ranksep 60\r
...
\r
skinparam rectangle<<DevOnpremEdgeAdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreOnpremAppClusterPreNode1AdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreOnpremAppClusterPreNode2AdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdOnpremLoadBalancerLoadBalancer>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdOnpremServicesVault>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdOnpremServicesSharedStorage>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<DevOnpremEdgeQuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreOnpremAppClusterPreNode1QuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreOnpremAppClusterPreNode2QuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdOnpremAppClusterProdNode1AdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdOnpremAppClusterProdNode2AdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<DevOnpremDataOtel>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<DevOnpremDataIam>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<DevOnpremDataDb>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<PreOnpremDataOtel>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreOnpremDataIam>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<PreOnpremDataDb>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<ProdOnpremAppClusterProdNode1QuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdOnpremAppClusterProdNode2QuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<DevOnpremDataJaeger>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreOnpremDataJaeger>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdOnpremDataOtel>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdOnpremDataIam>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<ProdOnpremDataDb>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<ProdOnpremDataJaeger>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
rectangle "onprem" <<DevOnprem>> as DevOnprem {\r
  skinparam RectangleBorderColor<<DevOnprem>> #737373\r
  skinparam RectangleFontColor<<DevOnprem>> #737373\r
  skinparam RectangleBorderStyle<<DevOnprem>> dashed\r
\r
  rectangle "edge" <<DevOnpremEdge>> as DevOnpremEdge {\r
    skinparam RectangleBorderColor<<DevOnpremEdge>> #428a4f\r
    skinparam RectangleFontColor<<DevOnpremEdge>> #428a4f\r
    skinparam RectangleBorderStyle<<DevOnpremEdge>> dashed\r
\r
    rectangle "==Admin Console" <<DevOnpremEdgeAdminConsole>> as DevOnpremEdgeAdminConsole\r
    rectangle "==Quarkus Native App" <<DevOnpremEdgeQuarkusApp>> as DevOnpremEdgeQuarkusApp\r
  }\r
  rectangle "data" <<DevOnpremData>> as DevOnpremData {\r
    skinparam RectangleBorderColor<<DevOnpremData>> #428a4f\r
    skinparam RectangleFontColor<<DevOnpremData>> #428a4f\r
    skinparam RectangleBorderStyle<<DevOnpremData>> dashed\r
\r
    rectangle "==OpenTelemetry Collector" <<DevOnpremDataOtel>> as DevOnpremDataOtel\r
    rectangle "==Keycloak" <<DevOnpremDataIam>> as DevOnpremDataIam\r
    rectangle "==PostgreSQL" <<DevOnpremDataDb>> as DevOnpremDataDb\r
    rectangle "==Jaeger" <<DevOnpremDataJaeger>> as DevOnpremDataJaeger\r
  }\r
}\r
rectangle "onprem" <<PreOnprem>> as PreOnprem {\r
  skinparam RectangleBorderColor<<PreOnprem>> #737373\r
  skinparam RectangleFontColor<<PreOnprem>> #737373\r
  skinparam RectangleBorderStyle<<PreOnprem>> dashed\r
\r
  rectangle "appCluster" <<PreOnpremAppCluster>> as PreOnpremAppCluster {\r
    skinparam RectangleBorderColor<<PreOnpremAppCluster>> #3b82f6\r
    skinparam RectangleFontColor<<PreOnpremAppCluster>> #3b82f6\r
    skinparam RectangleBorderStyle<<PreOnpremAppCluster>> dashed\r
\r
    rectangle "preNode1" <<PreOnpremAppClusterPreNode1>> as PreOnpremAppClusterPreNode1 {\r
      skinparam RectangleBorderColor<<PreOnpremAppClusterPreNode1>> #428a4f\r
      skinparam RectangleFontColor<<PreOnpremAppClusterPreNode1>> #428a4f\r
      skinparam RectangleBorderStyle<<PreOnpremAppClusterPreNode1>> dashed\r
\r
      rectangle "==Admin Console" <<PreOnpremAppClusterPreNode1AdminConsole>> as PreOnpremAppClusterPreNode1AdminConsole\r
      rectangle "==Quarkus Native App" <<PreOnpremAppClusterPreNode1QuarkusApp>> as PreOnpremAppClusterPreNode1QuarkusApp\r
    }\r
    rectangle "preNode2" <<PreOnpremAppClusterPreNode2>> as PreOnpremAppClusterPreNode2 {\r
      skinparam RectangleBorderColor<<PreOnpremAppClusterPreNode2>> #428a4f\r
      skinparam RectangleFontColor<<PreOnpremAppClusterPreNode2>> #428a4f\r
      skinparam RectangleBorderStyle<<PreOnpremAppClusterPreNode2>> dashed\r
\r
      rectangle "==Admin Console" <<PreOnpremAppClusterPreNode2AdminConsole>> as PreOnpremAppClusterPreNode2AdminConsole\r
      rectangle "==Quarkus Native App" <<PreOnpremAppClusterPreNode2QuarkusApp>> as PreOnpremAppClusterPreNode2QuarkusApp\r
    }\r
  }\r
  rectangle "data" <<PreOnpremData>> as PreOnpremData {\r
    skinparam RectangleBorderColor<<PreOnpremData>> #428a4f\r
    skinparam RectangleFontColor<<PreOnpremData>> #428a4f\r
    skinparam RectangleBorderStyle<<PreOnpremData>> dashed\r
\r
    rectangle "==OpenTelemetry Collector" <<PreOnpremDataOtel>> as PreOnpremDataOtel\r
    rectangle "==Keycloak" <<PreOnpremDataIam>> as PreOnpremDataIam\r
    rectangle "==PostgreSQL" <<PreOnpremDataDb>> as PreOnpremDataDb\r
    rectangle "==Jaeger" <<PreOnpremDataJaeger>> as PreOnpremDataJaeger\r
  }\r
}\r
rectangle "onprem" <<ProdOnprem>> as ProdOnprem {\r
  skinparam RectangleBorderColor<<ProdOnprem>> #737373\r
  skinparam RectangleFontColor<<ProdOnprem>> #737373\r
  skinparam RectangleBorderStyle<<ProdOnprem>> dashed\r
\r
  rectangle "loadBalancer" <<ProdOnpremLoadBalancer>> as ProdOnpremLoadBalancer {\r
    skinparam RectangleBorderColor<<ProdOnpremLoadBalancer>> #428a4f\r
    skinparam RectangleFontColor<<ProdOnpremLoadBalancer>> #428a4f\r
    skinparam RectangleBorderStyle<<ProdOnpremLoadBalancer>> dashed\r
\r
    rectangle "==Load Balancer / Reverse Proxy" <<ProdOnpremLoadBalancerLoadBalancer>> as ProdOnpremLoadBalancerLoadBalancer\r
  }\r
  rectangle "services" <<ProdOnpremServices>> as ProdOnpremServices {\r
    skinparam RectangleBorderColor<<ProdOnpremServices>> #428a4f\r
    skinparam RectangleFontColor<<ProdOnpremServices>> #428a4f\r
    skinparam RectangleBorderStyle<<ProdOnpremServices>> dashed\r
\r
    rectangle "==Secrets / Vault corporativo" <<ProdOnpremServicesVault>> as ProdOnpremServicesVault\r
    rectangle "==Shared File Storage" <<ProdOnpremServicesSharedStorage>> as ProdOnpremServicesSharedStorage\r
  }\r
  rectangle "appCluster" <<ProdOnpremAppCluster>> as ProdOnpremAppCluster {\r
    skinparam RectangleBorderColor<<ProdOnpremAppCluster>> #3b82f6\r
    skinparam RectangleFontColor<<ProdOnpremAppCluster>> #3b82f6\r
    skinparam RectangleBorderStyle<<ProdOnpremAppCluster>> dashed\r
\r
    rectangle "prodNode1" <<ProdOnpremAppClusterProdNode1>> as ProdOnpremAppClusterProdNode1 {\r
      skinparam RectangleBorderColor<<ProdOnpremAppClusterProdNode1>> #428a4f\r
      skinparam RectangleFontColor<<ProdOnpremAppClusterProdNode1>> #428a4f\r
      skinparam RectangleBorderStyle<<ProdOnpremAppClusterProdNode1>> dashed\r
\r
      rectangle "==Admin Console" <<ProdOnpremAppClusterProdNode1AdminConsole>> as ProdOnpremAppClusterProdNode1AdminConsole\r
      rectangle "==Quarkus Native App" <<ProdOnpremAppClusterProdNode1QuarkusApp>> as ProdOnpremAppClusterProdNode1QuarkusApp\r
    }\r
    rectangle "prodNode2" <<ProdOnpremAppClusterProdNode2>> as ProdOnpremAppClusterProdNode2 {\r
      skinparam RectangleBorderColor<<ProdOnpremAppClusterProdNode2>> #428a4f\r
      skinparam RectangleFontColor<<ProdOnpremAppClusterProdNode2>> #428a4f\r
      skinparam RectangleBorderStyle<<ProdOnpremAppClusterProdNode2>> dashed\r
\r
      rectangle "==Admin Console" <<ProdOnpremAppClusterProdNode2AdminConsole>> as ProdOnpremAppClusterProdNode2AdminConsole\r
      rectangle "==Quarkus Native App" <<ProdOnpremAppClusterProdNode2QuarkusApp>> as ProdOnpremAppClusterProdNode2QuarkusApp\r
    }\r
  }\r
  rectangle "data" <<ProdOnpremData>> as ProdOnpremData {\r
    skinparam RectangleBorderColor<<ProdOnpremData>> #428a4f\r
    skinparam RectangleFontColor<<ProdOnpremData>> #428a4f\r
    skinparam RectangleBorderStyle<<ProdOnpremData>> dashed\r
\r
    rectangle "==OpenTelemetry Collector" <<ProdOnpremDataOtel>> as ProdOnpremDataOtel\r
    rectangle "==Keycloak" <<ProdOnpremDataIam>> as ProdOnpremDataIam\r
    rectangle "==PostgreSQL" <<ProdOnpremDataDb>> as ProdOnpremDataDb\r
    rectangle "==Jaeger" <<ProdOnpremDataJaeger>> as ProdOnpremDataJaeger\r
  }\r
}\r
\r
DevOnpremEdgeAdminConsole .[#8D8D8D,thickness=2].> DevOnpremEdgeQuarkusApp : <color:#8D8D8D>[...]\r
DevOnpremDataOtel .[#8D8D8D,thickness=2].> DevOnpremDataJaeger : <color:#8D8D8D>Entrega trazas\r
DevOnpremEdgeAdminConsole .[#8D8D8D,thickness=2].> DevOnpremDataIam : <color:#8D8D8D>[...]\r
DevOnpremEdgeQuarkusApp .[#8D8D8D,thickness=2].> DevOnpremDataDb : <color:#8D8D8D>[...]\r
DevOnpremEdgeQuarkusApp .[#8D8D8D,thickness=2].> DevOnpremDataIam : <color:#8D8D8D>Valida access tokens\r
DevOnpremEdgeQuarkusApp .[#8D8D8D,thickness=2].> DevOnpremDataOtel : <color:#8D8D8D>Exporta trazas\r
PreOnpremAppClusterPreNode1AdminConsole .[#8D8D8D,thickness=2].> PreOnpremAppClusterPreNode1QuarkusApp : <color:#8D8D8D>[...]\r
PreOnpremAppClusterPreNode2AdminConsole .[#8D8D8D,thickness=2].> PreOnpremAppClusterPreNode2QuarkusApp : <color:#8D8D8D>[...]\r
PreOnpremDataOtel .[#8D8D8D,thickness=2].> PreOnpremDataJaeger : <color:#8D8D8D>Entrega trazas\r
PreOnpremAppClusterPreNode1AdminConsole .[#8D8D8D,thickness=2].> PreOnpremDataIam : <color:#8D8D8D>[...]\r
PreOnpremAppClusterPreNode1QuarkusApp .[#8D8D8D,thickness=2].> PreOnpremDataDb : <color:#8D8D8D>[...]\r
PreOnpremAppClusterPreNode1QuarkusApp .[#8D8D8D,thickness=2].> PreOnpremDataIam : <color:#8D8D8D>Valida access tokens\r
PreOnpremAppClusterPreNode1QuarkusApp .[#8D8D8D,thickness=2].> PreOnpremDataOtel : <color:#8D8D8D>Exporta trazas\r
PreOnpremAppClusterPreNode2AdminConsole .[#8D8D8D,thickness=2].> PreOnpremDataIam : <color:#8D8D8D>[...]\r
PreOnpremAppClusterPreNode2QuarkusApp .[#8D8D8D,thickness=2].> PreOnpremDataDb : <color:#8D8D8D>[...]\r
PreOnpremAppClusterPreNode2QuarkusApp .[#8D8D8D,thickness=2].> PreOnpremDataIam : <color:#8D8D8D>Valida access tokens\r
PreOnpremAppClusterPreNode2QuarkusApp .[#8D8D8D,thickness=2].> PreOnpremDataOtel : <color:#8D8D8D>Exporta trazas\r
ProdOnpremAppClusterProdNode1AdminConsole .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode1QuarkusApp : <color:#8D8D8D>[...]\r
ProdOnpremAppClusterProdNode2AdminConsole .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode2QuarkusApp : <color:#8D8D8D>[...]\r
ProdOnpremDataOtel .[#8D8D8D,thickness=2].> ProdOnpremDataJaeger : <color:#8D8D8D>Entrega trazas\r
ProdOnpremLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode1AdminConsole : <color:#8D8D8D>Publica UI on-prem\r
ProdOnpremLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode1QuarkusApp : <color:#8D8D8D>Publica APIs on-prem\r
ProdOnpremLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode2AdminConsole : <color:#8D8D8D>Publica UI on-prem\r
ProdOnpremLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode2QuarkusApp : <color:#8D8D8D>Publica APIs on-prem\r
ProdOnpremAppClusterProdNode1AdminConsole .[#8D8D8D,thickness=2].> ProdOnpremDataIam : <color:#8D8D8D>[...]\r
ProdOnpremAppClusterProdNode1QuarkusApp .[#8D8D8D,thickness=2].> ProdOnpremDataDb : <color:#8D8D8D>[...]\r
ProdOnpremAppClusterProdNode1QuarkusApp .[#8D8D8D,thickness=2].> ProdOnpremDataIam : <color:#8D8D8D>Valida access tokens\r
ProdOnpremAppClusterProdNode1QuarkusApp .[#8D8D8D,thickness=2].> ProdOnpremDataOtel : <color:#8D8D8D>Exporta trazas\r
ProdOnpremServicesVault .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode1QuarkusApp : <color:#8D8D8D>Entrega secretos y credenciales\r
ProdOnpremServicesSharedStorage .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode1QuarkusApp : <color:#8D8D8D>Comparte archivos locales\r
ProdOnpremAppClusterProdNode2AdminConsole .[#8D8D8D,thickness=2].> ProdOnpremDataIam : <color:#8D8D8D>[...]\r
ProdOnpremAppClusterProdNode2QuarkusApp .[#8D8D8D,thickness=2].> ProdOnpremDataDb : <color:#8D8D8D>[...]\r
ProdOnpremAppClusterProdNode2QuarkusApp .[#8D8D8D,thickness=2].> ProdOnpremDataIam : <color:#8D8D8D>Valida access tokens\r
ProdOnpremAppClusterProdNode2QuarkusApp .[#8D8D8D,thickness=2].> ProdOnpremDataOtel : <color:#8D8D8D>Exporta trazas\r
ProdOnpremServicesVault .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode2QuarkusApp : <color:#8D8D8D>Entrega secretos y credenciales\r
ProdOnpremServicesSharedStorage .[#8D8D8D,thickness=2].> ProdOnpremAppClusterProdNode2QuarkusApp : <color:#8D8D8D>Comparte archivos locales\r
@enduml\r
