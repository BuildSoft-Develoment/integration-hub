...
graph TB\r
  ...
  Vault@{ shape: rectangle, label: "Secrets / Vault corporativo" }\r
  ...
  LoadBalancer -. "\`Publica UI on-prem\`" .-> IntegrationHub.AdminConsole\r
  LoadBalancer -. "\`Publica APIs on-prem\`" .-> IntegrationHub.QuarkusApp\r
  IngressController -. "\`Enruta trafico HTTP interno\`" .-> IntegrationHub.AdminConsole\r
  IngressController -. "\`Enruta trafico HTTP interno\`" .-> IntegrationHub.QuarkusApp\r
  Vault -. "\`Entrega secretos y credenciales\`" .-> IntegrationHub.QuarkusApp\r
  SharedStorage -. "\`Comparte archivos locales\`" .-> IntegrationHub.QuarkusApp\r
...
graph TB\r
  ...
  LoadBalancer -. "\`Publica UI on-prem\`" .-> IntegrationHubAdminConsole\r
  LoadBalancer -. "\`Publica APIs on-prem\`" .-> IntegrationHubQuarkusApp\r
