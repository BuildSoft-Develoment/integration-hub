...
skinparam rectangle<<ExternalDatabases>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
...
rectangle "==External Databases" <<ExternalDatabases>> as ExternalDatabases\r
...
IntegrationHub .[#8D8D8D,thickness=2].> ExternalDatabases : <color:#8D8D8D>[...]\r
...
skinparam rectangle<<IntegrationHubQuarkusAppReaderDefinitionResource>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
...
\r
    ...
    rectangle "==ReaderDefinitionResource" <<IntegrationHubQuarkusAppReaderDefinitionResource>> as IntegrationHubQuarkusAppReaderDefinitionResource\r
...
IntegrationHubAdminConsoleProcessDesigner .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppReaderDefinitionResource : <color:#8D8D8D>CRUD de readers\r
...
skinparam rectangle<<IntegrationHubQuarkusAppPackages>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
...
skinparam rectangle<<IntegrationHubQuarkusAppSourceCatalogService>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppReaderCatalogService>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
...
skinparam rectangle<<IntegrationHubQuarkusAppRepositories>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
...
skinparam rectangle<<IntegrationHubQuarkusAppDomainEntities>>{\r
  BackgroundColor #fec119\r
  FontColor #4d2a00\r
  BorderColor #e2a90c\r
}\r
skinparam rectangle<<Db>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
...
\r
    ...
    rectangle "==Package Structure" <<IntegrationHubQuarkusAppPackages>> as IntegrationHubQuarkusAppPackages\r
    rectangle "==ProcessDefinitionResource" <<IntegrationHubQuarkusAppProcessDefinitionResource>> as IntegrationHubQuarkusAppProcessDefinitionResource\r
    rectangle "==SourceDefinitionResource" <<IntegrationHubQuarkusAppSourceDefinitionResource>> as IntegrationHubQuarkusAppSourceDefinitionResource\r
    rectangle "==ReaderDefinitionResource" <<IntegrationHubQuarkusAppReaderDefinitionResource>> as IntegrationHubQuarkusAppReaderDefinitionResource\r
    rectangle "==ProcessExecutionResource" <<IntegrationHubQuarkusAppProcessExecutionResource>> as IntegrationHubQuarkusAppProcessExecutionResource\r
    ...
    rectangle "==SourceCatalogService" <<IntegrationHubQuarkusAppSourceCatalogService>> as IntegrationHubQuarkusAppSourceCatalogService\r
    rectangle "==ReaderCatalogService" <<IntegrationHubQuarkusAppReaderCatalogService>> as IntegrationHubQuarkusAppReaderCatalogService\r
    ...
    rectangle "==Repositories" <<IntegrationHubQuarkusAppRepositories>> as IntegrationHubQuarkusAppRepositories\r
...
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppSourceCatalogService : <color:#8D8D8D>Delega gestion de sources\r
IntegrationHubQuarkusAppReaderDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppReaderCatalogService : <color:#8D8D8D>Delega gestion de readers\r
...
IntegrationHubQuarkusAppProcessCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppRepositories : <color:#8D8D8D>[...]\r
IntegrationHubQuarkusAppSourceCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppRepositories : <color:#8D8D8D>Persiste sources\r
IntegrationHubQuarkusAppReaderCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppRepositories : <color:#8D8D8D>Persiste readers\r
...
IntegrationHubQuarkusAppProcessScheduleQueryService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppRepositories : <color:#8D8D8D>Consulta programaciones\r
IntegrationHubQuarkusAppExecutionQueryService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppRepositories : <color:#8D8D8D>[...]\r
IntegrationHubQuarkusAppRepositories .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntities : <color:#8D8D8D>Lee y persiste\r
User .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catalogos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
...
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppReaderDefinitionResource : <color:#8D8D8D>CRUD de readers\r
...
IntegrationHubQuarkusAppProcessEngine .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Batch insert, update y upsert internos\r
IntegrationHubQuarkusAppRepositories .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Opera sobre PostgreSQL\r
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Autenticacion OIDC\r
...
skinparam rectangle<<IntegrationHubQuarkusAppRepositoriesProcessDefinitionRepository>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppRepositoriesSourceDefinitionRepository>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppRepositoriesReaderDefinitionRepository>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppRepositoriesProcessTaskDefinitionRepository>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppRepositoriesProcessExecutionRepository>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppRepositoriesProcessTaskExecutionRepository>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppRepositoriesAuditEventRepository>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
...
\r
    rectangle "==OpenTelemetry Instrumentation" <<IntegrationHubQuarkusAppTelemetry>> as IntegrationHubQuarkusAppTelemetry\r
    rectangle "Repositories" <<IntegrationHubQuarkusAppRepositories>> as IntegrationHubQuarkusAppRepositories {\r
      skinparam RectangleBorderColor<<IntegrationHubQuarkusAppRepositories>> #3b82f6\r
      skinparam RectangleFontColor<<IntegrationHubQuarkusAppRepositories>> #3b82f6\r
      skinparam RectangleBorderStyle<<IntegrationHubQuarkusAppRepositories>> dashed\r
\r
      rectangle "==ProcessDefinitionRepository" <<IntegrationHubQuarkusAppRepositoriesProcessDefinitionRepository>> as IntegrationHubQuarkusAppRepositoriesProcessDefinitionRepository\r
      rectangle "==SourceDefinitionRepository" <<IntegrationHubQuarkusAppRepositoriesSourceDefinitionRepository>> as IntegrationHubQuarkusAppRepositoriesSourceDefinitionRepository\r
      rectangle "==ReaderDefinitionRepository" <<IntegrationHubQuarkusAppRepositoriesReaderDefinitionRepository>> as IntegrationHubQuarkusAppRepositoriesReaderDefinitionRepository\r
      rectangle "==ProcessTaskDefinitionRepository" <<IntegrationHubQuarkusAppRepositoriesProcessTaskDefinitionRepository>> as IntegrationHubQuarkusAppRepositoriesProcessTaskDefinitionRepository\r
      rectangle "==ProcessExecutionRepository" <<IntegrationHubQuarkusAppRepositoriesProcessExecutionRepository>> as IntegrationHubQuarkusAppRepositoriesProcessExecutionRepository\r
      rectangle "==ProcessTaskExecutionRepository" <<IntegrationHubQuarkusAppRepositoriesProcessTaskExecutionRepository>> as IntegrationHubQuarkusAppRepositoriesProcessTaskExecutionRepository\r
      rectangle "==AuditEventRepository" <<IntegrationHubQuarkusAppRepositoriesAuditEventRepository>> as IntegrationHubQuarkusAppRepositoriesAuditEventRepository\r
    }\r
    rectangle "==ProcessExecutionResource" <<IntegrationHubQuarkusAppProcessExecutionResource>> as IntegrationHubQuarkusAppProcessExecutionResource\r
    rectangle "==ProcessExecutionService" <<IntegrationHubQuarkusAppProcessExecutionService>> as IntegrationHubQuarkusAppProcessExecutionService\r
    rectangle "Process Engine" <<IntegrationHubQuarkusAppProcessEngine>> as IntegrationHubQuarkusAppProcessEngine {\r
...
IntegrationHubQuarkusAppProcessExecutionService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppAuditService : <color:#8D8D8D>Registra eventos\r
IntegrationHubQuarkusAppProcessEngineTaskProviders .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Batch insert, update y upsert internos\r
...
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> ObservabilityOtel : <color:#8D8D8D>Exporta trazas\r
@enduml\r
`;case"package_structure_code":return`@startuml\r
title "Package Structure"\r
top to bottom direction\r
\r
hide stereotype\r
skinparam ranksep 60\r
...
\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesProviderPackageProviderSourcePackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesProviderPackageProviderReaderPackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesProviderPackageProviderTaskPackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesApiPackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesApiQueryPackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesServicePackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesRepositoryPackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesSpiPackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesDomainPackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppPackagesEntityPackage>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
...
\r
  rectangle "Package Structure" <<IntegrationHubQuarkusAppPackages>> as IntegrationHubQuarkusAppPackages {\r
    skinparam RectangleBorderColor<<IntegrationHubQuarkusAppPackages>> #3b82f6\r
    skinparam RectangleFontColor<<IntegrationHubQuarkusAppPackages>> #3b82f6\r
    skinparam RectangleBorderStyle<<IntegrationHubQuarkusAppPackages>> dashed\r
\r
    rectangle "provider" <<IntegrationHubQuarkusAppPackagesProviderPackage>> as IntegrationHubQuarkusAppPackagesProviderPackage {\r
      skinparam RectangleBorderColor<<IntegrationHubQuarkusAppPackagesProviderPackage>> #3b82f6\r
      skinparam RectangleFontColor<<IntegrationHubQuarkusAppPackagesProviderPackage>> #3b82f6\r
      skinparam RectangleBorderStyle<<IntegrationHubQuarkusAppPackagesProviderPackage>> dashed\r
\r
      rectangle "==provider.source" <<IntegrationHubQuarkusAppPackagesProviderPackageProviderSourcePackage>> as IntegrationHubQuarkusAppPackagesProviderPackageProviderSourcePackage\r
      rectangle "==provider.reader" <<IntegrationHubQuarkusAppPackagesProviderPackageProviderReaderPackage>> as IntegrationHubQuarkusAppPackagesProviderPackageProviderReaderPackage\r
      rectangle "==provider.task" <<IntegrationHubQuarkusAppPackagesProviderPackageProviderTaskPackage>> as IntegrationHubQuarkusAppPackagesProviderPackageProviderTaskPackage\r
    }\r
    rectangle "==api" <<IntegrationHubQuarkusAppPackagesApiPackage>> as IntegrationHubQuarkusAppPackagesApiPackage\r
    rectangle "==api.query" <<IntegrationHubQuarkusAppPackagesApiQueryPackage>> as IntegrationHubQuarkusAppPackagesApiQueryPackage\r
    rectangle "==service" <<IntegrationHubQuarkusAppPackagesServicePackage>> as IntegrationHubQuarkusAppPackagesServicePackage\r
    rectangle "==repository" <<IntegrationHubQuarkusAppPackagesRepositoryPackage>> as IntegrationHubQuarkusAppPackagesRepositoryPackage\r
    rectangle "==spi" <<IntegrationHubQuarkusAppPackagesSpiPackage>> as IntegrationHubQuarkusAppPackagesSpiPackage\r
    rectangle "==domain" <<IntegrationHubQuarkusAppPackagesDomainPackage>> as IntegrationHubQuarkusAppPackagesDomainPackage\r
    rectangle "==entity" <<IntegrationHubQuarkusAppPackagesEntityPackage>> as IntegrationHubQuarkusAppPackagesEntityPackage\r
  }\r
}\r
\r
IntegrationHubQuarkusAppPackagesApiPackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesApiQueryPackage : <color:#8D8D8D>Expone DTOs y respuestas\r
IntegrationHubQuarkusAppPackagesApiPackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesServicePackage : <color:#8D8D8D>Invoca servicios\r
IntegrationHubQuarkusAppPackagesApiQueryPackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesServicePackage : <color:#8D8D8D>Consume consultas\r
IntegrationHubQuarkusAppPackagesServicePackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesRepositoryPackage : <color:#8D8D8D>Accede a persistencia\r
IntegrationHubQuarkusAppPackagesServicePackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesSpiPackage : <color:#8D8D8D>Orquesta contratos\r
IntegrationHubQuarkusAppPackagesServicePackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesDomainPackage : <color:#8D8D8D>Usa enums y tipos\r
IntegrationHubQuarkusAppPackagesRepositoryPackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesEntityPackage : <color:#8D8D8D>Persiste entidades\r
IntegrationHubQuarkusAppPackagesProviderPackageProviderSourcePackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesSpiPackage : <color:#8D8D8D>Implementa SourceProvider\r
IntegrationHubQuarkusAppPackagesProviderPackageProviderReaderPackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesSpiPackage : <color:#8D8D8D>Implementa ReaderProvider\r
IntegrationHubQuarkusAppPackagesProviderPackageProviderTaskPackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesRepositoryPackage : <color:#8D8D8D>Colabora con persistencia\r
IntegrationHubQuarkusAppPackagesProviderPackageProviderTaskPackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesSpiPackage : <color:#8D8D8D>Implementa TaskProvider\r
IntegrationHubQuarkusAppPackagesProviderPackageProviderTaskPackage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPackagesDomainPackage : <color:#8D8D8D>Usa estados y tipos\r
@enduml\r
`;case"domain_entities_code":return`@startuml\r
title "Domain Entities"\r
top to bottom direction\r
\r
hide stereotype\r
skinparam ranksep 60\r
...
\r
skinparam rectangle<<IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesSourceDefinitionEntity>>{\r
  BackgroundColor #fec119\r
  FontColor #4d2a00\r
  BorderColor #e2a90c\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesReaderDefinitionEntity>>{\r
  BackgroundColor #fec119\r
  FontColor #4d2a00\r
  BorderColor #e2a90c\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessDefinitionEntity>>{\r
  BackgroundColor #fec119\r
  FontColor #4d2a00\r
  BorderColor #e2a90c\r
}\r
...
skinparam rectangle<<IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity>>{\r
  BackgroundColor #fec119\r
  FontColor #4d2a00\r
  BorderColor #e2a90c\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessExecutionEntity>>{\r
  BackgroundColor #fec119\r
  FontColor #4d2a00\r
  BorderColor #e2a90c\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessTaskExecutionEntity>>{\r
  BackgroundColor #fec119\r
  FontColor #4d2a00\r
  BorderColor #e2a90c\r
}\r
skinparam rectangle<<IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesAuditEventEntity>>{\r
  BackgroundColor #fec119\r
  FontColor #4d2a00\r
  BorderColor #e2a90c\r
}\r
...
\r
  rectangle "Domain Entities" <<IntegrationHubQuarkusAppDomainEntities>> as IntegrationHubQuarkusAppDomainEntities {\r
    skinparam RectangleBorderColor<<IntegrationHubQuarkusAppDomainEntities>> #fec119\r
    skinparam RectangleFontColor<<IntegrationHubQuarkusAppDomainEntities>> #fec119\r
    skinparam RectangleBorderStyle<<IntegrationHubQuarkusAppDomainEntities>> dashed\r
\r
    rectangle "Catalog" <<IntegrationHubQuarkusAppDomainEntitiesCatalogEntities>> as IntegrationHubQuarkusAppDomainEntitiesCatalogEntities {\r
      skinparam RectangleBorderColor<<IntegrationHubQuarkusAppDomainEntitiesCatalogEntities>> #3b82f6\r
      skinparam RectangleFontColor<<IntegrationHubQuarkusAppDomainEntitiesCatalogEntities>> #3b82f6\r
      skinparam RectangleBorderStyle<<IntegrationHubQuarkusAppDomainEntitiesCatalogEntities>> dashed\r
\r
      rectangle "==SourceDefinition" <<IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesSourceDefinitionEntity>> as IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesSourceDefinitionEntity\r
      rectangle "==ReaderDefinition" <<IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesReaderDefinitionEntity>> as IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesReaderDefinitionEntity\r
      rectangle "==ProcessDefinition" <<IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessDefinitionEntity>> as IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessDefinitionEntity\r
      rectangle "==ProcessTaskDefinition" <<IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity>> as IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity\r
    }\r
    rectangle "Execution" <<IntegrationHubQuarkusAppDomainEntitiesExecutionEntities>> as IntegrationHubQuarkusAppDomainEntitiesExecutionEntities {\r
      skinparam RectangleBorderColor<<IntegrationHubQuarkusAppDomainEntitiesExecutionEntities>> #3b82f6\r
      skinparam RectangleFontColor<<IntegrationHubQuarkusAppDomainEntitiesExecutionEntities>> #3b82f6\r
      skinparam RectangleBorderStyle<<IntegrationHubQuarkusAppDomainEntitiesExecutionEntities>> dashed\r
\r
      rectangle "==ProcessExecution" <<IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessExecutionEntity>> as IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessExecutionEntity\r
      rectangle "==ProcessTaskExecution" <<IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessTaskExecutionEntity>> as IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessTaskExecutionEntity\r
      rectangle "==AuditEvent" <<IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesAuditEventEntity>> as IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesAuditEventEntity\r
    }\r
  }\r
}\r
rectangle "==PostgreSQL" <<Db>> as Db\r
\r
IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesSourceDefinitionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity : <color:#8D8D8D>0..n taskDefinitions\r
IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesReaderDefinitionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity : <color:#8D8D8D>0..n taskDefinitions\r
IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessDefinitionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity : <color:#8D8D8D>0..n taskDefinitions\r
IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessDefinitionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessExecutionEntity : <color:#8D8D8D>0..n processExecutions\r
IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessTaskExecutionEntity : <color:#8D8D8D>0..n taskExecutions\r
IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesAuditEventEntity : <color:#8D8D8D>0..n auditEvents\r
IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessExecutionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessTaskExecutionEntity : <color:#8D8D8D>0..n taskExecutions\r
IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessExecutionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesAuditEventEntity : <color:#8D8D8D>0..n auditEvents\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Persiste configuracion, jobs, auditoria y staging\r
@enduml\r
...
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppSourceCatalogService : <color:#8D8D8D>Delega alta de catalogo\r
IntegrationHubQuarkusAppSourceCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppRepositoriesSourceDefinitionRepository : <color:#8D8D8D>Persiste source definition\r
IntegrationHubQuarkusAppRepositoriesSourceDefinitionRepository .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Guarda source definition\r
@enduml\r
...
IntegrationHubAdminConsoleProcessDesigner .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppReaderDefinitionResource : <color:#8D8D8D>Registra reader definition\r
IntegrationHubQuarkusAppReaderDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppReaderCatalogService : <color:#8D8D8D>Delega alta de catalogo\r
IntegrationHubQuarkusAppReaderCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppRepositoriesReaderDefinitionRepository : <color:#8D8D8D>Persiste reader definition\r
IntegrationHubQuarkusAppRepositoriesReaderDefinitionRepository .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Guarda reader definition\r
@enduml\r
...
IntegrationHubQuarkusAppProcessCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppRepositoriesProcessDefinitionRepository : <color:#8D8D8D>Persiste definicion\r
IntegrationHubQuarkusAppProcessCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppRepositoriesProcessTaskDefinitionRepository : <color:#8D8D8D>Persiste tasks\r
IntegrationHubQuarkusAppRepositoriesProcessDefinitionRepository .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Guarda process definition\r
IntegrationHubQuarkusAppRepositoriesProcessTaskDefinitionRepository .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Guarda process tasks\r
@enduml\r
