...
IntegrationAdmin -> IntegrationHub: "Administra catÃƒÂ¡logos y procesos"\r
Operator -> IntegrationHub: "Ejecuta procesos"\r
Auditor -> IntegrationHub: "Consulta auditorÃƒÂ­a y resultados"\r
SchedulerActor -> IntegrationHub: "UC-05"\r
IntegrationHub -> ExternalApi: "[...]"\r
IntegrationHub -> Iam: "[...]"\r
IntegrationHub -> Db: "[...]"\r
LoadBalancer -> IngressController: "ReenvÃƒÂ­a trÃƒÂ¡fico al cluster"\r
...
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catÃƒÂ¡logos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
Auditor -> IntegrationHub.AdminConsole: "Consulta auditorÃƒÂ­a y resultados"\r
IntegrationHub.AdminConsole -> Iam: "AutenticaciÃƒÂ³n OIDC"\r
IntegrationHub.QuarkusApp -> Iam: "Valida access tokens"\r
IntegrationHub.QuarkusApp -> Db: "Persiste configuraciÃƒÂ³n, jobs, auditorÃƒÂ­a y staging"\r
...
\r
IntegrationHub.AdminConsole.ReactApp -> IntegrationHub.AdminConsole.OidcClient: "Gestiona sesiÃƒÂ³n"\r
IntegrationHub.AdminConsole.ReactApp -> IntegrationHub.AdminConsole.ProcessDesigner: "Configura catÃƒÂ¡logos y procesos"\r
...
IntegrationHub.AdminConsole.OperationsConsole -> IntegrationHub.QuarkusApp.ExecutionQueryResource: "Consulta ejecuciones y auditorÃƒÂ­a"\r
User -> IntegrationHub.AdminConsole: "Consulta estado y resultados"\r
Admin -> IntegrationHub.AdminConsole: "Configura fuentes, readers y procesos"\r
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catÃƒÂ¡logos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
...
\r
IntegrationHub.QuarkusApp.ProcessDefinitionResource -> IntegrationHub.QuarkusApp.ProcessCatalogService: "Delega gestiÃƒÂ³n de procesos"\r
IntegrationHub.QuarkusApp.SourceDefinitionResource -> IntegrationHub.QuarkusApp.ProcessCatalogService: "Delega gestiÃƒÂ³n de sources"\r
IntegrationHub.QuarkusApp.ProcessExecutionResource -> IntegrationHub.QuarkusApp.ProcessExecutionService: "Delega ejecuciÃƒÂ³n"\r
...
IntegrationHub.QuarkusApp.ExecutionQueryService -> IntegrationHub.QuarkusApp.PersistenceLayer: "Consulta ejecuciones y auditorÃƒÂ­a"\r
User -> IntegrationHub.AdminConsole: "Consulta estado y resultados"\r
Admin -> IntegrationHub.AdminConsole: "Configura fuentes, readers y procesos"\r
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catÃƒÂ¡logos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
...
IntegrationHub.AdminConsole -> IntegrationHub.QuarkusApp.ExecutionQueryResource: "Consulta ejecuciones y auditorÃƒÂ­a"\r
...
IntegrationHub.AdminConsole.OperationsConsole -> IntegrationHub.QuarkusApp.ProcessExecutionResource: "Ejecuta procesos"\r
IntegrationHub.QuarkusApp.ProcessExecutionResource -> IntegrationHub.QuarkusApp.ProcessExecutionService: "Delega ejecuciÃƒÂ³n"\r
IntegrationHub.QuarkusApp.ProcessExecutionService -> IntegrationHub.QuarkusApp.ProcessEngine.JsonConfigurationMapper: "Lee configuraciÃƒÂ³n JSON"\r
...
IntegrationAdmin -> IntegrationHubAdminConsole: "Administra catÃƒÂ¡logos y procesos"\r
Operator -> IntegrationHubAdminConsole: "Ejecuta procesos"\r
Auditor -> IntegrationHubAdminConsole: "Consulta auditorÃƒÂ­a y resultados"\r
...
ProdEdge.LoadBalancer.LoadBalancer -> ProdApp.AppCluster.IngressController.IngressController: "ReenvÃƒÂ­a trÃƒÂ¡fico al cluster"\r
...
ProdApp.AppCluster.AppService -> ProdApp.AppCluster.AppPod1: "Balancea trÃƒÂ¡fico HTTP"\r
ProdApp.AppCluster.AppService -> ProdApp.AppCluster.AppPod2: "Balancea trÃƒÂ¡fico HTTP"\r
...
\r
IntegrationAdmin -> IntegrationHubAdminConsoleProcessDesigner: "Define tipo de fuente y parÃƒÂ¡metros"\r
IntegrationHubAdminConsoleProcessDesigner -> IntegrationHubQuarkusAppSourceDefinitionResource: "Registra source definition"\r
IntegrationHubQuarkusAppSourceDefinitionResource -> IntegrationHubQuarkusAppProcessCatalogService: "Delega alta de catÃƒÂ¡logo"\r
...
IntegrationHubQuarkusAppProcessDefinitionResource -> IntegrationHubQuarkusAppProcessCatalogService: "Delega alta de catÃƒÂ¡logo"\r
...
IntegrationHubQuarkusAppProcessCatalogService -> IntegrationHubQuarkusAppPersistenceLayer: "Persiste definiciÃƒÂ³n"\r
...
IntegrationHubAdminConsoleOperationsConsole -> IntegrationHubQuarkusAppProcessExecutionResource: "Solicita ejecuciÃƒÂ³n"\r
IntegrationHubQuarkusAppProcessExecutionResource -> IntegrationHubQuarkusAppProcessExecutionService: "Delega ejecuciÃƒÂ³n"\r
...
IntegrationHubQuarkusAppProcessEngine.TaskProvidersRestCallTaskProvider -> ExternalApi: "EnvÃƒÂ­a payload"\r
...
IntegrationHubQuarkusAppProcessSchedulerService -> IntegrationHubQuarkusAppProcessExecutionService: "Lanza ejecuciÃƒÂ³n"\r
...
ObservabilityOtel -> ObservabilityJaeger: "Publica visualizaciÃƒÂ³n"\r
...
IntegrationHubAdminConsoleOidcClient -> Iam: "Solicita autenticaciÃƒÂ³n OIDC"\r
