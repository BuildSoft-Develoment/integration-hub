...
\r
IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.SourceDefinitionEntity: "0..1 sourceDefinition"\r
IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ReaderDefinitionEntity: "0..1 readerDefinition"\r
IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity -> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity: "1..n tasks"\r
IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity -> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity: "n..1 processDefinition"\r
IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity -> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity: "n..1 taskDefinition"\r
IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity -> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity: "0..1 taskDefinition"\r
IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity -> IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity: "n..1 processExecution"\r
IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity -> IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity: "n..1 processExecution"\r
IntegrationHub.QuarkusApp -> Db: "Persiste configuracion, jobs, auditoria y staging"\r
