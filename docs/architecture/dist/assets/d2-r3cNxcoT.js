...
IntegrationHub.QuarkusApp.SourceDefinitionResource -> IntegrationHub.QuarkusApp.ProcessCatalogService: "Delega gestion de sources"\r
...
IntegrationHub.QuarkusApp.ExecutionQueryService -> IntegrationHub.QuarkusApp.PersistenceLayer: "Consulta ejecuciones y auditoria"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities: "Lee y persiste"\r
User -> IntegrationHub.AdminConsole: "Consulta estado y resultados"\r
Admin -> IntegrationHub.AdminConsole: "Configura fuentes, readers y procesos"\r
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catalogos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
...
IntegrationHub.QuarkusApp -> FileSources.RestSource: "Obtiene payloads remotos"\r
IntegrationHub.QuarkusApp -> Observability.Otel: "Exporta trazas"\r
`;case"domain_catalog_entities_code":return`direction: down\r
\r
IntegrationHub: {\r
  label: "Integration Hub Platform"\r
\r
...
\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities.SourceDefinitionEntity: "Lee y persiste"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities.ReaderDefinitionEntity: "Lee y persiste"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity: "Lee y persiste"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity: "Lee y persiste"\r
IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity -> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity: "1..n tasks"\r
IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity -> IntegrationHub.QuarkusApp.DomainEntities.SourceDefinitionEntity: "0..1 sourceDefinition"\r
IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity -> IntegrationHub.QuarkusApp.DomainEntities.ReaderDefinitionEntity: "0..1 readerDefinition"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> Db: "Opera sobre PostgreSQL"\r
`;case"domain_execution_entities_code":return`direction: down\r
\r
IntegrationHub: {\r
  label: "Integration Hub Platform"\r
\r
...
\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity: "Lee y persiste"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity: "Lee y persiste"\r
IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity -> IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity: "n..1 processExecution"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity: "Lee y persiste"\r
IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity -> IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity: "n..1 processExecution"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity: "Lee y persiste"\r
IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity -> IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity: "n..1 processDefinition"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity: "Lee y persiste"\r
IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity -> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity: "n..1 taskDefinition"\r
IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity -> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity: "0..1 taskDefinition"\r
IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity -> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity: "1..n tasks"\r
IntegrationHub.QuarkusApp.PersistenceLayer -> Db: "Opera sobre PostgreSQL"\r
...
IntegrationHubQuarkusAppSourceDefinitionResource -> IntegrationHubQuarkusAppProcessCatalogService: "Delega alta de catalogo"\r
