...
IntegrationHubAdminConsole.ReactApp -> IntegrationHubAdminConsole.ProcessDesigner: "Configura catalogos y procesos"\r
IntegrationHubAdminConsole.ReactApp -> IntegrationHubAdminConsole.OperationsConsole: "Consulta y ejecuta procesos"\r
IntegrationHubAdminConsole.OidcClient -> Iam: "Login y refresh token"\r
IntegrationHubAdminConsole.ProcessDesigner -> IntegrationHubQuarkusAppProcessDefinitionResource: "CRUD de definiciones"\r
IntegrationHubAdminConsole.OperationsConsole -> IntegrationHubQuarkusAppProcessExecutionResource: "Ejecuta procesos"\r
IntegrationHubAdminConsole.OperationsConsole -> IntegrationHubQuarkusAppProcessScheduleResource: "Consulta programaciones"\r
IntegrationHubAdminConsole.OperationsConsole -> IntegrationHubQuarkusAppExecutionQueryResource: "Consulta ejecuciones y auditoria"\r
...
\r
IntegrationHubQuarkusApp.ProcessDefinitionResource -> IntegrationHubQuarkusApp.ProcessCatalogService: "Delega gestion de procesos"\r
IntegrationHubQuarkusApp.ProcessExecutionResource -> IntegrationHubQuarkusApp.ProcessExecutionService: "Delega ejecucion"\r
IntegrationHubQuarkusApp.ProcessScheduleResource -> IntegrationHubQuarkusApp.ProcessScheduleQueryService: "Delega consulta de schedules"\r
IntegrationHubQuarkusApp.ExecutionQueryResource -> IntegrationHubQuarkusApp.ExecutionQueryService: "Delega consultas operativas"\r
IntegrationHubQuarkusApp.ProcessCatalogService -> IntegrationHubQuarkusApp.PersistenceLayer: "Persiste definiciones"\r
IntegrationHubQuarkusApp.ProcessExecutionService -> IntegrationHubQuarkusApp.ProcessEngine: "[...]"\r
IntegrationHubQuarkusApp.ProcessExecutionService -> IntegrationHubQuarkusApp.AuditService: "Registra eventos"\r
IntegrationHubQuarkusApp.ProcessSchedulerService -> IntegrationHubQuarkusApp.ProcessExecutionService: "Dispara procesos programados"\r
IntegrationHubQuarkusApp.ProcessScheduleQueryService -> IntegrationHubQuarkusApp.PersistenceLayer: "Consulta programaciones"\r
IntegrationHubQuarkusApp.ExecutionQueryService -> IntegrationHubQuarkusApp.PersistenceLayer: "Consulta ejecuciones y auditoria"\r
IntegrationHubQuarkusApp.ProcessEngine -> Db: "Batch insert, update y upsert"\r
IntegrationHubQuarkusApp.PersistenceLayer -> Db: "Opera sobre PostgreSQL"\r
