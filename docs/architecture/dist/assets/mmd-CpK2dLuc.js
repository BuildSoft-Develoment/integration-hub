...
graph TB\r
  ...
  User -. "\`Accede por HTTPS\`" .-> OnPrem\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub\r
  Admin -. "\`Administra por HTTPS\`" .-> OnPrem\r
