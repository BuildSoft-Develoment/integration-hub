...
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode1 : <color:#8D8D8D>Balancea trafico HTTP\r
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode2 : <color:#8D8D8D>Balancea trafico HTTP\r
