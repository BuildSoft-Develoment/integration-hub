...
graph LR\r
  ...
  PlatformAdmin -. "\`Valida acceso a consola\`" .-> IntegrationHubAdminConsole.OidcClient\r
  IntegrationHubAdminConsole.OidcClient -. "\`Solicita autenticacion OIDC\`" .-> Iam\r
  IntegrationHubAdminConsole -. "\`Invoca APIs protegidas\`" .-> IntegrationHubQuarkusApp\r
  IntegrationHubQuarkusApp -. "\`Valida tokens y roles\`" .-> Iam\r
