...
IntegrationAdmin -> IntegrationHub: "Administra catálogos y procesos"\r
Operator -> IntegrationHub: "Ejecuta procesos"\r
Auditor -> IntegrationHub: "Consulta auditoría y resultados"\r
SchedulerActor -> IntegrationHub: "UC-05"\r
IntegrationHub -> ExternalApi: "[...]"\r
IntegrationHub -> Iam: "[...]"\r
IntegrationHub -> Db: "[...]"\r
LoadBalancer -> IngressController: "Reenvía tráfico al cluster"\r
...
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catálogos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
Auditor -> IntegrationHub.AdminConsole: "Consulta auditoría y resultados"\r
IntegrationHub.AdminConsole -> Iam: "Autenticación OIDC"\r
IntegrationHub.QuarkusApp -> Iam: "Valida access tokens"\r
IntegrationHub.QuarkusApp -> Db: "Persiste configuración, jobs, auditoría y staging"\r
...
\r
IntegrationHub.AdminConsole.ReactApp -> IntegrationHub.AdminConsole.OidcClient: "Gestiona sesión"\r
IntegrationHub.AdminConsole.ReactApp -> IntegrationHub.AdminConsole.ProcessDesigner: "Configura catálogos y procesos"\r
...
IntegrationHub.AdminConsole.OperationsConsole -> IntegrationHub.QuarkusApp.ExecutionQueryResource: "Consulta ejecuciones y auditoría"\r
User -> IntegrationHub.AdminConsole: "Consulta estado y resultados"\r
Admin -> IntegrationHub.AdminConsole: "Configura fuentes, readers y procesos"\r
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catálogos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
...
\r
IntegrationHub.QuarkusApp.ProcessDefinitionResource -> IntegrationHub.QuarkusApp.ProcessCatalogService: "Delega gestión de procesos"\r
IntegrationHub.QuarkusApp.SourceDefinitionResource -> IntegrationHub.QuarkusApp.ProcessCatalogService: "Delega gestión de sources"\r
IntegrationHub.QuarkusApp.ProcessExecutionResource -> IntegrationHub.QuarkusApp.ProcessExecutionService: "Delega ejecución"\r
...
IntegrationHub.QuarkusApp.ExecutionQueryService -> IntegrationHub.QuarkusApp.PersistenceLayer: "Consulta ejecuciones y auditoría"\r
User -> IntegrationHub.AdminConsole: "Consulta estado y resultados"\r
Admin -> IntegrationHub.AdminConsole: "Configura fuentes, readers y procesos"\r
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catálogos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
...
IntegrationHub.AdminConsole -> IntegrationHub.QuarkusApp.ExecutionQueryResource: "Consulta ejecuciones y auditoría"\r
...
\r
IntegrationHub.QuarkusApp.ProcessExecutionService -> IntegrationHub.QuarkusApp.ProcessEngine.JsonConfigurationMapper: "Lee configuración JSON"\r
...
IntegrationAdmin -> IntegrationHubAdminConsole: "Administra catálogos y procesos"\r
Operator -> IntegrationHubAdminConsole: "Ejecuta procesos"\r
Auditor -> IntegrationHubAdminConsole: "Consulta auditoría y resultados"\r
...
ProdEdge.LoadBalancer.LoadBalancer -> ProdApp.AppCluster.IngressController.IngressController: "Reenvía tráfico al cluster"\r
...
ProdApp.AppCluster.AppService -> ProdApp.AppCluster.AppPod1: "Balancea tráfico HTTP"\r
ProdApp.AppCluster.AppService -> ProdApp.AppCluster.AppPod2: "Balancea tráfico HTTP"\r
...
\r
IntegrationAdmin -> IntegrationHubAdminConsoleProcessDesigner: "Define tipo de fuente y parámetros"\r
IntegrationHubAdminConsoleProcessDesigner -> IntegrationHubQuarkusAppSourceDefinitionResource: "Registra source definition"\r
IntegrationHubQuarkusAppSourceDefinitionResource -> IntegrationHubQuarkusAppProcessCatalogService: "Delega alta de catálogo"\r
...
IntegrationHubQuarkusAppProcessDefinitionResource -> IntegrationHubQuarkusAppProcessCatalogService: "Delega alta de catálogo"\r
...
IntegrationHubQuarkusAppProcessCatalogService -> IntegrationHubQuarkusAppPersistenceLayer: "Persiste definición"\r
...
IntegrationHubAdminConsoleOperationsConsole -> IntegrationHubQuarkusAppProcessExecutionResource: "Solicita ejecución"\r
IntegrationHubQuarkusAppProcessExecutionResource -> IntegrationHubQuarkusAppProcessExecutionService: "Delega ejecución"\r
...
IntegrationHubQuarkusAppProcessEngine.TaskProvidersRestCallTaskProvider -> ExternalApi: "Envía payload"\r
...
IntegrationHubQuarkusAppProcessSchedulerService -> IntegrationHubQuarkusAppProcessExecutionService: "Lanza ejecución"\r
...
ObservabilityOtel -> ObservabilityJaeger: "Publica visualización"\r
...
IntegrationHubAdminConsoleOidcClient -> Iam: "Solicita autenticación OIDC"\r
