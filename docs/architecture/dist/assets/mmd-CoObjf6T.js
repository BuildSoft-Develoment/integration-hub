...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catÃƒÆ’Ã‚Â¡logos y procesos\`" .-> IntegrationHub\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub\r
  Auditor -. "\`Consulta auditorÃƒÆ’Ã‚Â­a y resultados\`" .-> IntegrationHub\r
  SchedulerActor -. "\`UC-05\`" .-> IntegrationHub\r
  IntegrationHub -. "\`[...]\`" .-> ExternalApi\r
  IntegrationHub -. "\`[...]\`" .-> Iam\r
  IntegrationHub -. "\`[...]\`" .-> Db\r
  LoadBalancer -. "\`ReenvÃƒÆ’Ã‚Â­a trÃƒÆ’Ã‚Â¡fico al cluster\`" .-> IngressController\r
...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catÃƒÆ’Ã‚Â¡logos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  Auditor -. "\`Consulta auditorÃƒÆ’Ã‚Â­a y resultados\`" .-> IntegrationHub.AdminConsole\r
  IntegrationHub.AdminConsole -. "\`AutenticaciÃƒÆ’Ã‚Â³n OIDC\`" .-> Iam\r
  IntegrationHub.QuarkusApp -. "\`Valida access tokens\`" .-> Iam\r
  IntegrationHub.QuarkusApp -. "\`Persiste configuraciÃƒÆ’Ã‚Â³n, jobs, auditorÃƒÆ’Ã‚Â­a y staging\`" .-> Db\r
...
graph TB\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  Iam@{ shape: rectangle, label: "Keycloak" }\r
  IntegrationHub.AdminConsole.ReactApp -. "\`Gestiona sesiÃƒÆ’Ã‚Â³n\`" .-> IntegrationHub.AdminConsole.OidcClient\r
  IntegrationHub.AdminConsole.ReactApp -. "\`Configura catÃƒÆ’Ã‚Â¡logos y procesos\`" .-> IntegrationHub.AdminConsole.ProcessDesigner\r
  ...
  IntegrationHub.AdminConsole.OperationsConsole -. "\`Consulta ejecuciones y auditorÃƒÆ’Ã‚Â­a\`" .-> IntegrationHub.QuarkusApp.ExecutionQueryResource\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub.AdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHub.AdminConsole\r
  IntegrationAdmin -. "\`Administra catÃƒÆ’Ã‚Â¡logos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
...
graph TB\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  ExternalApi@{ shape: rectangle, label: "APIs externas" }\r
  IntegrationHub.QuarkusApp.ProcessDefinitionResource -. "\`Delega gestiÃƒÆ’Ã‚Â³n de procesos\`" .-> IntegrationHub.QuarkusApp.ProcessCatalogService\r
  IntegrationHub.QuarkusApp.SourceDefinitionResource -. "\`Delega gestiÃƒÆ’Ã‚Â³n de sources\`" .-> IntegrationHub.QuarkusApp.ProcessCatalogService\r
  IntegrationHub.QuarkusApp.ProcessExecutionResource -. "\`Delega ejecuciÃƒÆ’Ã‚Â³n\`" .-> IntegrationHub.QuarkusApp.ProcessExecutionService\r
  ...
  IntegrationHub.QuarkusApp.ExecutionQueryService -. "\`Consulta ejecuciones y auditorÃƒÆ’Ã‚Â­a\`" .-> IntegrationHub.QuarkusApp.PersistenceLayer\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub.AdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHub.AdminConsole\r
  IntegrationAdmin -. "\`Administra catÃƒÆ’Ã‚Â¡logos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  ...
  IntegrationHub.AdminConsole -. "\`Consulta ejecuciones y auditorÃƒÆ’Ã‚Â­a\`" .-> IntegrationHub.QuarkusApp.ExecutionQueryResource\r
...
graph TB\r
  ...
  IntegrationHub.AdminConsole.OperationsConsole -. "\`Ejecuta procesos\`" .-> IntegrationHub.QuarkusApp.ProcessExecutionResource\r
  IntegrationHub.QuarkusApp.ProcessExecutionResource -. "\`Delega ejecuciÃƒÆ’Ã‚Â³n\`" .-> IntegrationHub.QuarkusApp.ProcessExecutionService\r
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`Lee configuraciÃƒÆ’Ã‚Â³n JSON\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.JsonConfigurationMapper\r
...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catÃƒÆ’Ã‚Â¡logos y procesos\`" .-> IntegrationHubAdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHubAdminConsole\r
  Auditor -. "\`Consulta auditorÃƒÆ’Ã‚Â­a y resultados\`" .-> IntegrationHubAdminConsole\r
...
graph LR\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationAdmin -. "\`Define tipo de fuente y parÃƒÆ’Ã‚Â¡metros\`" .-> IntegrationHubAdminConsoleProcessDesigner\r
  IntegrationHubAdminConsoleProcessDesigner -. "\`Registra source definition\`" .-> IntegrationHubQuarkusAppSourceDefinitionResource\r
  IntegrationHubQuarkusAppSourceDefinitionResource -. "\`Delega alta de catÃƒÆ’Ã‚Â¡logo\`" .-> IntegrationHubQuarkusAppProcessCatalogService\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppProcessDefinitionResource -. "\`Delega alta de catÃƒÆ’Ã‚Â¡logo\`" .-> IntegrationHubQuarkusAppProcessCatalogService\r
...
title: "UC-03 DiseÃƒÆ’Ã‚Â±ar proceso"\r
---\r
graph LR\r
  IntegrationAdmin@{ icon: "fa:user", shape: rounded, label: "Integration Admin" }\r
  IntegrationHubAdminConsoleProcessDesigner@{ shape: rectangle, label: "Process Designer" }\r
  ...
  IntegrationHubQuarkusAppProcessCatalogService -. "\`Persiste definiciÃƒÆ’Ã‚Â³n\`" .-> IntegrationHubQuarkusAppPersistenceLayer\r
...
graph LR\r
  ...
  IntegrationHubAdminConsoleOperationsConsole -. "\`Solicita ejecuciÃƒÆ’Ã‚Â³n\`" .-> IntegrationHubQuarkusAppProcessExecutionResource\r
  IntegrationHubQuarkusAppProcessExecutionResource -. "\`Delega ejecuciÃƒÆ’Ã‚Â³n\`" .-> IntegrationHubQuarkusAppProcessExecutionService\r
  ...
  IntegrationHubQuarkusAppProcessEngine.TaskProvidersRestCallTaskProvider -. "\`EnvÃƒÆ’Ã‚Â­a payload\`" .-> ExternalApi\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppProcessSchedulerService -. "\`Lanza ejecuciÃƒÆ’Ã‚Â³n\`" .-> IntegrationHubQuarkusAppProcessExecutionService\r
  ...
  ObservabilityOtel -. "\`Publica visualizaciÃƒÆ’Ã‚Â³n\`" .-> ObservabilityJaeger\r
...
graph LR\r
  ...
  IntegrationHubAdminConsoleOidcClient -. "\`Solicita autenticaciÃƒÆ’Ã‚Â³n OIDC\`" .-> Iam\r
