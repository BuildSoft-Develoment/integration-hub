...
graph TB\r
  ...
  ExternalDatabases@{ shape: rectangle, label: "External Databases" }\r
  ...
  IntegrationHub -. "\`[...]\`" .-> ExternalDatabases\r
...
graph TB\r
  ...
  subgraph IntegrationHub["\`Integration Hub Platform\`"]\r
    subgraph IntegrationHub.QuarkusApp["\`App Service Quarkus Native\`"]\r
      ...
      IntegrationHub.QuarkusApp.Packages@{ shape: rectangle, label: "Package Structure" }\r
      IntegrationHub.QuarkusApp.ProcessDefinitionResource@{ shape: rectangle, label: "ProcessDefinitionResource" }\r
      IntegrationHub.QuarkusApp.SourceDefinitionResource@{ shape: rectangle, label: "SourceDefinitionResource" }\r
      IntegrationHub.QuarkusApp.ReaderDefinitionResource@{ shape: rectangle, label: "ReaderDefinitionResource" }\r
      IntegrationHub.QuarkusApp.ProcessExecutionResource@{ shape: rectangle, label: "ProcessExecutionResource" }\r
      ...
      IntegrationHub.QuarkusApp.SourceCatalogService@{ shape: rectangle, label: "SourceCatalogService" }\r
      IntegrationHub.QuarkusApp.ReaderCatalogService@{ shape: rectangle, label: "ReaderCatalogService" }\r
      ...
      IntegrationHub.QuarkusApp.Repositories@{ shape: rectangle, label: "Repositories" }\r
      ...
      IntegrationHub.QuarkusApp.DomainEntities@{ shape: rectangle, label: "Domain Entities" }\r
    end\r
    IntegrationHub.AdminConsole@{ shape: rectangle, label: "Admin Console App (Front)" }\r
  end\r
  subgraph FileSources["\`Fuentes externas\`"]\r
  ...
  IntegrationHub.QuarkusApp.SourceDefinitionResource -. "\`Delega gestion de sources\`" .-> IntegrationHub.QuarkusApp.SourceCatalogService\r
  IntegrationHub.QuarkusApp.ReaderDefinitionResource -. "\`Delega gestion de readers\`" .-> IntegrationHub.QuarkusApp.ReaderCatalogService\r
  ...
  IntegrationHub.QuarkusApp.SourceCatalogService -. "\`Persiste sources\`" .-> IntegrationHub.QuarkusApp.Repositories\r
  IntegrationHub.QuarkusApp.ReaderCatalogService -. "\`Persiste readers\`" .-> IntegrationHub.QuarkusApp.Repositories\r
  ...
  IntegrationHub.QuarkusApp.ProcessScheduleQueryService -. "\`Consulta programaciones\`" .-> IntegrationHub.QuarkusApp.Repositories\r
  IntegrationHub.QuarkusApp.ExecutionQueryService -. "\`[...]\`" .-> IntegrationHub.QuarkusApp.Repositories\r
  IntegrationHub.QuarkusApp.Repositories -. "\`Lee y persiste\`" .-> IntegrationHub.QuarkusApp.DomainEntities\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub.AdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHub.AdminConsole\r
  IntegrationAdmin -. "\`Administra catalogos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  Auditor -. "\`Consulta auditoria y resultados\`" .-> IntegrationHub.AdminConsole\r
  IntegrationHub.AdminConsole -. "\`CRUD de procesos\`" .-> IntegrationHub.QuarkusApp.ProcessDefinitionResource\r
  IntegrationHub.AdminConsole -. "\`CRUD de sources\`" .-> IntegrationHub.QuarkusApp.SourceDefinitionResource\r
  IntegrationHub.AdminConsole -. "\`CRUD de readers\`" .-> IntegrationHub.QuarkusApp.ReaderDefinitionResource\r
  IntegrationHub.AdminConsole -. "\`Ejecuta procesos\`" .-> IntegrationHub.QuarkusApp.ProcessExecutionResource\r
  IntegrationHub.AdminConsole -. "\`Consulta programaciones\`" .-> IntegrationHub.QuarkusApp.ProcessScheduleResource\r
  IntegrationHub.AdminConsole -. "\`Consulta ejecuciones y auditoria\`" .-> IntegrationHub.QuarkusApp.ExecutionQueryResource\r
  IntegrationHub.QuarkusApp.ProcessEngine -. "\`Batch insert, update y upsert internos\`" .-> Db\r
...
graph TB\r
  ...
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`Registra eventos\`" .-> IntegrationHub.QuarkusApp.AuditService\r
  IntegrationHub.QuarkusApp.ProcessEngine.TaskProviders -. "\`Batch insert, update y upsert internos\`" .-> Db\r
  ...
  IntegrationHub.QuarkusApp -. "\`Obtiene payloads remotos\`" .-> FileSources.RestSource\r
  IntegrationHub.QuarkusApp -. "\`Exporta trazas\`" .-> Observability.Otel\r
`;case"package_structure_code":return`---\r
title: "Package Structure"\r
---\r
graph TB\r
  subgraph IntegrationHubQuarkusApp["\`App Service Quarkus Native\`"]\r
    subgraph IntegrationHubQuarkusApp.Packages["\`Package Structure\`"]\r
      subgraph IntegrationHubQuarkusApp.Packages.ProviderPackage["\`provider\`"]\r
        IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderSourcePackage@{ shape: rectangle, label: "provider.source" }\r
        IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderReaderPackage@{ shape: rectangle, label: "provider.reader" }\r
        IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderTaskPackage@{ shape: rectangle, label: "provider.task" }\r
      end\r
      IntegrationHubQuarkusApp.Packages.ApiPackage@{ shape: rectangle, label: "api" }\r
      IntegrationHubQuarkusApp.Packages.ApiQueryPackage@{ shape: rectangle, label: "api.query" }\r
      IntegrationHubQuarkusApp.Packages.ServicePackage@{ shape: rectangle, label: "service" }\r
      IntegrationHubQuarkusApp.Packages.RepositoryPackage@{ shape: rectangle, label: "repository" }\r
      IntegrationHubQuarkusApp.Packages.SpiPackage@{ shape: rectangle, label: "spi" }\r
      IntegrationHubQuarkusApp.Packages.DomainPackage@{ shape: rectangle, label: "domain" }\r
      IntegrationHubQuarkusApp.Packages.EntityPackage@{ shape: rectangle, label: "entity" }\r
    end\r
  end\r
  IntegrationHubQuarkusApp.Packages.ApiPackage -. "\`Expone DTOs y respuestas\`" .-> IntegrationHubQuarkusApp.Packages.ApiQueryPackage\r
  IntegrationHubQuarkusApp.Packages.ApiPackage -. "\`Invoca servicios\`" .-> IntegrationHubQuarkusApp.Packages.ServicePackage\r
  IntegrationHubQuarkusApp.Packages.ApiQueryPackage -. "\`Consume consultas\`" .-> IntegrationHubQuarkusApp.Packages.ServicePackage\r
  IntegrationHubQuarkusApp.Packages.ServicePackage -. "\`Accede a persistencia\`" .-> IntegrationHubQuarkusApp.Packages.RepositoryPackage\r
  IntegrationHubQuarkusApp.Packages.ServicePackage -. "\`Orquesta contratos\`" .-> IntegrationHubQuarkusApp.Packages.SpiPackage\r
  IntegrationHubQuarkusApp.Packages.ServicePackage -. "\`Usa enums y tipos\`" .-> IntegrationHubQuarkusApp.Packages.DomainPackage\r
  IntegrationHubQuarkusApp.Packages.RepositoryPackage -. "\`Persiste entidades\`" .-> IntegrationHubQuarkusApp.Packages.EntityPackage\r
  IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderSourcePackage -. "\`Implementa SourceProvider\`" .-> IntegrationHubQuarkusApp.Packages.SpiPackage\r
  IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderReaderPackage -. "\`Implementa ReaderProvider\`" .-> IntegrationHubQuarkusApp.Packages.SpiPackage\r
  IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderTaskPackage -. "\`Colabora con persistencia\`" .-> IntegrationHubQuarkusApp.Packages.RepositoryPackage\r
  IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderTaskPackage -. "\`Implementa TaskProvider\`" .-> IntegrationHubQuarkusApp.Packages.SpiPackage\r
  IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderTaskPackage -. "\`Usa estados y tipos\`" .-> IntegrationHubQuarkusApp.Packages.DomainPackage\r
