...
`;case"domain_catalog_entities_code":return`digraph {
    graph [TBbalance=min,
        bgcolor=transparent,
        compound=true,
        fontname=Arial,
        ...
        labelloc=t,
        layout=dot,
        likec4_viewId=domain_catalog_entities_code,
        nodesep=1.528,
        outputorder=nodesfirst,
        pad=0.209,
        rankdir=TB,
    ...
    subgraph cluster_integrationhub {
        ...
        subgraph cluster_quarkusapp {
            ...
            subgraph cluster_domainentities {
                ...
                processdefinitionentity [group="integrationHub.quarkusApp.domainEntities",
                    height=2.5,
                    label=<<FONT POINT-SIZE="20">ProcessDefinition</FONT>>,
                    likec4_id="integrationHub.quarkusApp.domainEntities.processDefinitionEntity",
                    likec4_level=3,
                    margin="0.223,0.223",
                    width=4.445];
                processtaskdefinitionentity [group="integrationHub.quarkusApp.domainEntities",
                    height=2.5,
                    label=<<FONT POINT-SIZE="20">ProcessTaskDefinition</FONT>>,
                    likec4_id="integrationHub.quarkusApp.domainEntities.processTaskDefinitionEntity",
                    likec4_level=3,
                    margin="0.223,0.223",
                    width=4.445];
                sourcedefinitionentity [group="integrationHub.quarkusApp.domainEntities",
                    height=2.5,
                    label=<<FONT POINT-SIZE="20">SourceDefinition</FONT>>,
                    likec4_id="integrationHub.quarkusApp.domainEntities.sourceDefinitionEntity",
                    likec4_level=3,
                    margin="0.223,0.223",
                    width=4.445];
                readerdefinitionentity [group="integrationHub.quarkusApp.domainEntities",
                    height=2.5,
                    label=<<FONT POINT-SIZE="20">ReaderDefinition</FONT>>,
                    likec4_id="integrationHub.quarkusApp.domainEntities.readerDefinitionEntity",
                    likec4_level=3,
                    margin="0.223,0.223",
                    width=4.445];
            }
    ...
    persistencelayer -> db [arrowhead=normal,
        ...
        minlen=1,
        style=dashed];
    persistencelayer -> processdefinitionentity [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">Lee y persiste</FONT></TD></TR></TABLE>>,
        likec4_id="1xk70nc",
        style=dashed,
        weight=2];
    persistencelayer -> processtaskdefinitionentity [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">Lee y persiste</FONT></TD></TR></TABLE>>,
        likec4_id="14yn5z9",
        style=dashed,
        weight=2];
    persistencelayer -> sourcedefinitionentity [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">Lee y persiste</FONT></TD></TR></TABLE>>,
        likec4_id=z9hofy,
        style=dashed,
        weight=2];
    persistencelayer -> readerdefinitionentity [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">Lee y persiste</FONT></TD></TR></TABLE>>,
        likec4_id="1ixayrq",
        style=dashed,
        weight=2];
...
`;case"domain_execution_entities_code":return`digraph {
    graph [TBbalance=min,
        bgcolor=transparent,
        compound=true,
        fontname=Arial,
        ...
        labelloc=t,
        layout=dot,
        likec4_viewId=domain_execution_entities_code,
        nodesep=1.528,
        outputorder=nodesfirst,
        pad=0.209,
        rankdir=TB,
    ...
    subgraph cluster_integrationhub {
        ...
        subgraph cluster_quarkusapp {
            ...
            subgraph cluster_domainentities {
                ...
                processtaskexecutionentity [group="integrationHub.quarkusApp.domainEntities",
                    height=2.5,
                    label=<<FONT POINT-SIZE="20">ProcessTaskExecution</FONT>>,
                    likec4_id="integrationHub.quarkusApp.domainEntities.processTaskExecutionEntity",
                    likec4_level=3,
                    margin="0.223,0.223",
                    width=4.445];
                auditevententity [group="integrationHub.quarkusApp.domainEntities",
                    height=2.5,
                    label=<<FONT POINT-SIZE="20">AuditEvent</FONT>>,
                    likec4_id="integrationHub.quarkusApp.domainEntities.auditEventEntity",
                    likec4_level=3,
                    margin="0.223,0.223",
                    width=4.445];
                processexecutionentity [group="integrationHub.quarkusApp.domainEntities",
                    height=2.5,
                    label=<<FONT POINT-SIZE="20">ProcessExecution</FONT>>,
                    likec4_id="integrationHub.quarkusApp.domainEntities.processExecutionEntity",
                    likec4_level=3,
                    margin="0.223,0.223",
                    width=4.445];
                processdefinitionentity [group="integrationHub.quarkusApp.domainEntities",
    ...
    persistencelayer -> db [arrowhead=normal,
        ...
        minlen=1,
        style=dashed];
    persistencelayer -> processtaskexecutionentity [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">Lee y persiste</FONT></TD></TR></TABLE>>,
        likec4_id="7on38i",
        style=dashed,
        weight=2];
    persistencelayer -> auditevententity [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">Lee y persiste</FONT></TD></TR></TABLE>>,
        likec4_id=wd6g47,
        style=dashed,
        weight=2];
    persistencelayer -> processexecutionentity [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">Lee y persiste</FONT></TD></TR></TABLE>>,
        likec4_id="14mfj9r",
        style=dashed,
        weight=2];
...
`;case"domain_catalog_entities_code":return`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN"
 "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<!-- Generated by graphviz version 14.1.0 (0)
 -->
<!-- Pages: 1 -->
<svg width="1437pt" height="1430pt"
 viewBox="0.00 0.00 1437.00 1430.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<g id="graph0" class="graph" transform="scale(1 1) rotate(0) translate(15.05 1415.05)">
<g id="clust1" class="cluster">
<title>cluster_integrationhub</title>
<polygon fill="#1c417d" stroke="#1c356c" points="8,-8 8,-1392 1049,-1392 1049,-8 8,-8"/>
<text xml:space="preserve" text-anchor="start" x="16" y="-1379.1" font-family="Arial" font-weight="bold" font-size="11.00" fill="#bfdbfe" fill-opacity="0.701961">INTEGRATION HUB PLATFORM</text>
</g>
<g id="clust2" class="cluster">
<title>cluster_quarkusapp</title>
<polygon fill="#29472f" stroke="#1c3021" points="40,-40 40,-1338.8 1017,-1338.8 1017,-40 40,-40"/>
<text xml:space="preserve" text-anchor="start" x="48" y="-1325.9" font-family="Arial" font-weight="bold" font-size="11.00" fill="#c2f0c2" fill-opacity="0.701961">APP SERVICE QUARKUS NATIVE</text>
</g>
<g id="clust3" class="cluster">
<title>cluster_domainentities</title>
<polygon fill="#194b9e" stroke="#1b3d88" points="80,-80 80,-1006.8 910,-1006.8 910,-80 80,-80"/>
<text xml:space="preserve" text-anchor="start" x="88" y="-993.9" font-family="Arial" font-weight="bold" font-size="11.00" fill="#bfdbfe" fill-opacity="0.701961">DOMAIN ENTITIES</text>
</g>
<!-- processdefinitionentity -->
<g id="node1" class="node">
<title>processdefinitionentity</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="440.02,-945.6 119.98,-945.6 119.98,-765.6 440.02,-765.6 440.02,-945.6"/>
<text xml:space="preserve" text-anchor="start" x="202.19" y="-849.6" font-family="Arial" font-size="20.00" fill="#eff6ff">ProcessDefinition</text>
</g>
<!-- processtaskdefinitionentity -->
<g id="node2" class="node">
<title>processtaskdefinitionentity</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="440.02,-622.8 119.98,-622.8 119.98,-442.8 440.02,-442.8 440.02,-622.8"/>
<text xml:space="preserve" text-anchor="start" x="180.52" y="-526.8" font-family="Arial" font-size="20.00" fill="#eff6ff">ProcessTaskDefinition</text>
</g>
<!-- sourcedefinitionentity -->
<g id="node3" class="node">
<title>sourcedefinitionentity</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="440.02,-300 119.98,-300 119.98,-120 440.02,-120 440.02,-300"/>
<text xml:space="preserve" text-anchor="start" x="206.63" y="-204" font-family="Arial" font-size="20.00" fill="#eff6ff">SourceDefinition</text>
</g>
<!-- readerdefinitionentity -->
<g id="node4" class="node">
<title>readerdefinitionentity</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="870.02,-300 549.98,-300 549.98,-120 870.02,-120 870.02,-300"/>
<text xml:space="preserve" text-anchor="start" x="635.51" y="-204" font-family="Arial" font-size="20.00" fill="#eff6ff">ReaderDefinition</text>
</g>
<!-- persistencelayer -->
<g id="node5" class="node">
<title>persistencelayer</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="977.02,-1277.6 656.98,-1277.6 656.98,-1097.6 977.02,-1097.6 977.02,-1277.6"/>
<text xml:space="preserve" text-anchor="start" x="694.71" y="-1181.6" font-family="Arial" font-size="20.00" fill="#eff6ff">Panache Persistence Layer</text>
</g>
<!-- db -->
<g id="node6" class="node">
<title>db</title>
<polygon fill="#428a4f" stroke="#2d5d39" stroke-width="0" points="1407.02,-945.6 1086.98,-945.6 1086.98,-765.6 1407.02,-765.6 1407.02,-945.6"/>
<text xml:space="preserve" text-anchor="start" x="1192.53" y="-849.6" font-family="Arial" font-size="20.00" fill="#f8fafc">PostgreSQL</text>
</g>
<!-- processdefinitionentity&#45;&gt;processtaskdefinitionentity -->
<g id="edge6" class="edge">
<title>processdefinitionentity&#45;&gt;processtaskdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M233.3,-765.72C224.34,-739.4 219.1,-710.27 224.08,-682.8 227.11,-666.1 231.91,-648.83 237.45,-632.23"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="239.84,-633.35 239.81,-625.4 234.88,-631.64 239.84,-633.35"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="224.08,-682.8 224.08,-705.6 290,-705.6 290,-682.8 224.08,-682.8"/>
<text xml:space="preserve" text-anchor="start" x="227.08" y="-690" font-family="Arial" font-size="14.00" fill="#c9c9c9">1..n tasks</text>
</g>
<!-- processtaskdefinitionentity&#45;&gt;sourcedefinitionentity -->
<g id="edge7" class="edge">
<title>processtaskdefinitionentity&#45;&gt;sourcedefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M268.44,-442.9C266.33,-423.15 264.46,-402.29 263.37,-382.8 262.06,-359.21 263.13,-333.86 265.25,-310.07"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="267.86,-310.35 265.96,-302.63 262.63,-309.85 267.86,-310.35"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="263.37,-360 263.37,-382.8 397,-382.8 397,-360 263.37,-360"/>
<text xml:space="preserve" text-anchor="start" x="266.37" y="-367.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">0..1 sourceDefinition</text>
</g>
<!-- processtaskdefinitionentity&#45;&gt;readerdefinitionentity -->
<g id="edge8" class="edge">
<title>processtaskdefinitionentity&#45;&gt;readerdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M399.21,-442.87C456.3,-400.27 524.72,-349.23 582.81,-305.89"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="584.07,-308.23 588.51,-301.64 580.93,-304.02 584.07,-308.23"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="507.89,-360 507.89,-382.8 639.97,-382.8 639.97,-360 507.89,-360"/>
<text xml:space="preserve" text-anchor="start" x="510.89" y="-367.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">0..1 readerDefinition</text>
</g>
<!-- persistencelayer&#45;&gt;processdefinitionentity -->
<g id="edge2" class="edge">
<title>persistencelayer&#45;&gt;processdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M657.15,-1121.96C588.97,-1091.29 510.07,-1051.55 444,-1006.8 420.41,-990.82 396.79,-971.57 375.12,-952.27"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="377.12,-950.54 369.79,-947.47 373.61,-954.44 377.12,-950.54"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="491.47,-1014.8 491.47,-1037.6 584.63,-1037.6 584.63,-1014.8 491.47,-1014.8"/>
<text xml:space="preserve" text-anchor="start" x="494.47" y="-1022" font-family="Arial" font-size="14.00" fill="#c9c9c9">Lee y persiste</text>
</g>
<!-- persistencelayer&#45;&gt;processtaskdefinitionentity -->
<g id="edge3" class="edge">
<title>persistencelayer&#45;&gt;processtaskdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M752.76,-1097.62C689.4,-1011.08 588.7,-876.76 495,-765.6 456.45,-719.87 411.77,-671.07 373.15,-630.1"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="375.15,-628.4 368.09,-624.75 371.33,-632 375.15,-628.4"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="682.93,-844.2 682.93,-867 776.09,-867 776.09,-844.2 682.93,-844.2"/>
<text xml:space="preserve" text-anchor="start" x="685.93" y="-851.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">Lee y persiste</text>
</g>
<!-- persistencelayer&#45;&gt;sourcedefinitionentity -->
<g id="edge4" class="edge">
<title>persistencelayer&#45;&gt;sourcedefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M829.45,-1097.8C838.17,-1010.52 842.21,-874.87 803,-765.6 791.64,-733.93 771.63,-735.82 756.84,-705.6 687.09,-563.04 774.57,-476.69 667,-360 612.13,-300.47 570.66,-328.83 495,-300 480.15,-294.34 464.79,-288.32 449.42,-282.18"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="450.61,-279.83 442.67,-279.47 448.65,-284.7 450.61,-279.83"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="756.84,-682.8 756.84,-705.6 850,-705.6 850,-682.8 756.84,-682.8"/>
<text xml:space="preserve" text-anchor="start" x="759.84" y="-690" font-family="Arial" font-size="14.00" fill="#c9c9c9">Lee y persiste</text>
</g>
<!-- persistencelayer&#45;&gt;readerdefinitionentity -->
<g id="edge5" class="edge">
<title>persistencelayer&#45;&gt;readerdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M870.07,-1097.77C879.14,-1078.55 887.18,-1057.89 892,-1037.6 919.93,-919.98 911.09,-884.97 892,-765.6 865.64,-600.71 797.81,-418.32 752.82,-309.27"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="755.26,-308.32 749.97,-302.39 750.41,-310.33 755.26,-308.32"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="879.6,-682.8 879.6,-705.6 972.76,-705.6 972.76,-682.8 879.6,-682.8"/>
<text xml:space="preserve" text-anchor="start" x="882.6" y="-690" font-family="Arial" font-size="14.00" fill="#c9c9c9">Lee y persiste</text>
</g>
<!-- persistencelayer&#45;&gt;db -->
<g id="edge1" class="edge">
<title>persistencelayer&#45;&gt;db</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M932.8,-1097.73C991.72,-1052.51 1063.37,-997.53 1123.36,-951.49"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1124.62,-953.83 1128.97,-947.18 1121.42,-949.67 1124.62,-953.83"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1032,-1014.8 1032,-1037.6 1195.97,-1037.6 1195.97,-1014.8 1032,-1014.8"/>
<text xml:space="preserve" text-anchor="start" x="1035" y="-1022" font-family="Arial" font-size="14.00" fill="#c9c9c9">Opera sobre PostgreSQL</text>
</g>
</g>
</svg>
`;case"domain_execution_entities_code":return`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN"
 "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<!-- Generated by graphviz version 14.1.0 (0)
 -->
<!-- Pages: 1 -->
<svg width="1867pt" height="1753pt"
 viewBox="0.00 0.00 1867.00 1753.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<g id="graph0" class="graph" transform="scale(1 1) rotate(0) translate(15.05 1737.85)">
<g id="clust1" class="cluster">
<title>cluster_integrationhub</title>
<polygon fill="#1c417d" stroke="#1c356c" points="8,-8 8,-1714.8 1479,-1714.8 1479,-8 8,-8"/>
<text xml:space="preserve" text-anchor="start" x="16" y="-1701.9" font-family="Arial" font-weight="bold" font-size="11.00" fill="#bfdbfe" fill-opacity="0.701961">INTEGRATION HUB PLATFORM</text>
</g>
<g id="clust2" class="cluster">
<title>cluster_quarkusapp</title>
<polygon fill="#29472f" stroke="#1c3021" points="40,-40 40,-1661.6 1447,-1661.6 1447,-40 40,-40"/>
<text xml:space="preserve" text-anchor="start" x="48" y="-1648.7" font-family="Arial" font-weight="bold" font-size="11.00" fill="#c2f0c2" fill-opacity="0.701961">APP SERVICE QUARKUS NATIVE</text>
</g>
<g id="clust3" class="cluster">
<title>cluster_domainentities</title>
<polygon fill="#194b9e" stroke="#1b3d88" points="80,-80 80,-1329.6 929,-1329.6 929,-80 80,-80"/>
<text xml:space="preserve" text-anchor="start" x="88" y="-1316.7" font-family="Arial" font-weight="bold" font-size="11.00" fill="#bfdbfe" fill-opacity="0.701961">DOMAIN ENTITIES</text>
</g>
<!-- processtaskexecutionentity -->
<g id="node1" class="node">
<title>processtaskexecutionentity</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="440.02,-1268.4 119.98,-1268.4 119.98,-1088.4 440.02,-1088.4 440.02,-1268.4"/>
<text xml:space="preserve" text-anchor="start" x="178.29" y="-1172.4" font-family="Arial" font-size="20.00" fill="#eff6ff">ProcessTaskExecution</text>
</g>
<!-- auditevententity -->
<g id="node2" class="node">
<title>auditevententity</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="870.02,-1268.4 549.98,-1268.4 549.98,-1088.4 870.02,-1088.4 870.02,-1268.4"/>
<text xml:space="preserve" text-anchor="start" x="661.64" y="-1172.4" font-family="Arial" font-size="20.00" fill="#eff6ff">AuditEvent</text>
</g>
<!-- processexecutionentity -->
<g id="node3" class="node">
<title>processexecutionentity</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="661.02,-945.6 340.98,-945.6 340.98,-765.6 661.02,-765.6 661.02,-945.6"/>
<text xml:space="preserve" text-anchor="start" x="420.96" y="-849.6" font-family="Arial" font-size="20.00" fill="#eff6ff">ProcessExecution</text>
</g>
<!-- processdefinitionentity -->
<g id="node4" class="node">
<title>processdefinitionentity</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="661.02,-622.8 340.98,-622.8 340.98,-442.8 661.02,-442.8 661.02,-622.8"/>
<text xml:space="preserve" text-anchor="start" x="423.19" y="-526.8" font-family="Arial" font-size="20.00" fill="#eff6ff">ProcessDefinition</text>
</g>
<!-- processtaskdefinitionentity -->
<g id="node5" class="node">
<title>processtaskdefinitionentity</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="661.02,-300 340.98,-300 340.98,-120 661.02,-120 661.02,-300"/>
<text xml:space="preserve" text-anchor="start" x="401.52" y="-204" font-family="Arial" font-size="20.00" fill="#eff6ff">ProcessTaskDefinition</text>
</g>
<!-- persistencelayer -->
<g id="node6" class="node">
<title>persistencelayer</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="1250.02,-1600.4 929.98,-1600.4 929.98,-1420.4 1250.02,-1420.4 1250.02,-1600.4"/>
<text xml:space="preserve" text-anchor="start" x="967.71" y="-1504.4" font-family="Arial" font-size="20.00" fill="#eff6ff">Panache Persistence Layer</text>
</g>
<!-- db -->
<g id="node7" class="node">
<title>db</title>
<polygon fill="#428a4f" stroke="#2d5d39" stroke-width="0" points="1837.02,-1268.4 1516.98,-1268.4 1516.98,-1088.4 1837.02,-1088.4 1837.02,-1268.4"/>
<text xml:space="preserve" text-anchor="start" x="1622.53" y="-1172.4" font-family="Arial" font-size="20.00" fill="#f8fafc">PostgreSQL</text>
</g>
<!-- processtaskexecutionentity&#45;&gt;processexecutionentity -->
<g id="edge7" class="edge">
<title>processtaskexecutionentity&#45;&gt;processexecutionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M341.27,-1088.47C370.07,-1046.66 404.48,-996.71 433.97,-953.89"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="435.99,-955.59 438.09,-947.92 431.67,-952.61 435.99,-955.59"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="397.13,-1005.6 397.13,-1028.4 540.87,-1028.4 540.87,-1005.6 397.13,-1005.6"/>
<text xml:space="preserve" text-anchor="start" x="400.13" y="-1012.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">n..1 processExecution</text>
</g>
<!-- processtaskexecutionentity&#45;&gt;processtaskdefinitionentity -->
<g id="edge8" class="edge">
<title>processtaskexecutionentity&#45;&gt;processtaskdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M260.82,-1088.68C234.37,-946.52 199.16,-661.5 286,-442.8 306.36,-391.53 343.86,-344.8 381.92,-306.93"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="383.34,-309.21 386.86,-302.09 379.67,-305.46 383.34,-309.21"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="233.95,-682.8 233.95,-705.6 351.23,-705.6 351.23,-682.8 233.95,-682.8"/>
<text xml:space="preserve" text-anchor="start" x="236.95" y="-690" font-family="Arial" font-size="14.00" fill="#c9c9c9">n..1 taskDefinition</text>
</g>
<!-- auditevententity&#45;&gt;processexecutionentity -->
<g id="edge9" class="edge">
<title>auditevententity&#45;&gt;processexecutionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M642.2,-1088.72C627.93,-1069.14 613.27,-1048.29 600.26,-1028.4 584.89,-1004.91 569.25,-978.97 555.06,-954.51"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="557.44,-953.38 551.42,-948.2 552.89,-956.01 557.44,-953.38"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="600.26,-1005.6 600.26,-1028.4 744,-1028.4 744,-1005.6 600.26,-1005.6"/>
<text xml:space="preserve" text-anchor="start" x="603.26" y="-1012.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">n..1 processExecution</text>
</g>
<!-- auditevententity&#45;&gt;processtaskdefinitionentity -->
<g id="edge10" class="edge">
<title>auditevententity&#45;&gt;processtaskdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M755.01,-1088.52C763.99,-1062.33 769.91,-1033.26 767,-1005.6 755.6,-897.15 764.25,-863.4 716,-765.6 700.48,-734.14 676.87,-738.51 664.72,-705.6 649.73,-664.99 701.01,-663.41 716,-622.8 743.7,-547.75 745.22,-517.27 716,-442.8 695.85,-391.45 658.39,-344.7 620.31,-306.84"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="622.56,-305.37 615.36,-301.99 618.89,-309.12 622.56,-305.37"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="664.72,-682.8 664.72,-705.6 782,-705.6 782,-682.8 664.72,-682.8"/>
<text xml:space="preserve" text-anchor="start" x="667.72" y="-690" font-family="Arial" font-size="14.00" fill="#c9c9c9">0..1 taskDefinition</text>
</g>
<!-- processexecutionentity&#45;&gt;processdefinitionentity -->
<g id="edge11" class="edge">
<title>processexecutionentity&#45;&gt;processdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M496.41,-765.98C495.56,-746.12 494.81,-725.14 494.37,-705.6 493.85,-682.07 494.28,-656.75 495.12,-632.96"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="497.74,-633.13 495.4,-625.53 492.49,-632.93 497.74,-633.13"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="494.37,-682.8 494.37,-705.6 635,-705.6 635,-682.8 494.37,-682.8"/>
<text xml:space="preserve" text-anchor="start" x="497.37" y="-690" font-family="Arial" font-size="14.00" fill="#c9c9c9">n..1 processDefinition</text>
</g>
<!-- processdefinitionentity&#45;&gt;processtaskdefinitionentity -->
<g id="edge12" class="edge">
<title>processdefinitionentity&#45;&gt;processtaskdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M501,-442.87C501,-401.67 501,-352.56 501,-310.17"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="503.63,-310.36 501,-302.86 498.38,-310.36 503.63,-310.36"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="501,-360 501,-382.8 566.92,-382.8 566.92,-360 501,-360"/>
<text xml:space="preserve" text-anchor="start" x="504" y="-367.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">1..n tasks</text>
</g>
<!-- persistencelayer&#45;&gt;processtaskexecutionentity -->
<g id="edge2" class="edge">
<title>persistencelayer&#45;&gt;processtaskexecutionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M930.19,-1475.67C807.38,-1446.33 635.54,-1397.77 495,-1329.6 463.31,-1314.23 431.13,-1294.43 401.67,-1274.28"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="403.17,-1272.13 395.51,-1270.03 400.19,-1276.45 403.17,-1272.13"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="556.31,-1337.6 556.31,-1360.4 649.46,-1360.4 649.46,-1337.6 556.31,-1337.6"/>
<text xml:space="preserve" text-anchor="start" x="559.31" y="-1344.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">Lee y persiste</text>
</g>
<!-- persistencelayer&#45;&gt;auditevententity -->
<g id="edge3" class="edge">
<title>persistencelayer&#45;&gt;auditevententity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M981.21,-1420.54C946.64,-1391.85 908.45,-1359.69 874,-1329.6 854.14,-1312.26 833.21,-1293.49 813.19,-1275.28"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="815.12,-1273.48 807.81,-1270.37 811.58,-1277.36 815.12,-1273.48"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="908.81,-1337.6 908.81,-1360.4 1001.97,-1360.4 1001.97,-1337.6 908.81,-1337.6"/>
<text xml:space="preserve" text-anchor="start" x="911.81" y="-1344.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">Lee y persiste</text>
</g>
<!-- persistencelayer&#45;&gt;processexecutionentity -->
<g id="edge4" class="edge">
<title>persistencelayer&#45;&gt;processexecutionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1074.39,-1420.74C1054.09,-1328.18 1010.61,-1183.5 925,-1088.4 923.73,-1086.99 787.69,-1012.71 670.07,-948.62"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="671.41,-946.37 663.57,-945.09 668.9,-950.98 671.41,-946.37"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1049.14,-1167 1049.14,-1189.8 1142.3,-1189.8 1142.3,-1167 1049.14,-1167"/>
<text xml:space="preserve" text-anchor="start" x="1052.14" y="-1174.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">Lee y persiste</text>
</g>
<!-- persistencelayer&#45;&gt;processdefinitionentity -->
<g id="edge5" class="edge">
<title>persistencelayer&#45;&gt;processdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1137.58,-1420.83C1150.41,-1392.5 1162.52,-1360.47 1169,-1329.6 1191.03,-1224.69 1207.06,-1188.62 1169,-1088.4 1083.42,-863.07 1005.19,-822.82 809,-682.8 755.32,-644.49 730.07,-651.83 670.12,-625.08"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="671.26,-622.72 663.35,-621.95 669.05,-627.49 671.26,-622.72"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1143.42,-1005.6 1143.42,-1028.4 1236.58,-1028.4 1236.58,-1005.6 1143.42,-1005.6"/>
<text xml:space="preserve" text-anchor="start" x="1146.42" y="-1012.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">Lee y persiste</text>
</g>
<!-- persistencelayer&#45;&gt;processtaskdefinitionentity -->
<g id="edge6" class="edge">
<title>persistencelayer&#45;&gt;processtaskdefinitionentity</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1158.69,-1420.65C1228.07,-1319.64 1317.88,-1149.94 1264,-1005.6 1147.16,-692.6 834.49,-436.77 647.66,-305.83"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="649.27,-303.75 641.62,-301.61 646.27,-308.06 649.27,-303.75"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1237.14,-844.2 1237.14,-867 1330.3,-867 1330.3,-844.2 1237.14,-844.2"/>
<text xml:space="preserve" text-anchor="start" x="1240.14" y="-851.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">Lee y persiste</text>
</g>
<!-- persistencelayer&#45;&gt;db -->
<g id="edge1" class="edge">
<title>persistencelayer&#45;&gt;db</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1250,-1449.14C1309.28,-1424.5 1376.12,-1393.89 1434,-1360.4 1477.15,-1335.44 1521.65,-1304.16 1560.59,-1274.65"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1562.03,-1276.86 1566.4,-1270.22 1558.84,-1272.68 1562.03,-1276.86"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1469.13,-1337.6 1469.13,-1360.4 1633.1,-1360.4 1633.1,-1337.6 1469.13,-1337.6"/>
<text xml:space="preserve" text-anchor="start" x="1472.13" y="-1344.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">Opera sobre PostgreSQL</text>
</g>
</g>
</svg>
