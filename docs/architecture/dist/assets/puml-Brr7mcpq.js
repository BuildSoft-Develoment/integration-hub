...
\r
skinparam rectangle<<DevEdgeAdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<DevEdgeQuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<DevDataOtel>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<DevDataIam>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<DevDataDb>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<DevDataJaeger>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
rectangle "edge" <<DevEdge>> as DevEdge {\r
  skinparam RectangleBorderColor<<DevEdge>> #428a4f\r
  skinparam RectangleFontColor<<DevEdge>> #428a4f\r
  skinparam RectangleBorderStyle<<DevEdge>> dashed\r
\r
  rectangle "==Admin Console" <<DevEdgeAdminConsole>> as DevEdgeAdminConsole\r
  rectangle "==Quarkus Native App" <<DevEdgeQuarkusApp>> as DevEdgeQuarkusApp\r
}\r
rectangle "data" <<DevData>> as DevData {\r
  skinparam RectangleBorderColor<<DevData>> #428a4f\r
  skinparam RectangleFontColor<<DevData>> #428a4f\r
  skinparam RectangleBorderStyle<<DevData>> dashed\r
\r
  rectangle "==OpenTelemetry Collector" <<DevDataOtel>> as DevDataOtel\r
  rectangle "==Keycloak" <<DevDataIam>> as DevDataIam\r
  rectangle "==PostgreSQL" <<DevDataDb>> as DevDataDb\r
  rectangle "==Jaeger" <<DevDataJaeger>> as DevDataJaeger\r
}\r
\r
DevEdgeAdminConsole .[#8D8D8D,thickness=2].> DevEdgeQuarkusApp : <color:#8D8D8D>[...]\r
DevDataOtel .[#8D8D8D,thickness=2].> DevDataJaeger : <color:#8D8D8D>Entrega trazas\r
DevEdgeAdminConsole .[#8D8D8D,thickness=2].> DevDataIam : <color:#8D8D8D>[...]\r
DevEdgeQuarkusApp .[#8D8D8D,thickness=2].> DevDataDb : <color:#8D8D8D>[...]\r
DevEdgeQuarkusApp .[#8D8D8D,thickness=2].> DevDataIam : <color:#8D8D8D>Valida access tokens\r
DevEdgeQuarkusApp .[#8D8D8D,thickness=2].> DevDataOtel : <color:#8D8D8D>Exporta trazas\r
@enduml\r
...
\r
skinparam rectangle<<PreAppClusterPreNode1AdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreAppClusterPreNode2AdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreAppClusterPreNode1QuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreAppClusterPreNode2QuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreDataOtel>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<PreDataIam>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<PreDataDb>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<PreDataJaeger>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
rectangle "appCluster" <<PreAppCluster>> as PreAppCluster {\r
  skinparam RectangleBorderColor<<PreAppCluster>> #3b82f6\r
  skinparam RectangleFontColor<<PreAppCluster>> #3b82f6\r
  skinparam RectangleBorderStyle<<PreAppCluster>> dashed\r
\r
  rectangle "preNode1" <<PreAppClusterPreNode1>> as PreAppClusterPreNode1 {\r
    skinparam RectangleBorderColor<<PreAppClusterPreNode1>> #428a4f\r
    skinparam RectangleFontColor<<PreAppClusterPreNode1>> #428a4f\r
    skinparam RectangleBorderStyle<<PreAppClusterPreNode1>> dashed\r
\r
    rectangle "==Admin Console" <<PreAppClusterPreNode1AdminConsole>> as PreAppClusterPreNode1AdminConsole\r
    rectangle "==Quarkus Native App" <<PreAppClusterPreNode1QuarkusApp>> as PreAppClusterPreNode1QuarkusApp\r
  }\r
  rectangle "preNode2" <<PreAppClusterPreNode2>> as PreAppClusterPreNode2 {\r
    skinparam RectangleBorderColor<<PreAppClusterPreNode2>> #428a4f\r
    skinparam RectangleFontColor<<PreAppClusterPreNode2>> #428a4f\r
    skinparam RectangleBorderStyle<<PreAppClusterPreNode2>> dashed\r
\r
    rectangle "==Admin Console" <<PreAppClusterPreNode2AdminConsole>> as PreAppClusterPreNode2AdminConsole\r
    rectangle "==Quarkus Native App" <<PreAppClusterPreNode2QuarkusApp>> as PreAppClusterPreNode2QuarkusApp\r
  }\r
}\r
rectangle "data" <<PreData>> as PreData {\r
  skinparam RectangleBorderColor<<PreData>> #428a4f\r
  skinparam RectangleFontColor<<PreData>> #428a4f\r
  skinparam RectangleBorderStyle<<PreData>> dashed\r
\r
  rectangle "==OpenTelemetry Collector" <<PreDataOtel>> as PreDataOtel\r
  rectangle "==Keycloak" <<PreDataIam>> as PreDataIam\r
  rectangle "==PostgreSQL" <<PreDataDb>> as PreDataDb\r
  rectangle "==Jaeger" <<PreDataJaeger>> as PreDataJaeger\r
}\r
\r
PreAppClusterPreNode1AdminConsole .[#8D8D8D,thickness=2].> PreAppClusterPreNode1QuarkusApp : <color:#8D8D8D>[...]\r
PreAppClusterPreNode2AdminConsole .[#8D8D8D,thickness=2].> PreAppClusterPreNode2QuarkusApp : <color:#8D8D8D>[...]\r
PreDataOtel .[#8D8D8D,thickness=2].> PreDataJaeger : <color:#8D8D8D>Entrega trazas\r
PreAppClusterPreNode1AdminConsole .[#8D8D8D,thickness=2].> PreDataIam : <color:#8D8D8D>[...]\r
PreAppClusterPreNode1QuarkusApp .[#8D8D8D,thickness=2].> PreDataDb : <color:#8D8D8D>[...]\r
PreAppClusterPreNode1QuarkusApp .[#8D8D8D,thickness=2].> PreDataIam : <color:#8D8D8D>Valida access tokens\r
PreAppClusterPreNode1QuarkusApp .[#8D8D8D,thickness=2].> PreDataOtel : <color:#8D8D8D>Exporta trazas\r
PreAppClusterPreNode2AdminConsole .[#8D8D8D,thickness=2].> PreDataIam : <color:#8D8D8D>[...]\r
PreAppClusterPreNode2QuarkusApp .[#8D8D8D,thickness=2].> PreDataDb : <color:#8D8D8D>[...]\r
PreAppClusterPreNode2QuarkusApp .[#8D8D8D,thickness=2].> PreDataIam : <color:#8D8D8D>Valida access tokens\r
PreAppClusterPreNode2QuarkusApp .[#8D8D8D,thickness=2].> PreDataOtel : <color:#8D8D8D>Exporta trazas\r
@enduml\r
...
\r
skinparam rectangle<<ProdLoadBalancerLoadBalancer>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdServicesVault>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdServicesSharedStorage>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdAppClusterProdNode1AdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdAppClusterProdNode2AdminConsole>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdAppClusterProdNode1QuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdAppClusterProdNode2QuarkusApp>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdDataOtel>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdDataIam>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<ProdDataDb>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<ProdDataJaeger>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
rectangle "loadBalancer" <<ProdLoadBalancer>> as ProdLoadBalancer {\r
  skinparam RectangleBorderColor<<ProdLoadBalancer>> #428a4f\r
  skinparam RectangleFontColor<<ProdLoadBalancer>> #428a4f\r
  skinparam RectangleBorderStyle<<ProdLoadBalancer>> dashed\r
\r
  rectangle "==Load Balancer / Reverse Proxy" <<ProdLoadBalancerLoadBalancer>> as ProdLoadBalancerLoadBalancer\r
}\r
rectangle "services" <<ProdServices>> as ProdServices {\r
  skinparam RectangleBorderColor<<ProdServices>> #428a4f\r
  skinparam RectangleFontColor<<ProdServices>> #428a4f\r
  skinparam RectangleBorderStyle<<ProdServices>> dashed\r
\r
  rectangle "==Secrets / Vault corporativo" <<ProdServicesVault>> as ProdServicesVault\r
  rectangle "==Shared File Storage" <<ProdServicesSharedStorage>> as ProdServicesSharedStorage\r
}\r
rectangle "appCluster" <<ProdAppCluster>> as ProdAppCluster {\r
  skinparam RectangleBorderColor<<ProdAppCluster>> #3b82f6\r
  skinparam RectangleFontColor<<ProdAppCluster>> #3b82f6\r
  skinparam RectangleBorderStyle<<ProdAppCluster>> dashed\r
\r
  rectangle "prodNode1" <<ProdAppClusterProdNode1>> as ProdAppClusterProdNode1 {\r
    skinparam RectangleBorderColor<<ProdAppClusterProdNode1>> #428a4f\r
    skinparam RectangleFontColor<<ProdAppClusterProdNode1>> #428a4f\r
    skinparam RectangleBorderStyle<<ProdAppClusterProdNode1>> dashed\r
\r
    rectangle "==Admin Console" <<ProdAppClusterProdNode1AdminConsole>> as ProdAppClusterProdNode1AdminConsole\r
    rectangle "==Quarkus Native App" <<ProdAppClusterProdNode1QuarkusApp>> as ProdAppClusterProdNode1QuarkusApp\r
  }\r
  rectangle "prodNode2" <<ProdAppClusterProdNode2>> as ProdAppClusterProdNode2 {\r
    skinparam RectangleBorderColor<<ProdAppClusterProdNode2>> #428a4f\r
    skinparam RectangleFontColor<<ProdAppClusterProdNode2>> #428a4f\r
    skinparam RectangleBorderStyle<<ProdAppClusterProdNode2>> dashed\r
\r
    rectangle "==Admin Console" <<ProdAppClusterProdNode2AdminConsole>> as ProdAppClusterProdNode2AdminConsole\r
    rectangle "==Quarkus Native App" <<ProdAppClusterProdNode2QuarkusApp>> as ProdAppClusterProdNode2QuarkusApp\r
  }\r
}\r
rectangle "data" <<ProdData>> as ProdData {\r
  skinparam RectangleBorderColor<<ProdData>> #428a4f\r
  skinparam RectangleFontColor<<ProdData>> #428a4f\r
  skinparam RectangleBorderStyle<<ProdData>> dashed\r
\r
  rectangle "==OpenTelemetry Collector" <<ProdDataOtel>> as ProdDataOtel\r
  rectangle "==Keycloak" <<ProdDataIam>> as ProdDataIam\r
  rectangle "==PostgreSQL" <<ProdDataDb>> as ProdDataDb\r
  rectangle "==Jaeger" <<ProdDataJaeger>> as ProdDataJaeger\r
}\r
\r
ProdAppClusterProdNode1AdminConsole .[#8D8D8D,thickness=2].> ProdAppClusterProdNode1QuarkusApp : <color:#8D8D8D>[...]\r
ProdAppClusterProdNode2AdminConsole .[#8D8D8D,thickness=2].> ProdAppClusterProdNode2QuarkusApp : <color:#8D8D8D>[...]\r
ProdDataOtel .[#8D8D8D,thickness=2].> ProdDataJaeger : <color:#8D8D8D>Entrega trazas\r
ProdLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppClusterProdNode1AdminConsole : <color:#8D8D8D>Publica UI on-prem\r
ProdLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppClusterProdNode1QuarkusApp : <color:#8D8D8D>Publica APIs on-prem\r
ProdLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppClusterProdNode2AdminConsole : <color:#8D8D8D>Publica UI on-prem\r
ProdLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppClusterProdNode2QuarkusApp : <color:#8D8D8D>Publica APIs on-prem\r
ProdAppClusterProdNode1AdminConsole .[#8D8D8D,thickness=2].> ProdDataIam : <color:#8D8D8D>[...]\r
ProdAppClusterProdNode1QuarkusApp .[#8D8D8D,thickness=2].> ProdDataDb : <color:#8D8D8D>[...]\r
ProdAppClusterProdNode1QuarkusApp .[#8D8D8D,thickness=2].> ProdDataIam : <color:#8D8D8D>Valida access tokens\r
ProdAppClusterProdNode1QuarkusApp .[#8D8D8D,thickness=2].> ProdDataOtel : <color:#8D8D8D>Exporta trazas\r
ProdServicesVault .[#8D8D8D,thickness=2].> ProdAppClusterProdNode1QuarkusApp : <color:#8D8D8D>Entrega secretos y credenciales\r
ProdServicesSharedStorage .[#8D8D8D,thickness=2].> ProdAppClusterProdNode1QuarkusApp : <color:#8D8D8D>Comparte archivos locales\r
ProdAppClusterProdNode2AdminConsole .[#8D8D8D,thickness=2].> ProdDataIam : <color:#8D8D8D>[...]\r
ProdAppClusterProdNode2QuarkusApp .[#8D8D8D,thickness=2].> ProdDataDb : <color:#8D8D8D>[...]\r
ProdAppClusterProdNode2QuarkusApp .[#8D8D8D,thickness=2].> ProdDataIam : <color:#8D8D8D>Valida access tokens\r
ProdAppClusterProdNode2QuarkusApp .[#8D8D8D,thickness=2].> ProdDataOtel : <color:#8D8D8D>Exporta trazas\r
ProdServicesVault .[#8D8D8D,thickness=2].> ProdAppClusterProdNode2QuarkusApp : <color:#8D8D8D>Entrega secretos y credenciales\r
ProdServicesSharedStorage .[#8D8D8D,thickness=2].> ProdAppClusterProdNode2QuarkusApp : <color:#8D8D8D>Comparte archivos locales\r
@enduml\r
