...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catalogos y procesos\`" .-> IntegrationHub\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub\r
  Auditor -. "\`Consulta auditoria y resultados\`" .-> IntegrationHub\r
...
graph TB\r
  ...
  ExternalApi@{ shape: rectangle, label: "APIs externas" }\r
  subgraph Observability["\`Observabilidad\`"]\r
    Observability.Otel@{ shape: rectangle, label: "OpenTelemetry Collector" }\r
    Observability.Jaeger@{ shape: rectangle, label: "Jaeger" }\r
  end\r
  ...
  IntegrationAdmin -. "\`Administra catalogos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  Auditor -. "\`Consulta auditoria y resultados\`" .-> IntegrationHub.AdminConsole\r
  ...
  IntegrationHub.QuarkusApp -. "\`Exporta trazas\`" .-> Observability.Otel\r
  Observability.Otel -. "\`Entrega trazas\`" .-> Observability.Jaeger\r
...
graph TB\r
  ...
  subgraph IntegrationHub["\`Integration Hub Platform\`"]\r
    ...
    subgraph IntegrationHub.QuarkusApp["\`App Service Quarkus Native\`"]\r
      ...
      IntegrationHub.QuarkusApp.SourceDefinitionResource@{ shape: rectangle, label: "SourceDefinitionResource" }\r
      IntegrationHub.QuarkusApp.ReaderDefinitionResource@{ shape: rectangle, label: "ReaderDefinitionResource" }\r
  ...
  IntegrationHub.AdminConsole.ProcessDesigner -. "\`CRUD de procesos\`" .-> IntegrationHub.QuarkusApp.ProcessDefinitionResource\r
  IntegrationHub.AdminConsole.ProcessDesigner -. "\`CRUD de sources\`" .-> IntegrationHub.QuarkusApp.SourceDefinitionResource\r
  IntegrationHub.AdminConsole.ProcessDesigner -. "\`CRUD de readers\`" .-> IntegrationHub.QuarkusApp.ReaderDefinitionResource\r
  IntegrationHub.AdminConsole.OperationsConsole -. "\`Ejecuta procesos\`" .-> IntegrationHub.QuarkusApp.ProcessExecutionResource\r
  IntegrationHub.AdminConsole.OperationsConsole -. "\`Consulta programaciones\`" .-> IntegrationHub.QuarkusApp.ProcessScheduleResource\r
  IntegrationHub.AdminConsole.OperationsConsole -. "\`Consulta ejecuciones y auditoria\`" .-> IntegrationHub.QuarkusApp.ExecutionQueryResource\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub.AdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHub.AdminConsole\r
  IntegrationAdmin -. "\`Administra catalogos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  ...
  IntegrationHub.QuarkusApp -. "\`Persiste configuracion, jobs, auditoria y staging\`" .-> Db\r
  IntegrationHub.QuarkusApp -. "\`Valida access tokens\`" .-> Iam\r
`;case"backend_components":return'---\r\ntitle: "Zoom a App Service Quarkus Native"\r\n---\r\ngraph TB\r\n  User@{ icon: "fa:user", shape: rounded, label: "Usuario de negocio" }\r\n  Admin@{ icon: "fa:user", shape: rounded, label: "Administrador de integraciones" }\r\n  IntegrationAdmin@{ icon: "fa:user", shape: rounded, label: "Integration Admin" }\r\n  Operator@{ icon: "fa:user", shape: rounded, label: "Operator" }\r\n  Auditor@{ icon: "fa:user", shape: rounded, label: "Auditor" }\r\n  subgraph IntegrationHub["`Integration Hub Platform`"]\r\n    subgraph IntegrationHub.QuarkusApp["`App Service Quarkus Native`"]\r\n      IntegrationHub.QuarkusApp.Telemetry@{ shape: rectangle, label: "OpenTelemetry Instrumentation" }\r\n      IntegrationHub.QuarkusApp.ProcessDefinitionResource@{ shape: rectangle, label: "ProcessDefinitionResource" }\r\n      IntegrationHub.QuarkusApp.SourceDefinitionResource@{ shape: rectangle, label: "SourceDefinitionResource" }\r\n      IntegrationHub.QuarkusApp.ReaderDefinitionResource@{ shape: rectangle, label: "ReaderDefinitionResource" }\r\n      IntegrationHub.QuarkusApp.ProcessExecutionResource@{ shape: rectangle, label: "ProcessExecutionResource" }\r\n      IntegrationHub.QuarkusApp.ProcessScheduleResource@{ shape: rectangle, label: "ProcessScheduleResource" }\r\n      IntegrationHub.QuarkusApp.ExecutionQueryResource@{ shape: rectangle, label: "ExecutionQueryResource" }\r\n      IntegrationHub.QuarkusApp.ProcessSchedulerService@{ shape: rectangle, label: "ProcessSchedulerService" }\r\n      IntegrationHub.QuarkusApp.ProcessCatalogService@{ shape: rectangle, label: "ProcessCatalogService" }\r\n      IntegrationHub.QuarkusApp.SourceCatalogService@{ shape: rectangle, label: "SourceCatalogService" }\r\n      IntegrationHub.QuarkusApp.ReaderCatalogService@{ shape: rectangle, label: "ReaderCatalogService" }\r\n      IntegrationHub.QuarkusApp.ProcessScheduleQueryService@{ shape: rectangle, label: "ProcessScheduleQueryService" }\r\n      IntegrationHub.QuarkusApp.ExecutionQueryService@{ shape: rectangle, label: "ExecutionQueryService" }\r\n      IntegrationHub.QuarkusApp.ProcessExecutionService@{ shape: rectangle, label: "ProcessExecutionService" }\r\n      IntegrationHub.QuarkusApp.Repositories@{ shape: rectangle, label: "Repositories" }\r\n      IntegrationHub.QuarkusApp.ProcessEngine@{ shape: rectangle, label: "Process Engine" }\r\n      IntegrationHub.QuarkusApp.AuditService@{ shape: rectangle, label: "Audit Service" }\r\n      IntegrationHub.QuarkusApp.DomainEntities@{ shape: rectangle, label: "Domain Entities" }\r\n    end\r\n    IntegrationHub.AdminConsole@{ shape: rectangle, label: "Admin Console App (Front)" }\r\n  end\r\n  subgraph FileSources["`Fuentes externas`"]\r\n    FileSources.Filesystem@{ shape: rectangle, label: "File System" }\r\n    FileSources.Ftp@{ shape: rectangle, label: "FTP" }\r\n    FileSources.Sftp@{ shape: rectangle, label: "SFTP" }\r\n    FileSources.RestSource@{ shape: rectangle, label: "REST Source" }\r\n  end\r\n  subgraph Observability["`Observabilidad`"]\r\n    Observability.Otel@{ shape: rectangle, label: "OpenTelemetry Collector" }\r\n    Observability.Jaeger@{ shape: rectangle, label: "Jaeger" }\r\n  end\r\n  Iam@{ shape: rectangle, label: "Keycloak" }\r\n  Db@{ shape: rectangle, label: "PostgreSQL" }\r\n  ExternalApi@{ shape: rectangle, label: "APIs externas" }\r\n  IntegrationHub.QuarkusApp.ProcessDefinitionResource -. "`Delega gestion de procesos`" .-> IntegrationHub.QuarkusApp.ProcessCatalogService\r\n  IntegrationHub.QuarkusApp.SourceDefinitionResource -. "`Delega gestion de sources`" .-> IntegrationHub.QuarkusApp.SourceCatalogService\r\n  IntegrationHub.QuarkusApp.ReaderDefinitionResource -. "`Delega gestion de readers`" .-> IntegrationHub.QuarkusApp.ReaderCatalogService\r\n  IntegrationHub.QuarkusApp.ProcessExecutionResource -. "`Delega ejecucion`" .-> IntegrationHub.QuarkusApp.ProcessExecutionService\r\n  IntegrationHub.QuarkusApp.ProcessScheduleResource -. "`Delega consulta de schedules`" .-> IntegrationHub.QuarkusApp.ProcessScheduleQueryService\r\n  IntegrationHub.QuarkusApp.ExecutionQueryResource -. "`Delega consultas operativas`" .-> IntegrationHub.QuarkusApp.ExecutionQueryService\r\n  IntegrationHub.QuarkusApp.ProcessCatalogService -. "`[...]`" .-> IntegrationHub.QuarkusApp.Repositories\r\n  IntegrationHub.QuarkusApp.SourceCatalogService -. "`Persiste sources`" .-> IntegrationHub.QuarkusApp.Repositories\r\n  IntegrationHub.QuarkusApp.ReaderCatalogService -. "`Persiste readers`" .-> IntegrationHub.QuarkusApp.Repositories\r\n  IntegrationHub.QuarkusApp.ProcessExecutionService -. "`[...]`" .-> IntegrationHub.QuarkusApp.ProcessEngine\r\n  IntegrationHub.QuarkusApp.ProcessExecutionService -. "`Registra eventos`" .-> IntegrationHub.QuarkusApp.AuditService\r\n  IntegrationHub.QuarkusApp.ProcessSchedulerService -. "`Dispara procesos programados`" .-> IntegrationHub.QuarkusApp.ProcessExecutionService\r\n  IntegrationHub.QuarkusApp.ProcessScheduleQueryService -. "`Consulta programaciones`" .-> IntegrationHub.QuarkusApp.Repositories\r\n  IntegrationHub.QuarkusApp.ExecutionQueryService -. "`[...]`" .-> IntegrationHub.QuarkusApp.Repositories\r\n  IntegrationHub.QuarkusApp.Repositories -. "`Lee y persiste`" .-> IntegrationHub.QuarkusApp.DomainEntities\r\n  User -. "`Consulta estado y resultados`" .-> IntegrationHub.AdminConsole\r\n  Admin -. "`Configura fuentes, readers y procesos`" .-> IntegrationHub.AdminConsole\r\n  IntegrationAdmin -. "`Administra catalogos y procesos`" .-> IntegrationHub.AdminConsole\r\n  Operator -. "`Ejecuta procesos`" .-> IntegrationHub.AdminConsole\r\n  Auditor -. "`Consulta auditoria y resultados`" .-> IntegrationHub.AdminConsole\r\n  IntegrationHub.AdminConsole -. "`CRUD de procesos`" .-> IntegrationHub.QuarkusApp.ProcessDefinitionResource\r\n  IntegrationHub.AdminConsole -. "`CRUD de sources`" .-> IntegrationHub.QuarkusApp.SourceDefinitionResource\r\n  IntegrationHub.AdminConsole -. "`CRUD de readers`" .-> IntegrationHub.QuarkusApp.ReaderDefinitionResource\r\n  IntegrationHub.AdminConsole -. "`Ejecuta procesos`" .-> IntegrationHub.QuarkusApp.ProcessExecutionResource\r\n  IntegrationHub.AdminConsole -. "`Consulta programaciones`" .-> IntegrationHub.QuarkusApp.ProcessScheduleResource\r\n  IntegrationHub.AdminConsole -. "`Consulta ejecuciones y auditoria`" .-> IntegrationHub.QuarkusApp.ExecutionQueryResource\r\n  IntegrationHub.QuarkusApp.ProcessEngine -. "`Batch insert, update y upsert`" .-> Db\r\n  IntegrationHub.QuarkusApp.Repositories -. "`Opera sobre PostgreSQL`" .-> Db\r\n  IntegrationHub.AdminConsole -. "`Autenticacion OIDC`" .-> Iam\r\n  IntegrationHub.QuarkusApp.ProcessEngine -. "`[...]`" .-> ExternalApi\r\n  Observability.Otel -. "`Entrega trazas`" .-> Observability.Jaeger\r\n  IntegrationHub.QuarkusApp -. "`Valida access tokens`" .-> Iam\r\n  IntegrationHub.QuarkusApp -. "`Lee archivos locales`" .-> FileSources.Filesystem\r\n  IntegrationHub.QuarkusApp -. "`Descarga archivos`" .-> FileSources.Ftp\r\n  IntegrationHub.QuarkusApp -. "`Descarga archivos`" .-> FileSources.Sftp\r\n  IntegrationHub.QuarkusApp -. "`Obtiene payloads remotos`" .-> FileSources.RestSource\r\n  IntegrationHub.QuarkusApp -. "`Exporta trazas`" .-> Observability.Otel\r\n';case"process_engine_code":return`---\r
...
graph TB\r
  subgraph IntegrationHub["\`Integration Hub Platform\`"]\r
    ...
    subgraph IntegrationHub.QuarkusApp["\`App Service Quarkus Native\`"]\r
      ...
      subgraph IntegrationHub.QuarkusApp.Repositories["\`Repositories\`"]\r
        IntegrationHub.QuarkusApp.Repositories.ProcessDefinitionRepository@{ shape: rectangle, label: "ProcessDefinitionRepository" }\r
        IntegrationHub.QuarkusApp.Repositories.SourceDefinitionRepository@{ shape: rectangle, label: "SourceDefinitionRepository" }\r
        IntegrationHub.QuarkusApp.Repositories.ReaderDefinitionRepository@{ shape: rectangle, label: "ReaderDefinitionRepository" }\r
        IntegrationHub.QuarkusApp.Repositories.ProcessTaskDefinitionRepository@{ shape: rectangle, label: "ProcessTaskDefinitionRepository" }\r
        IntegrationHub.QuarkusApp.Repositories.ProcessExecutionRepository@{ shape: rectangle, label: "ProcessExecutionRepository" }\r
        IntegrationHub.QuarkusApp.Repositories.ProcessTaskExecutionRepository@{ shape: rectangle, label: "ProcessTaskExecutionRepository" }\r
        IntegrationHub.QuarkusApp.Repositories.AuditEventRepository@{ shape: rectangle, label: "AuditEventRepository" }\r
      end\r
      IntegrationHub.QuarkusApp.ProcessExecutionResource@{ shape: rectangle, label: "ProcessExecutionResource" }\r
      IntegrationHub.QuarkusApp.ProcessExecutionService@{ shape: rectangle, label: "ProcessExecutionService" }\r
      subgraph IntegrationHub.QuarkusApp.ProcessEngine["\`Process Engine\`"]\r
        IntegrationHub.QuarkusApp.ProcessEngine.JsonConfigurationMapper@{ shape: rectangle, label: "JsonConfigurationMapper" }\r
        IntegrationHub.QuarkusApp.ProcessEngine.SourceRegistry@{ shape: rectangle, label: "Source Provider Registry" }\r
        IntegrationHub.QuarkusApp.ProcessEngine.ReaderRegistry@{ shape: rectangle, label: "Reader Provider Registry" }\r
        IntegrationHub.QuarkusApp.ProcessEngine.TaskRegistry@{ shape: rectangle, label: "Task Provider Registry" }\r
        IntegrationHub.QuarkusApp.ProcessEngine.SourceProviders@{ shape: rectangle, label: "Source Providers" }\r
        IntegrationHub.QuarkusApp.ProcessEngine.ReaderProviders@{ shape: rectangle, label: "Reader Providers" }\r
        IntegrationHub.QuarkusApp.ProcessEngine.TaskProviders@{ shape: rectangle, label: "Task Providers" }\r
      end\r
  ...
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`Lee configuracion JSON\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.JsonConfigurationMapper\r
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`Resuelve SourceProvider\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.SourceRegistry\r
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`Resuelve ReaderProvider\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.ReaderRegistry\r
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`Resuelve TaskProvider\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.TaskRegistry\r
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`[...]\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.TaskProviders\r
  IntegrationHub.QuarkusApp.ProcessEngine.SourceRegistry -. "\`Usa implementations\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.SourceProviders\r
  IntegrationHub.QuarkusApp.ProcessEngine.ReaderRegistry -. "\`Usa implementations\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.ReaderProviders\r
  IntegrationHub.QuarkusApp.ProcessEngine.TaskRegistry -. "\`Usa implementations\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.TaskProviders\r
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`Registra eventos\`" .-> IntegrationHub.QuarkusApp.AuditService\r
  IntegrationHub.QuarkusApp.ProcessEngine.TaskProviders -. "\`Batch insert, update y upsert\`" .-> Db\r
  ...
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  Auditor -. "\`Consulta auditoria y resultados\`" .-> IntegrationHub.AdminConsole\r
  IntegrationHub.QuarkusApp.Repositories -. "\`Opera sobre PostgreSQL\`" .-> Db\r
  IntegrationHub.QuarkusApp -. "\`Lee archivos locales\`" .-> FileSources.Filesystem\r
  IntegrationHub.QuarkusApp -. "\`Descarga archivos\`" .-> FileSources.Ftp\r
  IntegrationHub.QuarkusApp -. "\`Descarga archivos\`" .-> FileSources.Sftp\r
  IntegrationHub.QuarkusApp -. "\`Obtiene payloads remotos\`" .-> FileSources.RestSource\r
  IntegrationHub.QuarkusApp -. "\`Exporta trazas\`" .-> Observability.Otel\r
`;case"domain_entities_code":return`---\r
title: "Domain Entities"\r
---\r
graph TB\r
  subgraph IntegrationHubQuarkusApp["\`App Service Quarkus Native\`"]\r
    subgraph IntegrationHubQuarkusApp.DomainEntities["\`Domain Entities\`"]\r
      subgraph IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities["\`Execution\`"]\r
        IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity@{ shape: rectangle, label: "ProcessTaskExecution" }\r
        IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity@{ shape: rectangle, label: "AuditEvent" }\r
        IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity@{ shape: rectangle, label: "ProcessExecution" }\r
      end\r
      subgraph IntegrationHubQuarkusApp.DomainEntities.CatalogEntities["\`Catalog\`"]\r
        IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity@{ shape: rectangle, label: "ProcessDefinition" }\r
        IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity@{ shape: rectangle, label: "ProcessTaskDefinition" }\r
        IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.SourceDefinitionEntity@{ shape: rectangle, label: "SourceDefinition" }\r
        IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ReaderDefinitionEntity@{ shape: rectangle, label: "ReaderDefinition" }\r
      end\r
    end\r
  end\r
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -. "\`0..1 sourceDefinition\`" .-> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.SourceDefinitionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -. "\`0..1 readerDefinition\`" .-> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ReaderDefinitionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity -. "\`1..n tasks\`" .-> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity -. "\`n..1 processDefinition\`" .-> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity -. "\`n..1 taskDefinition\`" .-> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity -. "\`0..1 taskDefinition\`" .-> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity -. "\`n..1 processExecution\`" .-> IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity -. "\`n..1 processExecution\`" .-> IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity\r
  IntegrationHubQuarkusApp -. "\`Persiste configuracion, jobs, auditoria y staging\`" .-> Db\r
`;case"security_overview":return`---\r
...
graph TB\r
  ...
  Auditor@{ icon: "fa:user", shape: rounded, label: "Auditor" }\r
  subgraph IntegrationHubQuarkusApp["\`App Service Quarkus Native\`"]\r
    IntegrationHubQuarkusApp.ProcessDefinitionResource@{ shape: rectangle, label: "ProcessDefinitionResource" }\r
    IntegrationHubQuarkusApp.ProcessExecutionResource@{ shape: rectangle, label: "ProcessExecutionResource" }\r
  end\r
  subgraph IntegrationHubAdminConsole["\`Admin Console App (Front)\`"]\r
  ...
  IntegrationAdmin -. "\`Administra catalogos y procesos\`" .-> IntegrationHubAdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHubAdminConsole\r
  Auditor -. "\`Consulta auditoria y resultados\`" .-> IntegrationHubAdminConsole\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppSourceDefinitionResource@{ shape: rectangle, label: "SourceDefinitionResource" }\r
  IntegrationHubQuarkusAppSourceCatalogService@{ shape: rectangle, label: "SourceCatalogService" }\r
  IntegrationHubQuarkusAppRepositoriesSourceDefinitionRepository@{ shape: rectangle, label: "SourceDefinitionRepository" }\r
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationAdmin -. "\`Define tipo de fuente y parametros\`" .-> IntegrationHubAdminConsoleProcessDesigner\r
  IntegrationHubAdminConsoleProcessDesigner -. "\`Registra source definition\`" .-> IntegrationHubQuarkusAppSourceDefinitionResource\r
  IntegrationHubQuarkusAppSourceDefinitionResource -. "\`Delega alta de catalogo\`" .-> IntegrationHubQuarkusAppSourceCatalogService\r
  IntegrationHubQuarkusAppSourceCatalogService -. "\`Persiste source definition\`" .-> IntegrationHubQuarkusAppRepositoriesSourceDefinitionRepository\r
  IntegrationHubQuarkusAppRepositoriesSourceDefinitionRepository -. "\`Guarda source definition\`" .-> Db\r
...
graph LR\r
  IntegrationAdmin@{ icon: "fa:user", shape: rounded, label: "Integration Admin" }\r
  IntegrationHubAdminConsoleProcessDesigner@{ shape: rectangle, label: "Process Designer" }\r
  IntegrationHubQuarkusAppReaderDefinitionResource@{ shape: rectangle, label: "ReaderDefinitionResource" }\r
  IntegrationHubQuarkusAppReaderCatalogService@{ shape: rectangle, label: "ReaderCatalogService" }\r
  IntegrationHubQuarkusAppRepositoriesReaderDefinitionRepository@{ shape: rectangle, label: "ReaderDefinitionRepository" }\r
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationAdmin -. "\`Define formato y layout\`" .-> IntegrationHubAdminConsoleProcessDesigner\r
  IntegrationHubAdminConsoleProcessDesigner -. "\`Registra reader definition\`" .-> IntegrationHubQuarkusAppReaderDefinitionResource\r
  IntegrationHubQuarkusAppReaderDefinitionResource -. "\`Delega alta de catalogo\`" .-> IntegrationHubQuarkusAppReaderCatalogService\r
  IntegrationHubQuarkusAppReaderCatalogService -. "\`Persiste reader definition\`" .-> IntegrationHubQuarkusAppRepositoriesReaderDefinitionRepository\r
  IntegrationHubQuarkusAppRepositoriesReaderDefinitionRepository -. "\`Guarda reader definition\`" .-> Db\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppRepositoriesProcessDefinitionRepository@{ shape: rectangle, label: "ProcessDefinitionRepository" }\r
  IntegrationHubQuarkusAppRepositoriesProcessTaskDefinitionRepository@{ shape: rectangle, label: "ProcessTaskDefinitionRepository" }\r
  IntegrationHubQuarkusAppReaderDefinitionResource@{ shape: rectangle, label: "ReaderDefinitionResource" }\r
  IntegrationHubQuarkusAppReaderCatalogService@{ shape: rectangle, label: "ReaderCatalogService" }\r
  IntegrationHubQuarkusAppRepositoriesReaderDefinitionRepository@{ shape: rectangle, label: "ReaderDefinitionRepository" }\r
  ...
  IntegrationHubQuarkusAppProcessCatalogService -. "\`Persiste definicion\`" .-> IntegrationHubQuarkusAppRepositoriesProcessDefinitionRepository\r
  IntegrationHubQuarkusAppProcessCatalogService -. "\`Persiste tasks\`" .-> IntegrationHubQuarkusAppRepositoriesProcessTaskDefinitionRepository\r
  IntegrationHubQuarkusAppRepositoriesProcessDefinitionRepository -. "\`Guarda process definition\`" .-> Db\r
  IntegrationHubQuarkusAppRepositoriesProcessTaskDefinitionRepository -. "\`Guarda process tasks\`" .-> Db\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppProcessExecutionService -. "\`Orquesta la ejecucion del motor\`" .-> IntegrationHubQuarkusAppProcessEngine\r
  ...
  IntegrationHubQuarkusAppTelemetry -. "\`Exporta trazas\`" .-> Observability.Otel\r
  Observability.Otel -. "\`Publica visualizacion\`" .-> Observability.Jaeger\r
