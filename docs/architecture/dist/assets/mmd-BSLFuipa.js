  ...
  subgraph IntegrationHub["\`Integration Hub Platform\`"]\r
    subgraph IntegrationHub.QuarkusApp["\`App Service Quarkus Native\`"]\r
      subgraph IntegrationHub.QuarkusApp.DomainEntities["\`Domain Entities\`"]\r
        subgraph IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities["\`Execution\`"]\r
          IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity@{ shape: rectangle, label: "ProcessTaskExecution" }\r
          IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity@{ shape: rectangle, label: "AuditEvent" }\r
          IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity@{ shape: rectangle, label: "ProcessExecution" }\r
        end\r
        subgraph IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities["\`Catalog\`"]\r
          IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity@{ shape: rectangle, label: "ProcessDefinition" }\r
          IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity@{ shape: rectangle, label: "ProcessTaskDefinition" }\r
          IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.SourceDefinitionEntity@{ shape: rectangle, label: "SourceDefinition" }\r
          IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ReaderDefinitionEntity@{ shape: rectangle, label: "ReaderDefinition" }\r
        end\r
      end\r
    end\r
  end\r
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -. "\`0..1 sourceDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.SourceDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -. "\`0..1 readerDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ReaderDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity -. "\`1..n tasks\`" .-> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity -. "\`n..1 processDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity -. "\`n..1 taskDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity -. "\`0..1 taskDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity -. "\`n..1 processExecution\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity -. "\`n..1 processExecution\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity\r
  IntegrationHub.QuarkusApp -. "\`Persiste configuracion, jobs, auditoria y staging\`" .-> Db\r
