...
graph TB\r
  ...
  IntegrationHubAdminConsole.ReactApp -. "\`Configura catalogos y procesos\`" .-> IntegrationHubAdminConsole.ProcessDesigner\r
  IntegrationHubAdminConsole.ReactApp -. "\`Consulta y ejecuta procesos\`" .-> IntegrationHubAdminConsole.OperationsConsole\r
  IntegrationHubAdminConsole.OidcClient -. "\`Login y refresh token\`" .-> Iam\r
  IntegrationHubAdminConsole.ProcessDesigner -. "\`CRUD de definiciones\`" .-> IntegrationHubQuarkusAppProcessDefinitionResource\r
  IntegrationHubAdminConsole.OperationsConsole -. "\`Ejecuta procesos\`" .-> IntegrationHubQuarkusAppProcessExecutionResource\r
  IntegrationHubAdminConsole.OperationsConsole -. "\`Consulta programaciones\`" .-> IntegrationHubQuarkusAppProcessScheduleResource\r
  IntegrationHubAdminConsole.OperationsConsole -. "\`Consulta ejecuciones y auditoria\`" .-> IntegrationHubQuarkusAppExecutionQueryResource\r
...
graph TB\r
  subgraph IntegrationHubQuarkusApp["\`App Service Quarkus Native\`"]\r
    ...
    IntegrationHubQuarkusApp.ProcessScheduleResource@{ shape: rectangle, label: "ProcessScheduleResource" }\r
    IntegrationHubQuarkusApp.ExecutionQueryResource@{ shape: rectangle, label: "ExecutionQueryResource" }\r
    IntegrationHubQuarkusApp.ProcessSchedulerService@{ shape: rectangle, label: "ProcessSchedulerService" }\r
    IntegrationHubQuarkusApp.Telemetry@{ shape: rectangle, label: "OpenTelemetry Instrumentation" }\r
    IntegrationHubQuarkusApp.ProcessCatalogService@{ shape: rectangle, label: "ProcessCatalogService" }\r
    IntegrationHubQuarkusApp.ProcessScheduleQueryService@{ shape: rectangle, label: "ProcessScheduleQueryService" }\r
    IntegrationHubQuarkusApp.ExecutionQueryService@{ shape: rectangle, label: "ExecutionQueryService" }\r
    IntegrationHubQuarkusApp.ProcessExecutionService@{ shape: rectangle, label: "ProcessExecutionService" }\r
    IntegrationHubQuarkusApp.PersistenceLayer@{ shape: rectangle, label: "Panache Persistence Layer" }\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  ExternalApi@{ shape: rectangle, label: "APIs externas" }\r
  IntegrationHubQuarkusApp.ProcessDefinitionResource -. "\`Delega gestion de procesos\`" .-> IntegrationHubQuarkusApp.ProcessCatalogService\r
  IntegrationHubQuarkusApp.ProcessExecutionResource -. "\`Delega ejecucion\`" .-> IntegrationHubQuarkusApp.ProcessExecutionService\r
  IntegrationHubQuarkusApp.ProcessScheduleResource -. "\`Delega consulta de schedules\`" .-> IntegrationHubQuarkusApp.ProcessScheduleQueryService\r
  IntegrationHubQuarkusApp.ExecutionQueryResource -. "\`Delega consultas operativas\`" .-> IntegrationHubQuarkusApp.ExecutionQueryService\r
  IntegrationHubQuarkusApp.ProcessCatalogService -. "\`Persiste definiciones\`" .-> IntegrationHubQuarkusApp.PersistenceLayer\r
  IntegrationHubQuarkusApp.ProcessExecutionService -. "\`[...]\`" .-> IntegrationHubQuarkusApp.ProcessEngine\r
  IntegrationHubQuarkusApp.ProcessExecutionService -. "\`Registra eventos\`" .-> IntegrationHubQuarkusApp.AuditService\r
  IntegrationHubQuarkusApp.ProcessSchedulerService -. "\`Dispara procesos programados\`" .-> IntegrationHubQuarkusApp.ProcessExecutionService\r
  IntegrationHubQuarkusApp.ProcessScheduleQueryService -. "\`Consulta programaciones\`" .-> IntegrationHubQuarkusApp.PersistenceLayer\r
  IntegrationHubQuarkusApp.ExecutionQueryService -. "\`Consulta ejecuciones y auditoria\`" .-> IntegrationHubQuarkusApp.PersistenceLayer\r
  IntegrationHubQuarkusApp.ProcessEngine -. "\`Batch insert, update y upsert\`" .-> Db\r
  IntegrationHubQuarkusApp.PersistenceLayer -. "\`Opera sobre PostgreSQL\`" .-> Db\r
  IntegrationHubQuarkusApp.ProcessEngine -. "\`[...]\`" .-> ExternalApi\r
  ObservabilityOtel -. "\`Entrega trazas\`" .-> ObservabilityJaeger\r
