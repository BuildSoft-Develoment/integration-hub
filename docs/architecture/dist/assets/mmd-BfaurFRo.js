...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catÃƒÂ¡logos y procesos\`" .-> IntegrationHub\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub\r
  Auditor -. "\`Consulta auditorÃƒÂ­a y resultados\`" .-> IntegrationHub\r
  SchedulerActor -. "\`UC-05\`" .-> IntegrationHub\r
  IntegrationHub -. "\`[...]\`" .-> ExternalApi\r
  IntegrationHub -. "\`[...]\`" .-> Iam\r
  IntegrationHub -. "\`[...]\`" .-> Db\r
  LoadBalancer -. "\`ReenvÃƒÂ­a trÃƒÂ¡fico al cluster\`" .-> IngressController\r
...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catÃƒÂ¡logos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  Auditor -. "\`Consulta auditorÃƒÂ­a y resultados\`" .-> IntegrationHub.AdminConsole\r
  IntegrationHub.AdminConsole -. "\`AutenticaciÃƒÂ³n OIDC\`" .-> Iam\r
  IntegrationHub.QuarkusApp -. "\`Valida access tokens\`" .-> Iam\r
  IntegrationHub.QuarkusApp -. "\`Persiste configuraciÃƒÂ³n, jobs, auditorÃƒÂ­a y staging\`" .-> Db\r
...
graph TB\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  Iam@{ shape: rectangle, label: "Keycloak" }\r
  IntegrationHub.AdminConsole.ReactApp -. "\`Gestiona sesiÃƒÂ³n\`" .-> IntegrationHub.AdminConsole.OidcClient\r
  IntegrationHub.AdminConsole.ReactApp -. "\`Configura catÃƒÂ¡logos y procesos\`" .-> IntegrationHub.AdminConsole.ProcessDesigner\r
  ...
  IntegrationHub.AdminConsole.OperationsConsole -. "\`Consulta ejecuciones y auditorÃƒÂ­a\`" .-> IntegrationHub.QuarkusApp.ExecutionQueryResource\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub.AdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHub.AdminConsole\r
  IntegrationAdmin -. "\`Administra catÃƒÂ¡logos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
...
graph TB\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  ExternalApi@{ shape: rectangle, label: "APIs externas" }\r
  IntegrationHub.QuarkusApp.ProcessDefinitionResource -. "\`Delega gestiÃƒÂ³n de procesos\`" .-> IntegrationHub.QuarkusApp.ProcessCatalogService\r
  IntegrationHub.QuarkusApp.SourceDefinitionResource -. "\`Delega gestiÃƒÂ³n de sources\`" .-> IntegrationHub.QuarkusApp.ProcessCatalogService\r
  IntegrationHub.QuarkusApp.ProcessExecutionResource -. "\`Delega ejecuciÃƒÂ³n\`" .-> IntegrationHub.QuarkusApp.ProcessExecutionService\r
  ...
  IntegrationHub.QuarkusApp.ExecutionQueryService -. "\`Consulta ejecuciones y auditorÃƒÂ­a\`" .-> IntegrationHub.QuarkusApp.PersistenceLayer\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub.AdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHub.AdminConsole\r
  IntegrationAdmin -. "\`Administra catÃƒÂ¡logos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  ...
  IntegrationHub.AdminConsole -. "\`Consulta ejecuciones y auditorÃƒÂ­a\`" .-> IntegrationHub.QuarkusApp.ExecutionQueryResource\r
...
graph TB\r
  ...
  IntegrationHub.AdminConsole.OperationsConsole -. "\`Ejecuta procesos\`" .-> IntegrationHub.QuarkusApp.ProcessExecutionResource\r
  IntegrationHub.QuarkusApp.ProcessExecutionResource -. "\`Delega ejecuciÃƒÂ³n\`" .-> IntegrationHub.QuarkusApp.ProcessExecutionService\r
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`Lee configuraciÃƒÂ³n JSON\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.JsonConfigurationMapper\r
...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catÃƒÂ¡logos y procesos\`" .-> IntegrationHubAdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHubAdminConsole\r
  Auditor -. "\`Consulta auditorÃƒÂ­a y resultados\`" .-> IntegrationHubAdminConsole\r
...
graph LR\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationAdmin -. "\`Define tipo de fuente y parÃƒÂ¡metros\`" .-> IntegrationHubAdminConsoleProcessDesigner\r
  IntegrationHubAdminConsoleProcessDesigner -. "\`Registra source definition\`" .-> IntegrationHubQuarkusAppSourceDefinitionResource\r
  IntegrationHubQuarkusAppSourceDefinitionResource -. "\`Delega alta de catÃƒÂ¡logo\`" .-> IntegrationHubQuarkusAppProcessCatalogService\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppProcessDefinitionResource -. "\`Delega alta de catÃƒÂ¡logo\`" .-> IntegrationHubQuarkusAppProcessCatalogService\r
...
title: "UC-03 DiseÃƒÂ±ar proceso"\r
---\r
graph LR\r
  IntegrationAdmin@{ icon: "fa:user", shape: rounded, label: "Integration Admin" }\r
  IntegrationHubAdminConsoleProcessDesigner@{ shape: rectangle, label: "Process Designer" }\r
  ...
  IntegrationHubQuarkusAppProcessCatalogService -. "\`Persiste definiciÃƒÂ³n\`" .-> IntegrationHubQuarkusAppPersistenceLayer\r
...
graph LR\r
  ...
  IntegrationHubAdminConsoleOperationsConsole -. "\`Solicita ejecuciÃƒÂ³n\`" .-> IntegrationHubQuarkusAppProcessExecutionResource\r
  IntegrationHubQuarkusAppProcessExecutionResource -. "\`Delega ejecuciÃƒÂ³n\`" .-> IntegrationHubQuarkusAppProcessExecutionService\r
  ...
  IntegrationHubQuarkusAppProcessEngine.TaskProvidersRestCallTaskProvider -. "\`EnvÃƒÂ­a payload\`" .-> ExternalApi\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppProcessSchedulerService -. "\`Lanza ejecuciÃƒÂ³n\`" .-> IntegrationHubQuarkusAppProcessExecutionService\r
  ...
  ObservabilityOtel -. "\`Publica visualizaciÃƒÂ³n\`" .-> ObservabilityJaeger\r
...
graph LR\r
  ...
  IntegrationHubAdminConsoleOidcClient -. "\`Solicita autenticaciÃƒÂ³n OIDC\`" .-> Iam\r
