...
skinparam rectangle<<UiService>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
skinparam rectangle<<ApiService>>{\r
  BackgroundColor #3b82f6\r
  FontColor #eff6ff\r
  BorderColor #2563eb\r
}\r
...
rectangle "==Service UI" <<UiService>> as UiService\r
rectangle "==Service API" <<ApiService>> as ApiService\r
...
skinparam rectangle<<ProdAppAppClusterUiService>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
skinparam rectangle<<ProdAppAppClusterApiService>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
...
\r
    ...
    rectangle "==Service UI" <<ProdAppAppClusterUiService>> as ProdAppAppClusterUiService\r
    rectangle "==Service API" <<ProdAppAppClusterApiService>> as ProdAppAppClusterApiService\r
...
ProdAppAppClusterIngressController .[#8D8D8D,thickness=2].> ProdAppAppClusterUiService : <color:#8D8D8D>Ruta host/path UI\r
ProdAppAppClusterIngressController .[#8D8D8D,thickness=2].> ProdAppAppClusterApiService : <color:#8D8D8D>Ruta host/path API\r
ProdAppAppClusterUiService .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode1 : <color:#8D8D8D>Balancea trafico UI\r
ProdAppAppClusterUiService .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode2 : <color:#8D8D8D>Balancea trafico UI\r
ProdAppAppClusterApiService .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode1 : <color:#8D8D8D>Balancea trafico API\r
ProdAppAppClusterApiService .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode2 : <color:#8D8D8D>Balancea trafico API\r
