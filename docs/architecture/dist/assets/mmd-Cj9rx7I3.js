...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catálogos y procesos\`" .-> IntegrationHub\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub\r
  Auditor -. "\`Consulta auditoría y resultados\`" .-> IntegrationHub\r
  SchedulerActor -. "\`UC-05\`" .-> IntegrationHub\r
  IntegrationHub -. "\`[...]\`" .-> ExternalApi\r
  IntegrationHub -. "\`[...]\`" .-> Iam\r
  IntegrationHub -. "\`[...]\`" .-> Db\r
  LoadBalancer -. "\`Reenvía tráfico al cluster\`" .-> IngressController\r
...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catálogos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  Auditor -. "\`Consulta auditoría y resultados\`" .-> IntegrationHub.AdminConsole\r
  IntegrationHub.AdminConsole -. "\`Autenticación OIDC\`" .-> Iam\r
  IntegrationHub.QuarkusApp -. "\`Valida access tokens\`" .-> Iam\r
  IntegrationHub.QuarkusApp -. "\`Persiste configuración, jobs, auditoría y staging\`" .-> Db\r
...
graph TB\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  Iam@{ shape: rectangle, label: "Keycloak" }\r
  IntegrationHub.AdminConsole.ReactApp -. "\`Gestiona sesión\`" .-> IntegrationHub.AdminConsole.OidcClient\r
  IntegrationHub.AdminConsole.ReactApp -. "\`Configura catálogos y procesos\`" .-> IntegrationHub.AdminConsole.ProcessDesigner\r
  ...
  IntegrationHub.AdminConsole.OperationsConsole -. "\`Consulta ejecuciones y auditoría\`" .-> IntegrationHub.QuarkusApp.ExecutionQueryResource\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub.AdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHub.AdminConsole\r
  IntegrationAdmin -. "\`Administra catálogos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
...
graph TB\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  ExternalApi@{ shape: rectangle, label: "APIs externas" }\r
  IntegrationHub.QuarkusApp.ProcessDefinitionResource -. "\`Delega gestión de procesos\`" .-> IntegrationHub.QuarkusApp.ProcessCatalogService\r
  IntegrationHub.QuarkusApp.SourceDefinitionResource -. "\`Delega gestión de sources\`" .-> IntegrationHub.QuarkusApp.ProcessCatalogService\r
  IntegrationHub.QuarkusApp.ProcessExecutionResource -. "\`Delega ejecución\`" .-> IntegrationHub.QuarkusApp.ProcessExecutionService\r
  ...
  IntegrationHub.QuarkusApp.ExecutionQueryService -. "\`Consulta ejecuciones y auditoría\`" .-> IntegrationHub.QuarkusApp.PersistenceLayer\r
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHub.AdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHub.AdminConsole\r
  IntegrationAdmin -. "\`Administra catálogos y procesos\`" .-> IntegrationHub.AdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  ...
  IntegrationHub.AdminConsole -. "\`Consulta ejecuciones y auditoría\`" .-> IntegrationHub.QuarkusApp.ExecutionQueryResource\r
...
graph TB\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  ExternalApi@{ shape: rectangle, label: "APIs externas" }\r
  IntegrationHub.QuarkusApp.ProcessExecutionService -. "\`Lee configuración JSON\`" .-> IntegrationHub.QuarkusApp.ProcessEngine.JsonConfigurationMapper\r
...
graph TB\r
  ...
  IntegrationAdmin -. "\`Administra catálogos y procesos\`" .-> IntegrationHubAdminConsole\r
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHubAdminConsole\r
  Auditor -. "\`Consulta auditoría y resultados\`" .-> IntegrationHubAdminConsole\r
...
graph LR\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationAdmin -. "\`Define tipo de fuente y parámetros\`" .-> IntegrationHubAdminConsoleProcessDesigner\r
  IntegrationHubAdminConsoleProcessDesigner -. "\`Registra source definition\`" .-> IntegrationHubQuarkusAppSourceDefinitionResource\r
  IntegrationHubQuarkusAppSourceDefinitionResource -. "\`Delega alta de catálogo\`" .-> IntegrationHubQuarkusAppProcessCatalogService\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppProcessDefinitionResource -. "\`Delega alta de catálogo\`" .-> IntegrationHubQuarkusAppProcessCatalogService\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppProcessCatalogService -. "\`Persiste definición\`" .-> IntegrationHubQuarkusAppPersistenceLayer\r
...
graph LR\r
  ...
  IntegrationHubAdminConsoleOperationsConsole -. "\`Solicita ejecución\`" .-> IntegrationHubQuarkusAppProcessExecutionResource\r
  IntegrationHubQuarkusAppProcessExecutionResource -. "\`Delega ejecución\`" .-> IntegrationHubQuarkusAppProcessExecutionService\r
  ...
  IntegrationHubQuarkusAppProcessEngine.TaskProvidersRestCallTaskProvider -. "\`Envía payload\`" .-> ExternalApi\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppProcessSchedulerService -. "\`Lanza ejecución\`" .-> IntegrationHubQuarkusAppProcessExecutionService\r
  ...
  ObservabilityOtel -. "\`Publica visualización\`" .-> ObservabilityJaeger\r
...
graph LR\r
  ...
  IntegrationHubAdminConsoleOidcClient -. "\`Solicita autenticación OIDC\`" .-> Iam\r
