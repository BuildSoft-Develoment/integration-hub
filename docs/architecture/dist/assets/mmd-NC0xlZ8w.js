...
graph TB\r
  ...
  User -. "\`Consulta estado y resultados\`" .-> IntegrationHubAdminConsole\r
  Admin -. "\`Configura fuentes, readers y procesos\`" .-> IntegrationHubAdminConsole\r
`;case"deployment_onprem":return'---\r\ntitle: "DEV, PRE y PRO"\r\n---\r\ngraph TB\r\n  subgraph DevOnprem["`onprem`"]\r\n    subgraph DevOnprem.Edge["`edge`"]\r\n      DevOnprem.Edge.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r\n      DevOnprem.Edge.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r\n    end\r\n    subgraph DevOnprem.Data["`data`"]\r\n      DevOnprem.Data.Otel@{ shape: rectangle, label: "OpenTelemetry Collector" }\r\n      DevOnprem.Data.Iam@{ shape: rectangle, label: "Keycloak" }\r\n      DevOnprem.Data.Db@{ shape: rectangle, label: "PostgreSQL" }\r\n      DevOnprem.Data.Jaeger@{ shape: rectangle, label: "Jaeger" }\r\n    end\r\n  end\r\n  subgraph PreOnprem["`onprem`"]\r\n    subgraph PreOnprem.AppCluster["`appCluster`"]\r\n      subgraph PreOnprem.AppCluster.PreNode1["`preNode1`"]\r\n        PreOnprem.AppCluster.PreNode1.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r\n        PreOnprem.AppCluster.PreNode1.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r\n      end\r\n      subgraph PreOnprem.AppCluster.PreNode2["`preNode2`"]\r\n        PreOnprem.AppCluster.PreNode2.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r\n        PreOnprem.AppCluster.PreNode2.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r\n      end\r\n    end\r\n    subgraph PreOnprem.Data["`data`"]\r\n      PreOnprem.Data.Otel@{ shape: rectangle, label: "OpenTelemetry Collector" }\r\n      PreOnprem.Data.Iam@{ shape: rectangle, label: "Keycloak" }\r\n      PreOnprem.Data.Db@{ shape: rectangle, label: "PostgreSQL" }\r\n      PreOnprem.Data.Jaeger@{ shape: rectangle, label: "Jaeger" }\r\n    end\r\n  end\r\n  subgraph ProdOnprem["`onprem`"]\r\n    subgraph ProdOnprem.LoadBalancer["`loadBalancer`"]\r\n      ProdOnprem.LoadBalancer.LoadBalancer@{ shape: rectangle, label: "Load Balancer / Reverse Proxy" }\r\n    end\r\n    subgraph ProdOnprem.Services["`services`"]\r\n      ProdOnprem.Services.Vault@{ shape: rectangle, label: "Secrets / Vault corporativo" }\r\n      ProdOnprem.Services.SharedStorage@{ shape: rectangle, label: "Shared File Storage" }\r\n    end\r\n    subgraph ProdOnprem.AppCluster["`appCluster`"]\r\n      subgraph ProdOnprem.AppCluster.ProdNode1["`prodNode1`"]\r\n        ProdOnprem.AppCluster.ProdNode1.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r\n        ProdOnprem.AppCluster.ProdNode1.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r\n      end\r\n      subgraph ProdOnprem.AppCluster.ProdNode2["`prodNode2`"]\r\n        ProdOnprem.AppCluster.ProdNode2.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r\n        ProdOnprem.AppCluster.ProdNode2.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r\n      end\r\n    end\r\n    subgraph ProdOnprem.Data["`data`"]\r\n      ProdOnprem.Data.Otel@{ shape: rectangle, label: "OpenTelemetry Collector" }\r\n      ProdOnprem.Data.Iam@{ shape: rectangle, label: "Keycloak" }\r\n      ProdOnprem.Data.Db@{ shape: rectangle, label: "PostgreSQL" }\r\n      ProdOnprem.Data.Jaeger@{ shape: rectangle, label: "Jaeger" }\r\n    end\r\n  end\r\n  DevOnprem.Edge.AdminConsole -. "`[...]`" .-> DevOnprem.Edge.QuarkusApp\r\n  DevOnprem.Data.Otel -. "`Entrega trazas`" .-> DevOnprem.Data.Jaeger\r\n  DevOnprem.Edge.AdminConsole -. "`[...]`" .-> DevOnprem.Data.Iam\r\n  DevOnprem.Edge.QuarkusApp -. "`[...]`" .-> DevOnprem.Data.Db\r\n  DevOnprem.Edge.QuarkusApp -. "`Valida access tokens`" .-> DevOnprem.Data.Iam\r\n  DevOnprem.Edge.QuarkusApp -. "`Exporta trazas`" .-> DevOnprem.Data.Otel\r\n  PreOnprem.AppCluster.PreNode1.AdminConsole -. "`[...]`" .-> PreOnprem.AppCluster.PreNode1.QuarkusApp\r\n  PreOnprem.AppCluster.PreNode2.AdminConsole -. "`[...]`" .-> PreOnprem.AppCluster.PreNode2.QuarkusApp\r\n  PreOnprem.Data.Otel -. "`Entrega trazas`" .-> PreOnprem.Data.Jaeger\r\n  PreOnprem.AppCluster.PreNode1.AdminConsole -. "`[...]`" .-> PreOnprem.Data.Iam\r\n  PreOnprem.AppCluster.PreNode1.QuarkusApp -. "`[...]`" .-> PreOnprem.Data.Db\r\n  PreOnprem.AppCluster.PreNode1.QuarkusApp -. "`Valida access tokens`" .-> PreOnprem.Data.Iam\r\n  PreOnprem.AppCluster.PreNode1.QuarkusApp -. "`Exporta trazas`" .-> PreOnprem.Data.Otel\r\n  PreOnprem.AppCluster.PreNode2.AdminConsole -. "`[...]`" .-> PreOnprem.Data.Iam\r\n  PreOnprem.AppCluster.PreNode2.QuarkusApp -. "`[...]`" .-> PreOnprem.Data.Db\r\n  PreOnprem.AppCluster.PreNode2.QuarkusApp -. "`Valida access tokens`" .-> PreOnprem.Data.Iam\r\n  PreOnprem.AppCluster.PreNode2.QuarkusApp -. "`Exporta trazas`" .-> PreOnprem.Data.Otel\r\n  ProdOnprem.AppCluster.ProdNode1.AdminConsole -. "`[...]`" .-> ProdOnprem.AppCluster.ProdNode1.QuarkusApp\r\n  ProdOnprem.AppCluster.ProdNode2.AdminConsole -. "`[...]`" .-> ProdOnprem.AppCluster.ProdNode2.QuarkusApp\r\n  ProdOnprem.Data.Otel -. "`Entrega trazas`" .-> ProdOnprem.Data.Jaeger\r\n  ProdOnprem.LoadBalancer.LoadBalancer -. "`Publica UI on-prem`" .-> ProdOnprem.AppCluster.ProdNode1.AdminConsole\r\n  ProdOnprem.LoadBalancer.LoadBalancer -. "`Publica APIs on-prem`" .-> ProdOnprem.AppCluster.ProdNode1.QuarkusApp\r\n  ProdOnprem.LoadBalancer.LoadBalancer -. "`Publica UI on-prem`" .-> ProdOnprem.AppCluster.ProdNode2.AdminConsole\r\n  ProdOnprem.LoadBalancer.LoadBalancer -. "`Publica APIs on-prem`" .-> ProdOnprem.AppCluster.ProdNode2.QuarkusApp\r\n  ProdOnprem.AppCluster.ProdNode1.AdminConsole -. "`[...]`" .-> ProdOnprem.Data.Iam\r\n  ProdOnprem.AppCluster.ProdNode1.QuarkusApp -. "`[...]`" .-> ProdOnprem.Data.Db\r\n  ProdOnprem.AppCluster.ProdNode1.QuarkusApp -. "`Valida access tokens`" .-> ProdOnprem.Data.Iam\r\n  ProdOnprem.AppCluster.ProdNode1.QuarkusApp -. "`Exporta trazas`" .-> ProdOnprem.Data.Otel\r\n  ProdOnprem.Services.Vault -. "`Entrega secretos y credenciales`" .-> ProdOnprem.AppCluster.ProdNode1.QuarkusApp\r\n  ProdOnprem.Services.SharedStorage -. "`Comparte archivos locales`" .-> ProdOnprem.AppCluster.ProdNode1.QuarkusApp\r\n  ProdOnprem.AppCluster.ProdNode2.AdminConsole -. "`[...]`" .-> ProdOnprem.Data.Iam\r\n  ProdOnprem.AppCluster.ProdNode2.QuarkusApp -. "`[...]`" .-> ProdOnprem.Data.Db\r\n  ProdOnprem.AppCluster.ProdNode2.QuarkusApp -. "`Valida access tokens`" .-> ProdOnprem.Data.Iam\r\n  ProdOnprem.AppCluster.ProdNode2.QuarkusApp -. "`Exporta trazas`" .-> ProdOnprem.Data.Otel\r\n  ProdOnprem.Services.Vault -. "`Entrega secretos y credenciales`" .-> ProdOnprem.AppCluster.ProdNode2.QuarkusApp\r\n  ProdOnprem.Services.SharedStorage -. "`Comparte archivos locales`" .-> ProdOnprem.AppCluster.ProdNode2.QuarkusApp\r\n';case"usecase_design_execute":return`---\r
