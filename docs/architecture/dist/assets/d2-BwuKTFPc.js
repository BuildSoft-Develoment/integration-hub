...
AppService: {\r
  label: "Integration Hub HTTP Service"\r
}\r
Vault: {\r
...
IntegrationHub -> Iam: "[...]"\r
IntegrationHub -> Db: "[...]"\r
IntegrationHub -> FileSourcesFilesystem: "Lee archivos locales"\r
IntegrationHub -> FileSourcesFtp: "Descarga archivos"\r
IntegrationHub -> FileSourcesSftp: "Descarga archivos"\r
IntegrationHub -> FileSourcesRestSource: "Obtiene payloads remotos"\r
IntegrationHub -> ExternalApi: "[...]"\r
IntegrationHub -> Observability: "Exporta trazas"\r
...
ProdApp.AppCluster.IngressController.IngressController -> ProdApp.AppCluster.AppPod1.AdminConsole: "Enruta trafico HTTP interno"\r
ProdApp.AppCluster.IngressController.IngressController -> ProdApp.AppCluster.AppPod1.QuarkusApp: "Enruta trafico HTTP interno"\r
ProdApp.AppCluster.IngressController.IngressController -> ProdApp.AppCluster.AppPod2.AdminConsole: "Enruta trafico HTTP interno"\r
ProdApp.AppCluster.IngressController.IngressController -> ProdApp.AppCluster.AppPod2.QuarkusApp: "Enruta trafico HTTP interno"\r
...
ProdApp.AppCluster.IngressController -> ProdApp.AppCluster.AppHttpService: "Ruta UI y API"\r
ProdApp.AppCluster.AppHttpService -> ProdApp.AppCluster.AppPod1: "Balancea trafico HTTP"\r
ProdApp.AppCluster.AppHttpService -> ProdApp.AppCluster.AppPod2: "Balancea trafico HTTP"\r
