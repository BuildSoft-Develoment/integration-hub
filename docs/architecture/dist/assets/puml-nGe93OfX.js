...
rectangle "==PostgreSQL" <<Db>> as Db\r
\r
IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesSourceDefinitionEntity : <color:#8D8D8D>0..1 sourceDefinition\r
IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesReaderDefinitionEntity : <color:#8D8D8D>0..1 readerDefinition\r
IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessDefinitionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity : <color:#8D8D8D>1..n tasks\r
IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessExecutionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessDefinitionEntity : <color:#8D8D8D>n..1 processDefinition\r
IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessTaskExecutionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity : <color:#8D8D8D>n..1 taskDefinition\r
IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesAuditEventEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesCatalogEntitiesProcessTaskDefinitionEntity : <color:#8D8D8D>0..1 taskDefinition\r
IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessTaskExecutionEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessExecutionEntity : <color:#8D8D8D>n..1 processExecution\r
IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesAuditEventEntity .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesExecutionEntitiesProcessExecutionEntity : <color:#8D8D8D>n..1 processExecution\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Persiste configuracion, jobs, auditoria y staging\r
@enduml\r
