...
IntegrationAdmin -> IntegrationHub: "Administra catÃƒÆ’Ã‚Â¡logos y procesos"\r
Operator -> IntegrationHub: "Ejecuta procesos"\r
Auditor -> IntegrationHub: "Consulta auditorÃƒÆ’Ã‚Â­a y resultados"\r
SchedulerActor -> IntegrationHub: "UC-05"\r
IntegrationHub -> ExternalApi: "[...]"\r
IntegrationHub -> Iam: "[...]"\r
IntegrationHub -> Db: "[...]"\r
LoadBalancer -> IngressController: "ReenvÃƒÆ’Ã‚Â­a trÃƒÆ’Ã‚Â¡fico al cluster"\r
...
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catÃƒÆ’Ã‚Â¡logos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
Auditor -> IntegrationHub.AdminConsole: "Consulta auditorÃƒÆ’Ã‚Â­a y resultados"\r
IntegrationHub.AdminConsole -> Iam: "AutenticaciÃƒÆ’Ã‚Â³n OIDC"\r
IntegrationHub.QuarkusApp -> Iam: "Valida access tokens"\r
IntegrationHub.QuarkusApp -> Db: "Persiste configuraciÃƒÆ’Ã‚Â³n, jobs, auditorÃƒÆ’Ã‚Â­a y staging"\r
...
\r
IntegrationHub.AdminConsole.ReactApp -> IntegrationHub.AdminConsole.OidcClient: "Gestiona sesiÃƒÆ’Ã‚Â³n"\r
IntegrationHub.AdminConsole.ReactApp -> IntegrationHub.AdminConsole.ProcessDesigner: "Configura catÃƒÆ’Ã‚Â¡logos y procesos"\r
...
IntegrationHub.AdminConsole.OperationsConsole -> IntegrationHub.QuarkusApp.ExecutionQueryResource: "Consulta ejecuciones y auditorÃƒÆ’Ã‚Â­a"\r
User -> IntegrationHub.AdminConsole: "Consulta estado y resultados"\r
Admin -> IntegrationHub.AdminConsole: "Configura fuentes, readers y procesos"\r
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catÃƒÆ’Ã‚Â¡logos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
...
\r
IntegrationHub.QuarkusApp.ProcessDefinitionResource -> IntegrationHub.QuarkusApp.ProcessCatalogService: "Delega gestiÃƒÆ’Ã‚Â³n de procesos"\r
IntegrationHub.QuarkusApp.SourceDefinitionResource -> IntegrationHub.QuarkusApp.ProcessCatalogService: "Delega gestiÃƒÆ’Ã‚Â³n de sources"\r
IntegrationHub.QuarkusApp.ProcessExecutionResource -> IntegrationHub.QuarkusApp.ProcessExecutionService: "Delega ejecuciÃƒÆ’Ã‚Â³n"\r
...
IntegrationHub.QuarkusApp.ExecutionQueryService -> IntegrationHub.QuarkusApp.PersistenceLayer: "Consulta ejecuciones y auditorÃƒÆ’Ã‚Â­a"\r
User -> IntegrationHub.AdminConsole: "Consulta estado y resultados"\r
Admin -> IntegrationHub.AdminConsole: "Configura fuentes, readers y procesos"\r
IntegrationAdmin -> IntegrationHub.AdminConsole: "Administra catÃƒÆ’Ã‚Â¡logos y procesos"\r
Operator -> IntegrationHub.AdminConsole: "Ejecuta procesos"\r
...
IntegrationHub.AdminConsole -> IntegrationHub.QuarkusApp.ExecutionQueryResource: "Consulta ejecuciones y auditorÃƒÆ’Ã‚Â­a"\r
...
IntegrationHub.AdminConsole.OperationsConsole -> IntegrationHub.QuarkusApp.ProcessExecutionResource: "Ejecuta procesos"\r
IntegrationHub.QuarkusApp.ProcessExecutionResource -> IntegrationHub.QuarkusApp.ProcessExecutionService: "Delega ejecuciÃƒÆ’Ã‚Â³n"\r
IntegrationHub.QuarkusApp.ProcessExecutionService -> IntegrationHub.QuarkusApp.ProcessEngine.JsonConfigurationMapper: "Lee configuraciÃƒÆ’Ã‚Â³n JSON"\r
...
IntegrationAdmin -> IntegrationHubAdminConsole: "Administra catÃƒÆ’Ã‚Â¡logos y procesos"\r
Operator -> IntegrationHubAdminConsole: "Ejecuta procesos"\r
Auditor -> IntegrationHubAdminConsole: "Consulta auditorÃƒÆ’Ã‚Â­a y resultados"\r
...
ProdEdge.LoadBalancer.LoadBalancer -> ProdApp.AppCluster.IngressController.IngressController: "ReenvÃƒÆ’Ã‚Â­a trÃƒÆ’Ã‚Â¡fico al cluster"\r
...
ProdApp.AppCluster.AppService -> ProdApp.AppCluster.AppPod1: "Balancea trÃƒÆ’Ã‚Â¡fico HTTP"\r
ProdApp.AppCluster.AppService -> ProdApp.AppCluster.AppPod2: "Balancea trÃƒÆ’Ã‚Â¡fico HTTP"\r
...
\r
IntegrationAdmin -> IntegrationHubAdminConsoleProcessDesigner: "Define tipo de fuente y parÃƒÆ’Ã‚Â¡metros"\r
IntegrationHubAdminConsoleProcessDesigner -> IntegrationHubQuarkusAppSourceDefinitionResource: "Registra source definition"\r
IntegrationHubQuarkusAppSourceDefinitionResource -> IntegrationHubQuarkusAppProcessCatalogService: "Delega alta de catÃƒÆ’Ã‚Â¡logo"\r
...
IntegrationHubQuarkusAppProcessDefinitionResource -> IntegrationHubQuarkusAppProcessCatalogService: "Delega alta de catÃƒÆ’Ã‚Â¡logo"\r
...
IntegrationHubQuarkusAppProcessCatalogService -> IntegrationHubQuarkusAppPersistenceLayer: "Persiste definiciÃƒÆ’Ã‚Â³n"\r
...
IntegrationHubAdminConsoleOperationsConsole -> IntegrationHubQuarkusAppProcessExecutionResource: "Solicita ejecuciÃƒÆ’Ã‚Â³n"\r
IntegrationHubQuarkusAppProcessExecutionResource -> IntegrationHubQuarkusAppProcessExecutionService: "Delega ejecuciÃƒÆ’Ã‚Â³n"\r
...
IntegrationHubQuarkusAppProcessEngine.TaskProvidersRestCallTaskProvider -> ExternalApi: "EnvÃƒÆ’Ã‚Â­a payload"\r
...
IntegrationHubQuarkusAppProcessSchedulerService -> IntegrationHubQuarkusAppProcessExecutionService: "Lanza ejecuciÃƒÆ’Ã‚Â³n"\r
...
ObservabilityOtel -> ObservabilityJaeger: "Publica visualizaciÃƒÆ’Ã‚Â³n"\r
...
IntegrationHubAdminConsoleOidcClient -> Iam: "Solicita autenticaciÃƒÆ’Ã‚Â³n OIDC"\r
