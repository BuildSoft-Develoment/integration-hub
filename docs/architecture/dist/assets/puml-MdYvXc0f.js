...
IntegrationHubAdminConsoleProcessDesigner .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessDefinitionResource : <color:#8D8D8D>CRUD de definiciones\r
...
IntegrationHubQuarkusAppProcessExecutionService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngine : <color:#8D8D8D>Orquesta tareas\r
...
ObservabilityOtel .[#8D8D8D,thickness=2].> ObservabilityJaeger : <color:#8D8D8D>Entrega trazas\r
@enduml\r
`;case"execution_query_layers":return`@startuml\r
...
IntegrationHubAdminConsoleProcessDesigner .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessDefinitionResource : <color:#8D8D8D>Registra source definition\r
...
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecucion\r
IntegrationHubQuarkusAppProcessExecutionService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngine : <color:#8D8D8D>Orquesta el proceso\r
IntegrationHubQuarkusAppProcessEngine .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngineSourceRegistry : <color:#8D8D8D>Resuelve fuente\r
IntegrationHubQuarkusAppProcessEngine .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngineReaderRegistry : <color:#8D8D8D>Lee contenido\r
