...
\r
IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.SourceDefinitionEntity: "0..1 sourceDefinition"\r
IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ReaderDefinitionEntity: "0..1 readerDefinition"\r
IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity -> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity: "1..n tasks"\r
IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity -> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity: "n..1 processDefinition"\r
IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity -> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity: "n..1 taskDefinition"\r
IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity -> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity: "0..1 taskDefinition"\r
IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity -> IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity: "n..1 processExecution"\r
IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity -> IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity: "n..1 processExecution"\r
