...
title "DEV, PRE y PRO on-premise"\r
top to bottom direction\r
\r
hide stereotype\r
skinparam ranksep 60\r
...
\r
skinparam rectangle<<OnPremDevEnv>>{\r
  BackgroundColor #737373\r
  FontColor #fafafa\r
  BorderColor #525252\r
}\r
skinparam rectangle<<OnPremPreEnv>>{\r
  BackgroundColor #737373\r
  FontColor #fafafa\r
  BorderColor #525252\r
}\r
skinparam rectangle<<OnPremProEnv>>{\r
  BackgroundColor #737373\r
  FontColor #fafafa\r
  BorderColor #525252\r
}\r
skinparam rectangle<<OnPremLoadBalancer>>{\r
  BackgroundColor #737373\r
  FontColor #fafafa\r
  BorderColor #525252\r
}\r
skinparam rectangle<<OnPremVault>>{\r
  BackgroundColor #737373\r
  FontColor #fafafa\r
  BorderColor #525252\r
}\r
skinparam rectangle<<OnPremSharedStorage>>{\r
  BackgroundColor #737373\r
  FontColor #fafafa\r
  BorderColor #525252\r
}\r
...
rectangle "==DEV Environment" <<OnPremDevEnv>> as OnPremDevEnv\r
rectangle "==PRE Environment" <<OnPremPreEnv>> as OnPremPreEnv\r
rectangle "==PRO Environment" <<OnPremProEnv>> as OnPremProEnv\r
rectangle "==Load Balancer / Reverse Proxy" <<OnPremLoadBalancer>> as OnPremLoadBalancer\r
rectangle "==Secrets / Vault corporativo" <<OnPremVault>> as OnPremVault\r
rectangle "==Shared File Storage" <<OnPremSharedStorage>> as OnPremSharedStorage\r
rectangle "==Admin Console" <<IntegrationHubAdminConsole>> as IntegrationHubAdminConsole\r
rectangle "==Quarkus Native App" <<IntegrationHubQuarkusApp>> as IntegrationHubQuarkusApp\r
rectangle "==Keycloak" <<Iam>> as Iam\r
rectangle "==PostgreSQL" <<Db>> as Db\r
...
rectangle "==Jaeger" <<ObservabilityJaeger>> as ObservabilityJaeger\r
\r
OnPremDevEnv .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Despliega UI dev\r
OnPremPreEnv .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Despliega UI pre\r
OnPremProEnv .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Despliega UI pro\r
OnPremLoadBalancer .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Publica UI on-prem\r
OnPremDevEnv .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Despliega app dev\r
OnPremPreEnv .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Despliega app pre\r
OnPremProEnv .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Despliega app pro\r
OnPremLoadBalancer .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Publica APIs on-prem\r
OnPremVault .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Entrega secretos y credenciales\r
OnPremSharedStorage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Comparte archivos locales\r
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Invoca APIs protegidas\r
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Autenticacion OIDC\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Valida access tokens\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Persiste configuracion, jobs, auditoria y staging\r
...
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> ExternalApi : <color:#8D8D8D>Invoca APIs de negocio\r
@enduml\r
`;case"usecases":return`@startuml\r
...
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleOperationsConsole : <color:#8D8D8D>UC-04, UC-06, UC-08\r
Auditor .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleOperationsConsole : <color:#8D8D8D>UC-06, UC-07\r
SchedulerActor .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppScheduler : <color:#8D8D8D>UC-05\r
PlatformAdmin .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>UC-09\r
PlatformAdmin .[#8D8D8D,thickness=2].> OnPrem : <color:#8D8D8D>UC-10\r
InfraTeam .[#8D8D8D,thickness=2].> OnPrem : <color:#8D8D8D>UC-10\r
@enduml\r
