...
IntegrationHub.QuarkusApp.ProcessEngine -> Db: "Batch insert, update y upsert internos"\r
...
IntegrationHub.QuarkusApp.ProcessExecutionService -> IntegrationHub.QuarkusApp.AuditService: "Registra eventos"\r
IntegrationHub.QuarkusApp.ProcessEngine.TaskProviders -> Db: "Batch insert, update y upsert internos"\r
...
IntegrationHub.QuarkusApp -> FileSources.RestSource: "Obtiene payloads remotos"\r
IntegrationHub.QuarkusApp -> Observability.Otel: "Exporta trazas"\r
`;case"package_structure_code":return`direction: down\r
\r
...
\r
    ProviderPackage: {\r
      label: "provider"\r
\r
      ProviderSourcePackage: {\r
        label: "provider.source"\r
      }\r
      ProviderReaderPackage: {\r
        label: "provider.reader"\r
      }\r
      ProviderTaskPackage: {\r
        label: "provider.task"\r
      }\r
    }\r
    ApiPackage: {\r
      label: "api"\r
...
\r
IntegrationHubQuarkusApp.Packages.ApiPackage -> IntegrationHubQuarkusApp.Packages.ApiQueryPackage: "Expone DTOs y respuestas"\r
IntegrationHubQuarkusApp.Packages.ApiPackage -> IntegrationHubQuarkusApp.Packages.ServicePackage: "Invoca servicios"\r
IntegrationHubQuarkusApp.Packages.ApiQueryPackage -> IntegrationHubQuarkusApp.Packages.ServicePackage: "Consume consultas"\r
IntegrationHubQuarkusApp.Packages.ServicePackage -> IntegrationHubQuarkusApp.Packages.RepositoryPackage: "Accede a persistencia"\r
IntegrationHubQuarkusApp.Packages.ServicePackage -> IntegrationHubQuarkusApp.Packages.SpiPackage: "Orquesta contratos"\r
IntegrationHubQuarkusApp.Packages.ServicePackage -> IntegrationHubQuarkusApp.Packages.DomainPackage: "Usa enums y tipos"\r
IntegrationHubQuarkusApp.Packages.RepositoryPackage -> IntegrationHubQuarkusApp.Packages.EntityPackage: "Persiste entidades"\r
IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderSourcePackage -> IntegrationHubQuarkusApp.Packages.SpiPackage: "Implementa SourceProvider"\r
IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderReaderPackage -> IntegrationHubQuarkusApp.Packages.SpiPackage: "Implementa ReaderProvider"\r
IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderTaskPackage -> IntegrationHubQuarkusApp.Packages.RepositoryPackage: "Colabora con persistencia"\r
IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderTaskPackage -> IntegrationHubQuarkusApp.Packages.SpiPackage: "Implementa TaskProvider"\r
IntegrationHubQuarkusApp.Packages.ProviderPackage.ProviderTaskPackage -> IntegrationHubQuarkusApp.Packages.DomainPackage: "Usa estados y tipos"\r
