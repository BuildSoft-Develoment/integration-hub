...
graph TB\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.SourceDefinitionEntity -. "\`0..n taskDefinitions\`" .-> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ReaderDefinitionEntity -. "\`0..n taskDefinitions\`" .-> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity -. "\`0..n taskDefinitions\`" .-> IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessDefinitionEntity -. "\`0..n processExecutions\`" .-> IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -. "\`0..n taskExecutions\`" .-> IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.CatalogEntities.ProcessTaskDefinitionEntity -. "\`0..n auditEvents\`" .-> IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity\r
  IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity -. "\`0..n taskExecutions\`" .-> IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessTaskExecutionEntity\r
  IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.ProcessExecutionEntity -. "\`0..n auditEvents\`" .-> IntegrationHubQuarkusApp.DomainEntities.ExecutionEntities.AuditEventEntity\r
