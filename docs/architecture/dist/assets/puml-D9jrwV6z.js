...
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Administra catÃƒÆ’Ã‚Â¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Ejecuta procesos\r
Auditor .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Consulta auditorÃƒÆ’Ã‚Â­a y resultados\r
...
LoadBalancer .[#8D8D8D,thickness=2].> IngressController : <color:#8D8D8D>ReenvÃƒÆ’Ã‚Â­a trÃƒÆ’Ã‚Â¡fico al cluster\r
...
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catÃƒÆ’Ã‚Â¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
Auditor .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta auditorÃƒÆ’Ã‚Â­a y resultados\r
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>AutenticaciÃƒÆ’Ã‚Â³n OIDC\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Valida access tokens\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Persiste configuraciÃƒÆ’Ã‚Â³n, jobs, auditorÃƒÆ’Ã‚Â­a y staging\r
...
rectangle "==Keycloak" <<Iam>> as Iam\r
\r
IntegrationHubAdminConsoleReactApp .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleOidcClient : <color:#8D8D8D>Gestiona sesiÃƒÆ’Ã‚Â³n\r
IntegrationHubAdminConsoleReactApp .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleProcessDesigner : <color:#8D8D8D>Configura catÃƒÆ’Ã‚Â¡logos y procesos\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppExecutionQueryResource : <color:#8D8D8D>Consulta ejecuciones y auditorÃƒÆ’Ã‚Â­a\r
User .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catÃƒÆ’Ã‚Â¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
...
rectangle "==APIs externas" <<ExternalApi>> as ExternalApi\r
\r
IntegrationHubQuarkusAppProcessDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega gestiÃƒÆ’Ã‚Â³n de procesos\r
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega gestiÃƒÆ’Ã‚Â³n de sources\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecuciÃƒÆ’Ã‚Â³n\r
...
IntegrationHubQuarkusAppExecutionQueryService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPersistenceLayer : <color:#8D8D8D>Consulta ejecuciones y auditorÃƒÆ’Ã‚Â­a\r
User .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catÃƒÆ’Ã‚Â¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
...
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppExecutionQueryResource : <color:#8D8D8D>Consulta ejecuciones y auditorÃƒÆ’Ã‚Â­a\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionResource : <color:#8D8D8D>Ejecuta procesos\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecuciÃƒÆ’Ã‚Â³n\r
IntegrationHubQuarkusAppProcessExecutionService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngineJsonConfigurationMapper : <color:#8D8D8D>Lee configuraciÃƒÆ’Ã‚Â³n JSON\r
...
ProdEdgeLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppAppClusterIngressControllerIngressController : <color:#8D8D8D>ReenvÃƒÆ’Ã‚Â­a trÃƒÆ’Ã‚Â¡fico al cluster\r
...
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod1 : <color:#8D8D8D>Balancea trÃƒÆ’Ã‚Â¡fico HTTP\r
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod2 : <color:#8D8D8D>Balancea trÃƒÆ’Ã‚Â¡fico HTTP\r
...
rectangle "==PostgreSQL" <<Db>> as Db\r
\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleProcessDesigner : <color:#8D8D8D>Define tipo de fuente y parÃƒÆ’Ã‚Â¡metros\r
...
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega alta de catÃƒÆ’Ã‚Â¡logo\r
...
IntegrationHubQuarkusAppProcessDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega alta de catÃƒÆ’Ã‚Â¡logo\r
...
IntegrationHubQuarkusAppProcessCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPersistenceLayer : <color:#8D8D8D>Persiste definiciÃƒÆ’Ã‚Â³n\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionResource : <color:#8D8D8D>Solicita ejecuciÃƒÆ’Ã‚Â³n\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecuciÃƒÆ’Ã‚Â³n\r
...
IntegrationHubQuarkusAppProcessEngineTaskProvidersRestCallTaskProvider .[#8D8D8D,thickness=2].> ExternalApi : <color:#8D8D8D>EnvÃƒÆ’Ã‚Â­a payload\r
@enduml\r
...
IntegrationHubQuarkusAppProcessSchedulerService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Lanza ejecuciÃƒÆ’Ã‚Â³n\r
...
ObservabilityOtel .[#8D8D8D,thickness=2].> ObservabilityJaeger : <color:#8D8D8D>Publica visualizaciÃƒÆ’Ã‚Â³n\r
@enduml\r
...
IntegrationHubAdminConsoleOidcClient .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Solicita autenticaciÃƒÆ’Ã‚Â³n OIDC\r
