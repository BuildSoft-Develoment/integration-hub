...
rectangle "==PostgreSQL" <<Db>> as Db\r
\r
IntegrationHubQuarkusAppPersistenceLayer .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesSourceDefinitionEntity : <color:#8D8D8D>Lee y persiste\r
IntegrationHubQuarkusAppPersistenceLayer .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesReaderDefinitionEntity : <color:#8D8D8D>Lee y persiste\r
IntegrationHubQuarkusAppPersistenceLayer .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesProcessDefinitionEntity : <color:#8D8D8D>Lee y persiste\r
IntegrationHubQuarkusAppPersistenceLayer .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesProcessTaskDefinitionEntity : <color:#8D8D8D>Lee y persiste\r
IntegrationHubQuarkusAppPersistenceLayer .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesProcessExecutionEntity : <color:#8D8D8D>Lee y persiste\r
IntegrationHubQuarkusAppPersistenceLayer .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesProcessTaskExecutionEntity : <color:#8D8D8D>Lee y persiste\r
IntegrationHubQuarkusAppPersistenceLayer .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppDomainEntitiesAuditEventEntity : <color:#8D8D8D>Lee y persiste\r
