...
\r
User -> OnPrem: "Accede por HTTPS"\r
User -> IntegrationHub: "Consulta estado y resultados"\r
Admin -> OnPrem: "Administra por HTTPS"\r
...
ProdApp.AppCluster.IngressController.Ingress -> ProdApp.AppCluster.ProdNode1.AdminConsole: "Enruta trafico HTTP interno"\r
ProdApp.AppCluster.IngressController.Ingress -> ProdApp.AppCluster.ProdNode1.QuarkusApp: "Enruta trafico HTTP interno"\r
ProdApp.AppCluster.IngressController.Ingress -> ProdApp.AppCluster.ProdNode2.AdminConsole: "Enruta trafico HTTP interno"\r
ProdApp.AppCluster.IngressController.Ingress -> ProdApp.AppCluster.ProdNode2.QuarkusApp: "Enruta trafico HTTP interno"\r
ProdData.ObservabilityNode.Otel -> ProdData.ObservabilityNode.Jaeger: "Entrega trazas"\r
ProdEdge.LoadBalancerLoadBalancer -> ProdApp.AppCluster.IngressController.Ingress: "Reenvia trafico al cluster"\r
ProdEdge.LoadBalancerLoadBalancer -> ProdApp.AppCluster.ProdNode1.AdminConsole: "Publica UI on-prem"\r
ProdEdge.LoadBalancerLoadBalancer -> ProdApp.AppCluster.ProdNode1.QuarkusApp: "Publica APIs on-prem"\r
ProdEdge.LoadBalancerLoadBalancer -> ProdApp.AppCluster.ProdNode2.AdminConsole: "Publica UI on-prem"\r
ProdEdge.LoadBalancerLoadBalancer -> ProdApp.AppCluster.ProdNode2.QuarkusApp: "Publica APIs on-prem"\r
