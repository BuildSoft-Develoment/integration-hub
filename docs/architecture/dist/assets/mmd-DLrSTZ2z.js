...
graph TB\r
  ...
  IntegrationHub.QuarkusApp -. "\`Persiste configuracion, jobs, auditoria y staging\`" .-> Db\r
`;case"domain_execution_entities_code":return`---\r
title: "Execution"\r
---\r
graph TB\r
  subgraph IntegrationHub["\`Integration Hub Platform\`"]\r
    subgraph IntegrationHub.QuarkusApp["\`App Service Quarkus Native\`"]\r
      subgraph IntegrationHub.QuarkusApp.DomainEntities["\`Domain Entities\`"]\r
        IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity@{ shape: rectangle, label: "ProcessTaskExecution" }\r
        IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity@{ shape: rectangle, label: "AuditEvent" }\r
        IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity@{ shape: rectangle, label: "ProcessExecution" }\r
        IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity@{ shape: rectangle, label: "ProcessDefinition" }\r
        IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity@{ shape: rectangle, label: "ProcessTaskDefinition" }\r
      end\r
    end\r
  ...
  Db@{ shape: rectangle, label: "PostgreSQL" }\r
  IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity -. "\`n..1 processExecution\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity -. "\`n..1 processExecution\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ProcessExecutionEntity -. "\`n..1 processDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskExecutionEntity -. "\`n..1 taskDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.AuditEventEntity -. "\`0..1 taskDefinition\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity\r
  IntegrationHub.QuarkusApp.DomainEntities.ProcessDefinitionEntity -. "\`1..n tasks\`" .-> IntegrationHub.QuarkusApp.DomainEntities.ProcessTaskDefinitionEntity\r
  IntegrationHub.QuarkusApp -. "\`Persiste configuracion, jobs, auditoria y staging\`" .-> Db\r
