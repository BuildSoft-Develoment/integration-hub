...
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Administra catálogos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Ejecuta procesos\r
Auditor .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Consulta auditoría y resultados\r
...
LoadBalancer .[#8D8D8D,thickness=2].> IngressController : <color:#8D8D8D>Reenvía tráfico al cluster\r
...
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catálogos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
Auditor .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta auditoría y resultados\r
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Autenticación OIDC\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Valida access tokens\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Persiste configuración, jobs, auditoría y staging\r
...
rectangle "==Keycloak" <<Iam>> as Iam\r
\r
IntegrationHubAdminConsoleReactApp .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleOidcClient : <color:#8D8D8D>Gestiona sesión\r
IntegrationHubAdminConsoleReactApp .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleProcessDesigner : <color:#8D8D8D>Configura catálogos y procesos\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppExecutionQueryResource : <color:#8D8D8D>Consulta ejecuciones y auditoría\r
User .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catálogos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
...
rectangle "==APIs externas" <<ExternalApi>> as ExternalApi\r
\r
IntegrationHubQuarkusAppProcessDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega gestión de procesos\r
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega gestión de sources\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecución\r
...
IntegrationHubQuarkusAppExecutionQueryService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPersistenceLayer : <color:#8D8D8D>Consulta ejecuciones y auditoría\r
User .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catálogos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
...
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppExecutionQueryResource : <color:#8D8D8D>Consulta ejecuciones y auditoría\r
...
rectangle "==APIs externas" <<ExternalApi>> as ExternalApi\r
\r
IntegrationHubQuarkusAppProcessExecutionService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngineJsonConfigurationMapper : <color:#8D8D8D>Lee configuración JSON\r
...
ProdEdgeLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppAppClusterIngressControllerIngressController : <color:#8D8D8D>Reenvía tráfico al cluster\r
...
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod1 : <color:#8D8D8D>Balancea tráfico HTTP\r
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod2 : <color:#8D8D8D>Balancea tráfico HTTP\r
...
rectangle "==PostgreSQL" <<Db>> as Db\r
\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleProcessDesigner : <color:#8D8D8D>Define tipo de fuente y parámetros\r
...
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega alta de catálogo\r
...
IntegrationHubQuarkusAppProcessDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega alta de catálogo\r
...
IntegrationHubQuarkusAppProcessCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPersistenceLayer : <color:#8D8D8D>Persiste definición\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionResource : <color:#8D8D8D>Solicita ejecución\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecución\r
...
IntegrationHubQuarkusAppProcessEngineTaskProvidersRestCallTaskProvider .[#8D8D8D,thickness=2].> ExternalApi : <color:#8D8D8D>Envía payload\r
@enduml\r
...
IntegrationHubQuarkusAppProcessSchedulerService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Lanza ejecución\r
...
ObservabilityOtel .[#8D8D8D,thickness=2].> ObservabilityJaeger : <color:#8D8D8D>Publica visualización\r
@enduml\r
...
IntegrationHubAdminConsoleOidcClient .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Solicita autenticación OIDC\r
