...
rectangle "==Integration Hub HTTP Service" <<AppService>> as AppService\r
...
skinparam rectangle<<ProdAppAppClusterAppHttpService>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
...
\r
    ...
    rectangle "==Integration Hub HTTP Service" <<ProdAppAppClusterAppHttpService>> as ProdAppAppClusterAppHttpService\r
...
\r
      rectangle "==Admin Console" <<ProdAppAppClusterAppPod1AdminConsole>> as ProdAppAppClusterAppPod1AdminConsole\r
      rectangle "==Quarkus Native App" <<ProdAppAppClusterAppPod1QuarkusApp>> as ProdAppAppClusterAppPod1QuarkusApp\r
    }\r
...
\r
      rectangle "==Admin Console" <<ProdAppAppClusterAppPod2AdminConsole>> as ProdAppAppClusterAppPod2AdminConsole\r
      rectangle "==Quarkus Native App" <<ProdAppAppClusterAppPod2QuarkusApp>> as ProdAppAppClusterAppPod2QuarkusApp\r
    }\r
  }\r
}\r
...
ProdAppAppClusterIngressControllerIngressController .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod1AdminConsole : <color:#8D8D8D>Enruta trafico HTTP interno\r
ProdAppAppClusterIngressControllerIngressController .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod1QuarkusApp : <color:#8D8D8D>Enruta trafico HTTP interno\r
ProdAppAppClusterIngressControllerIngressController .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod2AdminConsole : <color:#8D8D8D>Enruta trafico HTTP interno\r
ProdAppAppClusterIngressControllerIngressController .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod2QuarkusApp : <color:#8D8D8D>Enruta trafico HTTP interno\r
...
ProdAppAppClusterIngressController .[#8D8D8D,thickness=2].> ProdAppAppClusterAppHttpService : <color:#8D8D8D>Ruta UI y API\r
ProdAppAppClusterAppHttpService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod1 : <color:#8D8D8D>Balancea trafico HTTP\r
ProdAppAppClusterAppHttpService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod2 : <color:#8D8D8D>Balancea trafico HTTP\r
...
IntegrationHubAdminConsoleProcessDesigner .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppAdminApi : <color:#8D8D8D>Registra source definition\r
IntegrationHubQuarkusAppAdminApi .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngineProcessCatalogService : <color:#8D8D8D>Persiste catalogo\r
IntegrationHubQuarkusAppProcessEngineProcessCatalogService .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Guarda source definition\r
@enduml\r
...
IntegrationHubAdminConsoleProcessDesigner .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppAdminApi : <color:#8D8D8D>Registra reader definition\r
IntegrationHubQuarkusAppAdminApi .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngineProcessCatalogService : <color:#8D8D8D>Persiste catalogo\r
IntegrationHubQuarkusAppProcessEngineProcessCatalogService .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Guarda reader definition\r
@enduml\r
...
IntegrationHubQuarkusAppAdminApi .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngineProcessCatalogService : <color:#8D8D8D>Valida y registra tareas\r
IntegrationHubQuarkusAppProcessEngineProcessCatalogService .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Guarda process definition y task definitions\r
@enduml\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppExecutionApi : <color:#8D8D8D>Solicita ejecucion\r
...
IntegrationHubQuarkusAppTaskProvidersDbWriteTaskProvider .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Guarda staging o destino\r
...
rectangle "==Jaeger" <<ObservabilityJaeger>> as ObservabilityJaeger\r
\r
SchedulerActor .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppScheduler : <color:#8D8D8D>Detecta proceso programado\r
IntegrationHubQuarkusAppScheduler .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngine : <color:#8D8D8D>Lanza ejecucion\r
IntegrationHubQuarkusAppProcessEngine .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppSourceRegistry : <color:#8D8D8D>Resuelve fuente\r
IntegrationHubQuarkusAppProcessEngine .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppReaderRegistry : <color:#8D8D8D>Lee contenido\r
IntegrationHubQuarkusAppProcessEngine .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppTaskRegistry : <color:#8D8D8D>Ejecuta tareas\r
IntegrationHubQuarkusAppProcessEngine .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppAuditService : <color:#8D8D8D>Registra eventos\r
...
IntegrationHubAdminConsoleOidcClient .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppAdminApi : <color:#8D8D8D>Invoca APIs protegidas\r
IntegrationHubQuarkusAppAdminApi .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Valida tokens y roles\r
@enduml\r
