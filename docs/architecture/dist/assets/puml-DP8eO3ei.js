...
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Administra catÃ¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Ejecuta procesos\r
Auditor .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Consulta auditorÃ­a y resultados\r
...
LoadBalancer .[#8D8D8D,thickness=2].> IngressController : <color:#8D8D8D>ReenvÃ­a trÃ¡fico al cluster\r
...
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catÃ¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
Auditor .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta auditorÃ­a y resultados\r
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>AutenticaciÃ³n OIDC\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Valida access tokens\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Persiste configuraciÃ³n, jobs, auditorÃ­a y staging\r
...
rectangle "==Keycloak" <<Iam>> as Iam\r
\r
IntegrationHubAdminConsoleReactApp .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleOidcClient : <color:#8D8D8D>Gestiona sesiÃ³n\r
IntegrationHubAdminConsoleReactApp .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleProcessDesigner : <color:#8D8D8D>Configura catÃ¡logos y procesos\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppExecutionQueryResource : <color:#8D8D8D>Consulta ejecuciones y auditorÃ­a\r
User .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catÃ¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
...
rectangle "==APIs externas" <<ExternalApi>> as ExternalApi\r
\r
IntegrationHubQuarkusAppProcessDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega gestiÃ³n de procesos\r
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega gestiÃ³n de sources\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecuciÃ³n\r
...
IntegrationHubQuarkusAppExecutionQueryService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPersistenceLayer : <color:#8D8D8D>Consulta ejecuciones y auditorÃ­a\r
User .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catÃ¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
...
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppExecutionQueryResource : <color:#8D8D8D>Consulta ejecuciones y auditorÃ­a\r
...
rectangle "==APIs externas" <<ExternalApi>> as ExternalApi\r
\r
IntegrationHubQuarkusAppProcessExecutionService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngineJsonConfigurationMapper : <color:#8D8D8D>Lee configuraciÃ³n JSON\r
...
ProdEdgeLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppAppClusterIngressControllerIngressController : <color:#8D8D8D>ReenvÃ­a trÃ¡fico al cluster\r
...
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod1 : <color:#8D8D8D>Balancea trÃ¡fico HTTP\r
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod2 : <color:#8D8D8D>Balancea trÃ¡fico HTTP\r
...
rectangle "==PostgreSQL" <<Db>> as Db\r
\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleProcessDesigner : <color:#8D8D8D>Define tipo de fuente y parÃ¡metros\r
...
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega alta de catÃ¡logo\r
...
IntegrationHubQuarkusAppProcessDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega alta de catÃ¡logo\r
...
IntegrationHubQuarkusAppProcessCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPersistenceLayer : <color:#8D8D8D>Persiste definiciÃ³n\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionResource : <color:#8D8D8D>Solicita ejecuciÃ³n\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecuciÃ³n\r
...
IntegrationHubQuarkusAppProcessEngineTaskProvidersRestCallTaskProvider .[#8D8D8D,thickness=2].> ExternalApi : <color:#8D8D8D>EnvÃ­a payload\r
@enduml\r
...
IntegrationHubQuarkusAppProcessSchedulerService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Lanza ejecuciÃ³n\r
...
ObservabilityOtel .[#8D8D8D,thickness=2].> ObservabilityJaeger : <color:#8D8D8D>Publica visualizaciÃ³n\r
@enduml\r
...
IntegrationHubAdminConsoleOidcClient .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Solicita autenticaciÃ³n OIDC\r
