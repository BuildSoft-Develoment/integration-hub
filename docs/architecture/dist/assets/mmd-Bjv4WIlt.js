...
---\r
graph TB\r
  subgraph DevDockerHost["\`dockerHost\`"]\r
    DevDockerHost.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r
    DevDockerHost.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r
  end\r
  ...
  DevDockerHost.AdminConsole -. "\`[...]\`" .-> DevDockerHost.QuarkusApp\r
  DevData.Otel -. "\`Entrega trazas\`" .-> DevData.Jaeger\r
  DevDockerHost.AdminConsole -. "\`[...]\`" .-> DevData.Iam\r
  DevDockerHost.QuarkusApp -. "\`[...]\`" .-> DevData.Db\r
  DevDockerHost.QuarkusApp -. "\`Valida access tokens\`" .-> DevData.Iam\r
  DevDockerHost.QuarkusApp -. "\`Exporta trazas\`" .-> DevData.Otel\r
`;case"deployment_pre":return`---\r
title: "PRE"\r
---\r
graph TB\r
  subgraph PrePreNode1["\`preNode1\`"]\r
    PrePreNode1.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r
    PrePreNode1.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r
  end\r
  ...
  PrePreNode1.AdminConsole -. "\`[...]\`" .-> PrePreNode1.QuarkusApp\r
  PreData.Otel -. "\`Entrega trazas\`" .-> PreData.Jaeger\r
  PrePreNode1.AdminConsole -. "\`[...]\`" .-> PreData.Iam\r
  PrePreNode1.QuarkusApp -. "\`[...]\`" .-> PreData.Db\r
  PrePreNode1.QuarkusApp -. "\`Valida access tokens\`" .-> PreData.Iam\r
  PrePreNode1.QuarkusApp -. "\`Exporta trazas\`" .-> PreData.Otel\r
