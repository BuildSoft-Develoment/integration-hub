...
graph TB\r
  ...
  IntegrationHub.QuarkusApp -. "\`Obtiene payloads remotos\`" .-> FileSources.RestSource\r
  IntegrationHub.QuarkusApp -. "\`Exporta trazas\`" .-> ObservabilityOtel\r
`;case"process_engine_layers":return`---\r
...
graph LR\r
  ...
  IntegrationHubQuarkusAppSourceDefinitionResource -. "\`Delega gestion de sources\`" .-> IntegrationHubQuarkusAppProcessCatalogService\r
