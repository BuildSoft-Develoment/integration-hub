...
rectangle "==Secrets / Vault corporativo" <<Vault>> as Vault\r
...
LoadBalancer .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>[...]\r
...
LoadBalancer .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Publica UI on-prem\r
LoadBalancer .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Publica APIs on-prem\r
IngressController .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Enruta trafico HTTP interno\r
IngressController .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Enruta trafico HTTP interno\r
Vault .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Entrega secretos y credenciales\r
SharedStorage .[#8D8D8D,thickness=2].> IntegrationHubQuarkusApp : <color:#8D8D8D>Comparte archivos locales\r
