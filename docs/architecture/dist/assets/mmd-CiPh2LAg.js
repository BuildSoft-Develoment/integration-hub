...
graph TB\r
  ...
  UiService@{ shape: rectangle, label: "Service UI" }\r
  ApiService@{ shape: rectangle, label: "Service API" }\r
  ...
  IngressController -. "\`Enruta trafico HTTP interno\`" .-> IntegrationHub\r
