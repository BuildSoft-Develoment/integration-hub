...
\r
User .[#8D8D8D,thickness=2].> OnPrem : <color:#8D8D8D>Accede por HTTPS\r
User .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> OnPrem : <color:#8D8D8D>Administra por HTTPS\r
...
skinparam rectangle<<ProdAppAppClusterIngressControllerIngress>>{\r
  BackgroundColor #428a4f\r
  FontColor #f8fafc\r
  BorderColor #2d5d39\r
}\r
...
\r
    rectangle "==Secrets / Vault corporativo" <<ProdServicesServicesNodeVault>> as ProdServicesServicesNodeVault\r
...
\r
      rectangle "==Ingress Controller" <<ProdAppAppClusterIngressControllerIngress>> as ProdAppAppClusterIngressControllerIngress\r
    }\r
...
ProdAppAppClusterIngressControllerIngress .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode1AdminConsole : <color:#8D8D8D>Enruta trafico HTTP interno\r
ProdAppAppClusterIngressControllerIngress .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode1QuarkusApp : <color:#8D8D8D>Enruta trafico HTTP interno\r
ProdAppAppClusterIngressControllerIngress .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode2AdminConsole : <color:#8D8D8D>Enruta trafico HTTP interno\r
ProdAppAppClusterIngressControllerIngress .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode2QuarkusApp : <color:#8D8D8D>Enruta trafico HTTP interno\r
ProdDataObservabilityNodeOtel .[#8D8D8D,thickness=2].> ProdDataObservabilityNodeJaeger : <color:#8D8D8D>Entrega trazas\r
ProdEdgeLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppAppClusterIngressControllerIngress : <color:#8D8D8D>Reenvia trafico al cluster\r
ProdEdgeLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode1AdminConsole : <color:#8D8D8D>Publica UI on-prem\r
ProdEdgeLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode1QuarkusApp : <color:#8D8D8D>Publica APIs on-prem\r
ProdEdgeLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode2AdminConsole : <color:#8D8D8D>Publica UI on-prem\r
ProdEdgeLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppAppClusterProdNode2QuarkusApp : <color:#8D8D8D>Publica APIs on-prem\r
