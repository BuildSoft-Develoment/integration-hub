...
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Administra catÃƒÂ¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Ejecuta procesos\r
Auditor .[#8D8D8D,thickness=2].> IntegrationHub : <color:#8D8D8D>Consulta auditorÃƒÂ­a y resultados\r
...
LoadBalancer .[#8D8D8D,thickness=2].> IngressController : <color:#8D8D8D>ReenvÃƒÂ­a trÃƒÂ¡fico al cluster\r
...
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catÃƒÂ¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
Auditor .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta auditorÃƒÂ­a y resultados\r
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>AutenticaciÃƒÂ³n OIDC\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Valida access tokens\r
IntegrationHubQuarkusApp .[#8D8D8D,thickness=2].> Db : <color:#8D8D8D>Persiste configuraciÃƒÂ³n, jobs, auditorÃƒÂ­a y staging\r
...
rectangle "==Keycloak" <<Iam>> as Iam\r
\r
IntegrationHubAdminConsoleReactApp .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleOidcClient : <color:#8D8D8D>Gestiona sesiÃƒÂ³n\r
IntegrationHubAdminConsoleReactApp .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleProcessDesigner : <color:#8D8D8D>Configura catÃƒÂ¡logos y procesos\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppExecutionQueryResource : <color:#8D8D8D>Consulta ejecuciones y auditorÃƒÂ­a\r
User .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catÃƒÂ¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
...
rectangle "==APIs externas" <<ExternalApi>> as ExternalApi\r
\r
IntegrationHubQuarkusAppProcessDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega gestiÃƒÂ³n de procesos\r
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega gestiÃƒÂ³n de sources\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecuciÃƒÂ³n\r
...
IntegrationHubQuarkusAppExecutionQueryService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPersistenceLayer : <color:#8D8D8D>Consulta ejecuciones y auditorÃƒÂ­a\r
User .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Consulta estado y resultados\r
Admin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Configura fuentes, readers y procesos\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Administra catÃƒÂ¡logos y procesos\r
Operator .[#8D8D8D,thickness=2].> IntegrationHubAdminConsole : <color:#8D8D8D>Ejecuta procesos\r
...
IntegrationHubAdminConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppExecutionQueryResource : <color:#8D8D8D>Consulta ejecuciones y auditorÃƒÂ­a\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionResource : <color:#8D8D8D>Ejecuta procesos\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecuciÃƒÂ³n\r
IntegrationHubQuarkusAppProcessExecutionService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessEngineJsonConfigurationMapper : <color:#8D8D8D>Lee configuraciÃƒÂ³n JSON\r
...
ProdEdgeLoadBalancerLoadBalancer .[#8D8D8D,thickness=2].> ProdAppAppClusterIngressControllerIngressController : <color:#8D8D8D>ReenvÃƒÂ­a trÃƒÂ¡fico al cluster\r
...
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod1 : <color:#8D8D8D>Balancea trÃƒÂ¡fico HTTP\r
ProdAppAppClusterAppService .[#8D8D8D,thickness=2].> ProdAppAppClusterAppPod2 : <color:#8D8D8D>Balancea trÃƒÂ¡fico HTTP\r
...
rectangle "==PostgreSQL" <<Db>> as Db\r
\r
IntegrationAdmin .[#8D8D8D,thickness=2].> IntegrationHubAdminConsoleProcessDesigner : <color:#8D8D8D>Define tipo de fuente y parÃƒÂ¡metros\r
...
IntegrationHubQuarkusAppSourceDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega alta de catÃƒÂ¡logo\r
...
IntegrationHubQuarkusAppProcessDefinitionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessCatalogService : <color:#8D8D8D>Delega alta de catÃƒÂ¡logo\r
...
IntegrationHubQuarkusAppProcessCatalogService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppPersistenceLayer : <color:#8D8D8D>Persiste definiciÃƒÂ³n\r
...
IntegrationHubAdminConsoleOperationsConsole .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionResource : <color:#8D8D8D>Solicita ejecuciÃƒÂ³n\r
IntegrationHubQuarkusAppProcessExecutionResource .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Delega ejecuciÃƒÂ³n\r
...
IntegrationHubQuarkusAppProcessEngineTaskProvidersRestCallTaskProvider .[#8D8D8D,thickness=2].> ExternalApi : <color:#8D8D8D>EnvÃƒÂ­a payload\r
@enduml\r
...
IntegrationHubQuarkusAppProcessSchedulerService .[#8D8D8D,thickness=2].> IntegrationHubQuarkusAppProcessExecutionService : <color:#8D8D8D>Lanza ejecuciÃƒÂ³n\r
...
ObservabilityOtel .[#8D8D8D,thickness=2].> ObservabilityJaeger : <color:#8D8D8D>Publica visualizaciÃƒÂ³n\r
@enduml\r
...
IntegrationHubAdminConsoleOidcClient .[#8D8D8D,thickness=2].> Iam : <color:#8D8D8D>Solicita autenticaciÃƒÂ³n OIDC\r
