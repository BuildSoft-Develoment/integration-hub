...
graph TB\r
  ...
  IntegrationHub.AdminConsole.ProcessDesigner -. "\`CRUD de definiciones\`" .-> IntegrationHub.QuarkusApp.ProcessDefinitionResource\r
...
graph TB\r
  ...
  Operator -. "\`Ejecuta procesos\`" .-> IntegrationHub.AdminConsole\r
  Auditor -. "\`Consulta auditoria y resultados\`" .-> IntegrationHub.AdminConsole\r
  IntegrationHub.AdminConsole -. "\`CRUD de definiciones\`" .-> IntegrationHub.QuarkusApp.ProcessDefinitionResource\r
