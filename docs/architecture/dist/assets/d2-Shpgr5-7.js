...
\r
OnPremDevEnv: {\r
  label: "DEV Environment"\r
}\r
OnPremPreEnv: {\r
  label: "PRE Environment"\r
}\r
OnPremProEnv: {\r
  label: "PRO Environment"\r
}\r
OnPremLoadBalancer: {\r
  label: "Load Balancer / Reverse Proxy"\r
}\r
OnPremVault: {\r
  label: "Secrets / Vault corporativo"\r
}\r
OnPremSharedStorage: {\r
...
\r
OnPremDevEnv -> IntegrationHubAdminConsole: "Despliega UI dev"\r
OnPremPreEnv -> IntegrationHubAdminConsole: "Despliega UI pre"\r
OnPremProEnv -> IntegrationHubAdminConsole: "Despliega UI pro"\r
OnPremLoadBalancer -> IntegrationHubAdminConsole: "Publica UI on-prem"\r
OnPremDevEnv -> IntegrationHubQuarkusApp: "Despliega app dev"\r
OnPremPreEnv -> IntegrationHubQuarkusApp: "Despliega app pre"\r
OnPremProEnv -> IntegrationHubQuarkusApp: "Despliega app pro"\r
OnPremLoadBalancer -> IntegrationHubQuarkusApp: "Publica APIs on-prem"\r
OnPremVault -> IntegrationHubQuarkusApp: "Entrega secretos y credenciales"\r
OnPremSharedStorage -> IntegrationHubQuarkusApp: "Comparte archivos locales"\r
IntegrationHubAdminConsole -> IntegrationHubQuarkusApp: "Invoca APIs protegidas"\r
IntegrationHubAdminConsole -> Iam: "Autenticacion OIDC"\r
IntegrationHubQuarkusApp -> Iam: "Valida access tokens"\r
IntegrationHubQuarkusApp -> Db: "Persiste configuracion, jobs, auditoria y staging"\r
...
IntegrationHubQuarkusApp -> FileSourcesFilesystem: "Lee archivos locales"\r
IntegrationHubQuarkusApp -> ExternalApi: "Invoca APIs de negocio"\r
`;case"usecases":return`direction: down\r
\r
IntegrationAdmin: {\r
  label: "Integration Admin"\r
  shape: c4-person\r
...
\r
IntegrationAdmin -> IntegrationHubAdminConsoleProcessDesigner: "UC-01, UC-02, UC-03"\r
Operator -> IntegrationHubAdminConsoleOperationsConsole: "UC-04, UC-06, UC-08"\r
Auditor -> IntegrationHubAdminConsoleOperationsConsole: "UC-06, UC-07"\r
SchedulerActor -> IntegrationHubQuarkusAppScheduler: "UC-05"\r
PlatformAdmin -> Iam: "UC-09"\r
PlatformAdmin -> OnPrem: "UC-10"\r
InfraTeam -> OnPrem: "UC-10"\r
