...
---\r
graph TB\r
  subgraph DevEdge["\`edge\`"]\r
    DevEdge.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r
    DevEdge.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r
  end\r
  subgraph DevData["\`data\`"]\r
    DevData.Otel@{ shape: rectangle, label: "OpenTelemetry Collector" }\r
    DevData.Iam@{ shape: rectangle, label: "Keycloak" }\r
    DevData.Db@{ shape: rectangle, label: "PostgreSQL" }\r
    DevData.Jaeger@{ shape: rectangle, label: "Jaeger" }\r
  end\r
  DevEdge.AdminConsole -. "\`[...]\`" .-> DevEdge.QuarkusApp\r
  DevData.Otel -. "\`Entrega trazas\`" .-> DevData.Jaeger\r
  DevEdge.AdminConsole -. "\`[...]\`" .-> DevData.Iam\r
  DevEdge.QuarkusApp -. "\`[...]\`" .-> DevData.Db\r
  DevEdge.QuarkusApp -. "\`Valida access tokens\`" .-> DevData.Iam\r
  DevEdge.QuarkusApp -. "\`Exporta trazas\`" .-> DevData.Otel\r
`;case"deployment_pre":return`---\r
title: "PRE"\r
---\r
graph TB\r
  subgraph PreAppCluster["\`appCluster\`"]\r
    subgraph PreAppCluster.PreNode1["\`preNode1\`"]\r
      PreAppCluster.PreNode1.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r
      PreAppCluster.PreNode1.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r
    end\r
    subgraph PreAppCluster.PreNode2["\`preNode2\`"]\r
      PreAppCluster.PreNode2.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r
      PreAppCluster.PreNode2.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r
    end\r
  end\r
  subgraph PreData["\`data\`"]\r
    PreData.Otel@{ shape: rectangle, label: "OpenTelemetry Collector" }\r
    PreData.Iam@{ shape: rectangle, label: "Keycloak" }\r
    PreData.Db@{ shape: rectangle, label: "PostgreSQL" }\r
    PreData.Jaeger@{ shape: rectangle, label: "Jaeger" }\r
  end\r
  PreAppCluster.PreNode1.AdminConsole -. "\`[...]\`" .-> PreAppCluster.PreNode1.QuarkusApp\r
  PreAppCluster.PreNode2.AdminConsole -. "\`[...]\`" .-> PreAppCluster.PreNode2.QuarkusApp\r
  PreData.Otel -. "\`Entrega trazas\`" .-> PreData.Jaeger\r
  PreAppCluster.PreNode1.AdminConsole -. "\`[...]\`" .-> PreData.Iam\r
  PreAppCluster.PreNode1.QuarkusApp -. "\`[...]\`" .-> PreData.Db\r
  PreAppCluster.PreNode1.QuarkusApp -. "\`Valida access tokens\`" .-> PreData.Iam\r
  PreAppCluster.PreNode1.QuarkusApp -. "\`Exporta trazas\`" .-> PreData.Otel\r
  PreAppCluster.PreNode2.AdminConsole -. "\`[...]\`" .-> PreData.Iam\r
  PreAppCluster.PreNode2.QuarkusApp -. "\`[...]\`" .-> PreData.Db\r
  PreAppCluster.PreNode2.QuarkusApp -. "\`Valida access tokens\`" .-> PreData.Iam\r
  PreAppCluster.PreNode2.QuarkusApp -. "\`Exporta trazas\`" .-> PreData.Otel\r
`;case"deployment_prod":return'---\r\ntitle: "PROD"\r\n---\r\ngraph TB\r\n  subgraph ProdLoadBalancer["`loadBalancer`"]\r\n    ProdLoadBalancer.LoadBalancer@{ shape: rectangle, label: "Load Balancer / Reverse Proxy" }\r\n  end\r\n  subgraph ProdServices["`services`"]\r\n    ProdServices.Vault@{ shape: rectangle, label: "Secrets / Vault corporativo" }\r\n    ProdServices.SharedStorage@{ shape: rectangle, label: "Shared File Storage" }\r\n  end\r\n  subgraph ProdAppCluster["`appCluster`"]\r\n    subgraph ProdAppCluster.ProdNode1["`prodNode1`"]\r\n      ProdAppCluster.ProdNode1.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r\n      ProdAppCluster.ProdNode1.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r\n    end\r\n    subgraph ProdAppCluster.ProdNode2["`prodNode2`"]\r\n      ProdAppCluster.ProdNode2.AdminConsole@{ shape: rectangle, label: "Admin Console" }\r\n      ProdAppCluster.ProdNode2.QuarkusApp@{ shape: rectangle, label: "Quarkus Native App" }\r\n    end\r\n  end\r\n  subgraph ProdData["`data`"]\r\n    ProdData.Otel@{ shape: rectangle, label: "OpenTelemetry Collector" }\r\n    ProdData.Iam@{ shape: rectangle, label: "Keycloak" }\r\n    ProdData.Db@{ shape: rectangle, label: "PostgreSQL" }\r\n    ProdData.Jaeger@{ shape: rectangle, label: "Jaeger" }\r\n  end\r\n  ProdAppCluster.ProdNode1.AdminConsole -. "`[...]`" .-> ProdAppCluster.ProdNode1.QuarkusApp\r\n  ProdAppCluster.ProdNode2.AdminConsole -. "`[...]`" .-> ProdAppCluster.ProdNode2.QuarkusApp\r\n  ProdData.Otel -. "`Entrega trazas`" .-> ProdData.Jaeger\r\n  ProdLoadBalancer.LoadBalancer -. "`Publica UI on-prem`" .-> ProdAppCluster.ProdNode1.AdminConsole\r\n  ProdLoadBalancer.LoadBalancer -. "`Publica APIs on-prem`" .-> ProdAppCluster.ProdNode1.QuarkusApp\r\n  ProdLoadBalancer.LoadBalancer -. "`Publica UI on-prem`" .-> ProdAppCluster.ProdNode2.AdminConsole\r\n  ProdLoadBalancer.LoadBalancer -. "`Publica APIs on-prem`" .-> ProdAppCluster.ProdNode2.QuarkusApp\r\n  ProdAppCluster.ProdNode1.AdminConsole -. "`[...]`" .-> ProdData.Iam\r\n  ProdAppCluster.ProdNode1.QuarkusApp -. "`[...]`" .-> ProdData.Db\r\n  ProdAppCluster.ProdNode1.QuarkusApp -. "`Valida access tokens`" .-> ProdData.Iam\r\n  ProdAppCluster.ProdNode1.QuarkusApp -. "`Exporta trazas`" .-> ProdData.Otel\r\n  ProdServices.Vault -. "`Entrega secretos y credenciales`" .-> ProdAppCluster.ProdNode1.QuarkusApp\r\n  ProdServices.SharedStorage -. "`Comparte archivos locales`" .-> ProdAppCluster.ProdNode1.QuarkusApp\r\n  ProdAppCluster.ProdNode2.AdminConsole -. "`[...]`" .-> ProdData.Iam\r\n  ProdAppCluster.ProdNode2.QuarkusApp -. "`[...]`" .-> ProdData.Db\r\n  ProdAppCluster.ProdNode2.QuarkusApp -. "`Valida access tokens`" .-> ProdData.Iam\r\n  ProdAppCluster.ProdNode2.QuarkusApp -. "`Exporta trazas`" .-> ProdData.Otel\r\n  ProdServices.Vault -. "`Entrega secretos y credenciales`" .-> ProdAppCluster.ProdNode2.QuarkusApp\r\n  ProdServices.SharedStorage -. "`Comparte archivos locales`" .-> ProdAppCluster.ProdNode2.QuarkusApp\r\n';case"usecase_design_execute":return`---\r
