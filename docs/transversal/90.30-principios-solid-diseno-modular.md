...
## Objetivo
Hacer explicito el uso de `SOLID` como criterio de diseno para arquitectura, specs tecnicas, implementacion y revision de codigo. No reemplaza SDD, ADR ni pruebas; funciona como una regla de calidad para evitar acoplamiento accidental y codigo dificil de evolucionar.
