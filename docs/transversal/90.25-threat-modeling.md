...
| **I**nformation disclosure | Puede leer dato quien no deberia? | RBAC + ABAC (`03.08-auth-authz.md`); cifrado en reposo; redaccion PII (`pii-redact.ts` / `PiiRedactor.java **(no existe en el codigo; la redaccion de PII esta pendiente)**`); minimo privilegio en queries. |
...
- [Privacidad y compliance (90.16)](90.16-privacidad-compliance.md)
- Gestion de incidentes: documento 90.24 pendiente de publicar en transversal.
