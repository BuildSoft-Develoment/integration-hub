...
- UX/prototipo validado cuando la feature toca frontend,
- stack o modulo afectado.

## Process
1. Validar specs y contratos.
2. Si es frontend, validar consistencia spec + prototipo validado + criterios UI.
...
## Red flags
- No hay `spec tecnica`.
- Frontend sin prototipo validado o excepcion documentada cuando aplica.
