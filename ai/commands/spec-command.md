...
- UX/prototipo validado si la feature toca frontend.
...
7. Si hay frontend, vincular cada tarea visible a SPDD, prototipo y criterios UI.
...
- La feature frontend ignora prototipo validado o criterios UI existentes.
