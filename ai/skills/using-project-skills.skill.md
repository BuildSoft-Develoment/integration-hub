---
name: aif-using-project-skills
description: "Elegir la combinacion minima de `agent`, `prompt`, `skill` y referencias segun la intencion real del trabajo, no solo segun el rol. Usala cuando no esta claro por donde empezar."
---
