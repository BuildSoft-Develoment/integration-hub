---
name: aif-framework-governance
description: "Aplicar gobernanza al framework enterprise AI-first para que cada solicitud use la combinacion correcta de metodologia, commands, agents, prompts, skills, references, quality gates, memoria local, trazabilidad y evidencia. Usala cuando una solicitud cruza varias fases o dominios."
---
