---
name: aif-backend
description: "Mantener una forma consistente de implementar backend a partir de una `spec tecnica`. Usala cuando una feature ya tiene contratos y reglas claras."
---
