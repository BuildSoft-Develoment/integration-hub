---
name: aif-debugging-workflow
description: "Usa cuando hay un bug reproducible o intermitente, o falla una prueba/build/flujo, y necesitas reproducir el sintoma y reducir el espacio de causa probable con evidencia. No la uses si la solicitud real es discovery o documentacion."
---
