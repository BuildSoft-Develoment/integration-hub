---
name: aif-html5-prototyping
description: "Generar prototipos HTML5 navegables desde SPDD para validar UX rapidamente antes de construir frontend real o formalizar diseno en Penpot. Usala cuando existe `spdd-frontend.md`."
---
