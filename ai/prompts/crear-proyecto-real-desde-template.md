...
## Objetivo
Instanciar tecnicamente este framework AI-first empresarial como un proyecto real en una ruta externa, usando datos minimos ya definidos y manteniendo limpia la documentacion, la capa IA y la trazabilidad inicial.
