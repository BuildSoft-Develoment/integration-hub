...
//
// Permisos esperados (forma "__API_RESOURCE_NAME__:read"). Roles en lowercase: viewer/editor/approver/admin.
...
const STACK_FILES = [
  ...
  {
    stack: "java-monolith",
    file: "stacks/java-monolith/template/src/main/java/com/example/app/security/Role.java",
    parser: parseJavaRole,
  },
  {
    stack: "spring-react",
    file: "stacks/spring-react/template/backend/src/main/java/com/example/app/security/Role.java",
    parser: parseJavaRole,
  },
  {
    stack: "quarkus-angular",
    file: "stacks/quarkus-angular/template/backend/src/main/java/com/example/app/security/Role.java",
    parser: parseJavaRole,
  },
];
...
const JAVA_PERMISSION_MAP = {
  RESOURCE_READ: "__API_RESOURCE_NAME__:read",
  RESOURCE_WRITE: "__API_RESOURCE_NAME__:write",
  RESOURCE_APPROVE: "__API_RESOURCE_NAME__:approve",
