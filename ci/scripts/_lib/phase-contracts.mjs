...
export const PHASE_CONTRACTS = [
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    touchAllow: ["releases/**", "ops/fase-7-deploy/**", "ops/runbooks/**", "CHANGELOG.md", "ci/**", ".github/**", "AI_CONTEXT.md", "SESSION_LOG.md"],
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    touchAllow: ["ops/runbooks/**", "ops/**", "specs/<feature>/traceability.md", "AI_CONTEXT.md", "SESSION_LOG.md"],
    touchForbid: ["<backend>/**", "<frontend>/**", "specs/<feature>/spec-funcional.md", "<migrations>/**"],
